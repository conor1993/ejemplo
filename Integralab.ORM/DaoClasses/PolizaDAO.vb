...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the Poliza Entity. It will perform database oriented actions for
	''' a entity of type 'PolizaEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class PolizaDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "PolizaEntity", New PolizaEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'PolizaEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
		...
		''' <summary>
		''' Retrieves in the calling PolizaCollection object all PolizaEntity objects
		...
		Public Function GetMultiUsingSalidaGanadoCabCollectionViaCabFacturas(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, salidaGanadoCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.CabFacturasEntityUsingFolPoliza, "CabFacturas_")
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingSalidaGanadoCabCollectionViaCabFacturas(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, salidaGanadoCabInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.CabFacturasEntityUsingFolPoliza, "CabFacturas_")
			relations.Add(CabFacturasEntity.Relations.SalidaGanadoCabEntityUsingReferencia, "CabFacturas_", String.Empty, JoinHint.None)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingSalidaGanadoCabCollectionViaCabFacturas_(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, salidaGanadoCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.CabFacturasEntityUsingFolCanPoliza, "CabFacturas_")
			relations.Add(CabFacturasEntity.Relations.SalidaGanadoCabEntityUsingReferencia, "CabFacturas_", String.Empty, JoinHint.None)
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			selectFilter.Add(New FieldCompareValuePredicate(salidaGanadoCabInstance.Fields(CInt(SalidaGanadoCabFieldIndex.IdSalidaGanadoCab)), ComparisonOperator.Equal))
			Return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize)
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingSalidaGanadoCabCollectionViaCabFacturas_(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, salidaGanadoCabInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.CabFacturasEntityUsingFolCanPoliza, "CabFacturas_")
			relations.Add(CabFacturasEntity.Relations.SalidaGanadoCabEntityUsingReferencia, "CabFacturas_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingMetodoCabCollectionViaGastosDepartamentos(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, metodoCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.GastosDepartamentosEntityUsingIdPoliza, "GastosDepartamentos_")
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaContableCollectionViaGastosDepartamentos(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.GastosDepartamentosEntityUsingIdPoliza, "GastosDepartamentos_")
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCabMovGanCollectionViaSalidaGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.SalidaGanadoCabEntityUsingIdPoliza, "SalidaGanadoCab_")
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCabMovGanCollectionViaSalidaGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.SalidaGanadoCabEntityUsingIdPoliza, "SalidaGanadoCab_")
			relations.Add(SalidaGanadoCabEntity.Relations.CabMovGanEntityUsingFolioMovimientoGanado, "SalidaGanadoCab_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingBeneficiarioCollectionViaCheque(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, beneficiarioInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaId, "Cheque_")
		...
		Public Function GetMultiUsingBeneficiarioCollectionViaCheque_(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, beneficiarioInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaIdCancelacion, "Cheque_")
			relations.Add(ChequeEntity.Relations.BeneficiarioEntityUsingBeneficiarioId, "Cheque_", String.Empty, JoinHint.None)
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			selectFilter.Add(New FieldCompareValuePredicate(beneficiarioInstance.Fields(CInt(BeneficiarioFieldIndex.Codigo)), ComparisonOperator.Equal))
			Return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaId, "Cheque_")
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaId, "Cheque_")
			relations.Add(ChequeEntity.Relations.CuentaEntityUsingCuentaId, "Cheque_", String.Empty, JoinHint.None)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque__(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaIdCancelacion, "Cheque_")
			relations.Add(ChequeEntity.Relations.CuentaEntityUsingCuentaId, "Cheque_", String.Empty, JoinHint.None)
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque__(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaIdCancelacion, "Cheque_")
			relations.Add(ChequeEntity.Relations.CuentaEntityUsingCuentaId, "Cheque_", String.Empty, JoinHint.None)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque_(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaId, "Cheque_")
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque_(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaId, "Cheque_")
			relations.Add(ChequeEntity.Relations.CuentaEntityUsingCuentaDestinoId, "Cheque_", String.Empty, JoinHint.None)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque___(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaIdCancelacion, "Cheque_")
			relations.Add(ChequeEntity.Relations.CuentaEntityUsingCuentaDestinoId, "Cheque_", String.Empty, JoinHint.None)
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaCheque___(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As  New RelationCollection()
			relations.Add(PolizaEntity.Relations.ChequeEntityUsingPolizaIdCancelacion, "Cheque_")
			relations.Add(ChequeEntity.Relations.CuentaEntityUsingCuentaDestinoId, "Cheque_", String.Empty, JoinHint.None)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaCollectionViaUsrBanDepositos_(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.UsrBanDepositosEntityUsingPolizaId, "UsrBanDepositos_")
			relations.Add(UsrBanDepositosEntity.Relations.CuentaEntityUsingCuentaId, "UsrBanDepositos_", String.Empty, JoinHint.None)
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			selectFilter.Add(New FieldCompareValuePredicate(cuentaInstance.Fields(CInt(CuentaFieldIndex.Codigo)), ComparisonOperator.Equal))
			Return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCuentaContableCollectionViaPolizaDetalle(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.PolizaDetalleEntityUsingPolizaId, "PolizaDetalle_")
		...
		Public Function GetMultiUsingCuentaCollectionViaUsrCxppagosProveedores(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizaEntity)
			Dim relations As New RelationCollection()
			relations.Add(PolizaEntity.Relations.UsrCxppagosProveedoresEntityUsingPolizaId, "UsrCxppagosProveedores_")
