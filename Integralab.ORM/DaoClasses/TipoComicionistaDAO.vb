...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the TipoComicionista Entity. It will perform database oriented actions for
	''' a entity of type 'TipoComicionistaEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class TipoComicionistaDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "TipoComicionistaEntity", New TipoComicionistaEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'TipoComicionistaEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoComicionistaEntity)
		...
		''' <summary>
		''' Retrieves in the calling TipoComicionistaCollection object all TipoComicionistaEntity objects
		...
		Public Function GetMultiUsingPlazaCollectionViaComicionista(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, plazaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(TipoComicionistaEntity.Relations.ComicionistaEntityUsingTipoComisionista, "Comicionista_")
