...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the ConceptoFlujo Entity. It will perform database oriented actions for
	''' a entity of type 'ConceptoFlujoEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class ConceptoFlujoDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "ConceptoFlujoEntity", New ConceptoFlujoEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'ConceptoFlujoEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ConceptoFlujoEntity)
		...
		''' <summary>
		''' Retrieves in the calling ConceptoFlujoCollection object all ConceptoFlujoEntity objects
		...
		Public Function GetMultiUsingCuentasContables(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ConceptoFlujoEntity)
			Dim relations As New RelationCollection()
			relations.Add(ConceptoFlujoEntity.Relations.ConceptoFlujoCuentaEntityUsingConceptoFlujoId, "ConceptoFlujoCuenta_")
