...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the OrdenCompra Entity. It will perform database oriented actions for
	''' a entity of type 'OrdenCompraEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class OrdenCompraDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "OrdenCompraEntity", New OrdenCompraEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves in the calling OrdenCompraCollection object all OrdenCompraEntity objects which have data in common
		...
		Public Overloads Function GetMulti(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression, proveedorInstance As IEntity, sucursalInstance As IEntity, tipoMonedaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			Dim fieldsToReturn  As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.OrdenCompraEntity)
		...
		''' <summary>
		''' Retrieves entities of the type 'OrdenCompraEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		''' If the used Dynamic Query Engine supports it, 'TOP' is used to limit the amount of rows to return. When set to 0, no limitations are specified.</param>
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		''' <summary>
		''' Retrieves in the calling OrdenCompraCollection object all OrdenCompraEntity objects
		...
		Public Function GetMultiUsingProductoCollectionViaOrdenCompraDetalle(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, productoInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(OrdenCompraEntity.Relations.OrdenCompraDetalleEntityUsingIdOrdenCompra, "OrdenCompraDetalle_")
		...
		''' <summary>
		''' Deletes from the persistent storage all 'OrdenCompra' entities which have data in common
		''' with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="proveedorInstance">ProveedorEntity instance to use as a filter for the OrdenCompraEntity objects to delete</param>
		''' <param name="sucursalInstance">SucursalEntity instance to use as a filter for the OrdenCompraEntity objects to delete</param>
		''' <param name="tipoMonedaInstance">TipoMonedaEntity instance to use as a filter for the OrdenCompraEntity objects to delete</param>
		...
		Public Overloads Function DeleteMulti(containingTransaction As ITransaction, proveedorInstance As IEntity, sucursalInstance As IEntity, tipoMonedaInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.OrdenCompraEntity)
		...
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="proveedorInstance">ProveedorEntity instance to use as a filter for the OrdenCompraEntity objects to update</param>
		''' <param name="sucursalInstance">SucursalEntity instance to use as a filter for the OrdenCompraEntity objects to update</param>
		''' <param name="tipoMonedaInstance">TipoMonedaEntity instance to use as a filter for the OrdenCompraEntity objects to update</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		''' </summary>
		''' <param name="proveedorInstance">ProveedorEntity instance to use as a filter for the OrdenCompraEntity objects</param>
		''' <param name="sucursalInstance">SucursalEntity instance to use as a filter for the OrdenCompraEntity objects</param>
		''' <param name="tipoMonedaInstance">TipoMonedaEntity instance to use as a filter for the OrdenCompraEntity objects</param>
		...
		Private Function CreateFilterUsingForeignKeys(proveedorInstance As IEntity, sucursalInstance As IEntity, tipoMonedaInstance As IEntity, fieldsToReturn As IEntityFields) As IPredicateExpression
			...
			If Not proveedorInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(OrdenCompraFieldIndex.IdProveedor)), ComparisonOperator.Equal, CType(proveedorInstance, ProveedorEntity).Codigo))
			End If
			If Not sucursalInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(OrdenCompraFieldIndex.IdSucursal)), ComparisonOperator.Equal, CType(sucursalInstance, SucursalEntity).Codigo))
			End If
			If Not tipoMonedaInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(OrdenCompraFieldIndex.IdMoneda)), ComparisonOperator.Equal, CType(tipoMonedaInstance, TipoMonedaEntity).Codigo))
			End If
			Return selectFilter
		End Function
