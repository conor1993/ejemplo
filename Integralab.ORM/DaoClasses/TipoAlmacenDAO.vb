...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the TipoAlmacen Entity. It will perform database oriented actions for
	''' a entity of type 'TipoAlmacenEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class TipoAlmacenDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "TipoAlmacenEntity", New TipoAlmacenEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'TipoAlmacenEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoAlmacenEntity)
		...
		''' <summary>
		''' Retrieves in the calling TipoAlmacenCollection object all TipoAlmacenEntity objects
		...
		Public Function GetMultiUsingPlazaCollectionViaAlmacen(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, plazaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(TipoAlmacenEntity.Relations.AlmacenEntityUsingTipoAlmacen, "Almacen_")
