...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the TipoPresupuesto Entity. It will perform database oriented actions for
	''' a entity of type 'TipoPresupuestoEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class TipoPresupuestoDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "TipoPresupuestoEntity", New TipoPresupuestoEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'TipoPresupuestoEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoPresupuestoEntity)
		...
		''' <summary>
		''' Retrieves in the calling TipoPresupuestoCollection object all TipoPresupuestoEntity objects
