...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the MsccatMotivoDevolucion Entity. It will perform database oriented actions for
	''' a entity of type 'MsccatMotivoDevolucionEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class MsccatMotivoDevolucionDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "MsccatMotivoDevolucionEntity", New MsccatMotivoDevolucionEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'MsccatMotivoDevolucionEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatMotivoDevolucionEntity)
		...
		''' <summary>
		''' Retrieves in the calling MsccatMotivoDevolucionCollection object all MsccatMotivoDevolucionEntity objects
		...
		Public Function GetMultiUsingMfacEmbarquesCabCollectionViaDevolucionProductos(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mfacEmbarquesCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(MsccatMotivoDevolucionEntity.Relations.DevolucionProductosEntityUsingIdMotivoDevolucion, "DevolucionProductos_")
