...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the CostoIndirecto Entity. It will perform database oriented actions for
	''' a entity of type 'CostoIndirectoEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class CostoIndirectoDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "CostoIndirectoEntity", New CostoIndirectoEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'CostoIndirectoEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CostoIndirectoEntity)
		...
		''' <summary>
		''' Retrieves in the calling CostoIndirectoCollection object all CostoIndirectoEntity objects
		...
		Public Function GetMultiUsingProductoCollectionViaProductoCostoIndirecto(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, productoInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CostoIndirectoEntity)
			Dim relations As New RelationCollection()
			relations.Add(CostoIndirectoEntity.Relations.ProductoCostoIndirectoEntityUsingCodigoCostoIndirecto, "ProductoCostoIndirecto_")
