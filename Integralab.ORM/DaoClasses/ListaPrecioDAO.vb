...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the ListaPrecio Entity. It will perform database oriented actions for
	''' a entity of type 'ListaPrecioEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class ListaPrecioDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "ListaPrecioEntity", New ListaPrecioEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves in the calling ListaPrecioCollection object all ListaPrecioEntity objects which have data in common
		...
		Public Overloads Function GetMulti(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression, plaza_Instance As IEntity, tipoVentaInstance As IEntity, listaPrecioBaseInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			MyBase.EntityFactoryToUse = entityFactoryToUse
			Dim fieldsToReturn  As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ListaPrecioEntity)
			Dim selectFilter As IPredicateExpression= CreateFilterUsingForeignKeys(plaza_Instance, tipoVentaInstance, listaPrecioBaseInstance, fieldsToReturn)
		...
		''' <summary>
		''' Retrieves entities of the type 'ListaPrecioEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		''' If the used Dynamic Query Engine supports it, 'TOP' is used to limit the amount of rows to return. When set to 0, no limitations are specified.</param>
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		''' <summary>
		''' Retrieves in the calling ListaPrecioCollection object all ListaPrecioEntity objects
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingPlazaCollectionViaListaPrecio(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, plazaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ListaPrecioEntity)
			Dim relations As New RelationCollection()
			relations.Add(ListaPrecioEntity.Relations.ListaPrecioEntityUsingListaBase, "ListaPrecio_")
		...
		''' <summary>
		''' Deletes from the persistent storage all 'ListaPrecio' entities which have data in common
		''' with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="plaza_Instance">PlazaEntity instance to use as a filter for the ListaPrecioEntity objects to delete</param>
		''' <param name="tipoVentaInstance">TipoVentaEntity instance to use as a filter for the ListaPrecioEntity objects to delete</param>
		''' <param name="listaPrecioBaseInstance">ListaPrecioEntity instance to use as a filter for the ListaPrecioEntity objects to delete</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function DeleteMulti(containingTransaction As ITransaction, plaza_Instance As IEntity, tipoVentaInstance As IEntity, listaPrecioBaseInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ListaPrecioEntity)
			Dim deleteFilter As IPredicateExpression = CreateFilterUsingForeignKeys(plaza_Instance, tipoVentaInstance, listaPrecioBaseInstance, fields)
		...
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="plaza_Instance">PlazaEntity instance to use as a filter for the ListaPrecioEntity objects to update</param>
		''' <param name="tipoVentaInstance">TipoVentaEntity instance to use as a filter for the ListaPrecioEntity objects to update</param>
		''' <param name="listaPrecioBaseInstance">ListaPrecioEntity instance to use as a filter for the ListaPrecioEntity objects to update</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As IEntity, containingTransaction As ITransaction, plaza_Instance As IEntity, tipoVentaInstance As IEntity, listaPrecioBaseInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ListaPrecioEntity)
			Dim updateFilter As IPredicateExpression = CreateFilterUsingForeignKeys(plaza_Instance, tipoVentaInstance, listaPrecioBaseInstance, fields)
		...
		''' </summary>
		''' <param name="plaza_Instance">PlazaEntity instance to use as a filter for the ListaPrecioEntity objects</param>
		''' <param name="tipoVentaInstance">TipoVentaEntity instance to use as a filter for the ListaPrecioEntity objects</param>
		''' <param name="listaPrecioBaseInstance">ListaPrecioEntity instance to use as a filter for the ListaPrecioEntity objects</param>
		''' <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		''' <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		Private Function CreateFilterUsingForeignKeys(plaza_Instance As IEntity, tipoVentaInstance As IEntity, listaPrecioBaseInstance As IEntity, fieldsToReturn As IEntityFields) As IPredicateExpression
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			
			If Not plaza_Instance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(ListaPrecioFieldIndex.Plaza)), ComparisonOperator.Equal, CType(plaza_Instance, PlazaEntity).Codigo))
			End If
			If Not tipoVentaInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(ListaPrecioFieldIndex.LpidTipoVenta)), ComparisonOperator.Equal, CType(tipoVentaInstance, TipoVentaEntity).Codigo))
			End If
			If Not listaPrecioBaseInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(ListaPrecioFieldIndex.ListaBase)), ComparisonOperator.Equal, CType(listaPrecioBaseInstance, ListaPrecioEntity).Codigo))
			End If
			Return selectFilter
		End Function
