...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the MsccatProductos Entity. It will perform database oriented actions for
	''' a entity of type 'MsccatProductosEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class MsccatProductosDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "MsccatProductosEntity", New MsccatProductosEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves in the calling MsccatProductosCollection object all MsccatProductosEntity objects which have data in common
		...
		Public Overloads Function GetMulti(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			MyBase.EntityFactoryToUse = entityFactoryToUse
			Dim fieldsToReturn  As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim selectFilter As IPredicateExpression= CreateFilterUsingForeignKeys(cuentaContableInstance, fieldsToReturn)
		...
		''' <summary>
		''' Retrieves entities of the type 'MsccatProductosEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		''' If the used Dynamic Query Engine supports it, 'TOP' is used to limit the amount of rows to return. When set to 0, no limitations are specified.</param>
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		''' <summary>
		''' Retrieves in the calling MsccatProductosCollection object all MsccatProductosEntity objects
		...
		Public Function GetMultiUsingMfacEmbarquesCabCollectionViaMfacEmbarquesDet(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mfacEmbarquesCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(MsccatProductosEntity.Relations.MfacEmbarquesDetEntityUsingIdProducto, "MfacEmbarquesDet_")
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingMfacEmbarquesCabCollectionViaDevolucionProductos(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mfacEmbarquesCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim relations As New RelationCollection()
			relations.Add(MsccatProductosEntity.Relations.DevolucionProductosEntityUsingIdProducto, "DevolucionProductos_")
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingMfacEmbarquesCabCollectionViaDevolucionProductos(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mfacEmbarquesCabInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim relations As  New RelationCollection()
			relations.Add(MsccatProductosEntity.Relations.DevolucionProductosEntityUsingIdProducto, "DevolucionProductos_")
			relations.Add(DevolucionProductosEntity.Relations.MfacEmbarquesCabEntityUsingEmbarque, "DevolucionProductos_", String.Empty, JoinHint.None)
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCatRastrosCollectionViaMscrelacionProductosRastros(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, catRastrosInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim relations As New RelationCollection()
			relations.Add(MsccatProductosEntity.Relations.MscrelacionProductosRastrosEntityUsingCodProducto, "MscrelacionProductosRastros_")
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCatRastrosCollectionViaMscrelacionProductosRastros(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, catRastrosInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim relations As  New RelationCollection()
			relations.Add(MsccatProductosEntity.Relations.MscrelacionProductosRastrosEntityUsingCodProducto, "MscrelacionProductosRastros_")
			relations.Add(MscrelacionProductosRastrosEntity.Relations.CatRastrosEntityUsingCodRastro, "MscrelacionProductosRastros_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingMcgcatTiposdeGanadoCollectionViaUsrProdRecepcionDetalle(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mcgcatTiposdeGanadoInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim relations As New RelationCollection()
			relations.Add(MsccatProductosEntity.Relations.UsrProdRecepcionDetalleEntityUsingIdProducto, "UsrProdRecepcionDetalle_")
		...
		''' <summary>
		''' Deletes from the persistent storage all 'MsccatProductos' entities which have data in common
		''' with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="cuentaContableInstance">CuentaContableEntity instance to use as a filter for the MsccatProductosEntity objects to delete</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function DeleteMulti(containingTransaction As ITransaction, cuentaContableInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim deleteFilter As IPredicateExpression = CreateFilterUsingForeignKeys(cuentaContableInstance, fields)
		...
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="cuentaContableInstance">CuentaContableEntity instance to use as a filter for the MsccatProductosEntity objects to update</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As IEntity, containingTransaction As ITransaction, cuentaContableInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MsccatProductosEntity)
			Dim updateFilter As IPredicateExpression = CreateFilterUsingForeignKeys(cuentaContableInstance, fields)
		...
		''' </summary>
		''' <param name="cuentaContableInstance">CuentaContableEntity instance to use as a filter for the MsccatProductosEntity objects</param>
		''' <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		''' <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		Private Function CreateFilterUsingForeignKeys(cuentaContableInstance As IEntity, fieldsToReturn As IEntityFields) As IPredicateExpression
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			
			If Not cuentaContableInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(MsccatProductosFieldIndex.IdCeuntaContable)), ComparisonOperator.Equal, CType(cuentaContableInstance, CuentaContableEntity).Codigo))
			End If
			Return selectFilter
		End Function
