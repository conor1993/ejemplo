...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the TipoProveedor Entity. It will perform database oriented actions for
	''' a entity of type 'TipoProveedorEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class TipoProveedorDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "TipoProveedorEntity", New TipoProveedorEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'TipoProveedorEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoProveedorEntity)
		...
		''' <summary>
		''' Retrieves in the calling TipoProveedorCollection object all TipoProveedorEntity objects
		...
		Public Function GetMultiUsingBancoCollectionViaProveedorAvanzado(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, bancosInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoProveedorEntity)
			Dim relations As New RelationCollection()
			relations.Add(TipoProveedorEntity.Relations.ProveedorAvanzadoEntityUsingCodigoTipoProveedor, "ProveedorAvanzado_")
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingBancoCollectionViaProveedorAvanzado(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, bancosInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoProveedorEntity)
			Dim relations As  New RelationCollection()
			relations.Add(TipoProveedorEntity.Relations.ProveedorAvanzadoEntityUsingCodigoTipoProveedor, "ProveedorAvanzado_")
			relations.Add(ProveedorAvanzadoEntity.Relations.BancosEntityUsingCodigoBanco, "ProveedorAvanzado_", String.Empty, JoinHint.None)
