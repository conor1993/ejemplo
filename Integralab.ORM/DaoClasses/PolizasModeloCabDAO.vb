...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the PolizasModeloCab Entity. It will perform database oriented actions for
	''' a entity of type 'PolizasModeloCabEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class PolizasModeloCabDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "PolizasModeloCabEntity", New PolizasModeloCabEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'PolizasModeloCabEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PolizasModeloCabEntity)
		...
		''' <summary>
		''' Retrieves in the calling PolizasModeloCabCollection object all PolizasModeloCabEntity objects
