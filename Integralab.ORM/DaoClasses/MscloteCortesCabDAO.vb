...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the MscloteCortesCab Entity. It will perform database oriented actions for
	''' a entity of type 'MscloteCortesCabEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class MscloteCortesCabDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "MscloteCortesCabEntity", New MscloteCortesCabEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves in the calling MscloteCortesCabCollection object all MscloteCortesCabEntity objects which have data in common
		...
		''' <summary>
		''' Retrieves entities of the type 'MscloteCortesCabEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		''' If the used Dynamic Query Engine supports it, 'TOP' is used to limit the amount of rows to return. When set to 0, no limitations are specified.</param>
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		''' <summary>
		''' Retrieves in the calling MscloteCortesCabCollection object all MscloteCortesCabEntity objects
		...
		Public Function GetMultiUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mscmovtosAlmacenCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MscloteCortesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(MscloteCortesCabEntity.Relations.MscloteCortesDetEntityUsingLoteCorte, "MscloteCortesDet_")
		...
		''' <summary>
		''' Deletes from the persistent storage all 'MscloteCortesCab' entities which have data in common
		''' with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
