...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the McecatCorralesCab Entity. It will perform database oriented actions for
	''' a entity of type 'McecatCorralesCabEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class McecatCorralesCabDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "McecatCorralesCabEntity", New McecatCorralesCabEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves in the calling McecatCorralesCabCollection object all McecatCorralesCabEntity objects which have data in common
		...
		Public Overloads Function GetMulti(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression, mcecatTiposCorralInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			MyBase.EntityFactoryToUse = entityFactoryToUse
			Dim fieldsToReturn  As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim selectFilter As IPredicateExpression= CreateFilterUsingForeignKeys(mcecatTiposCorralInstance, fieldsToReturn)
		...
		''' <summary>
		''' Retrieves entities of the type 'McecatCorralesCabEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		''' If the used Dynamic Query Engine supports it, 'TOP' is used to limit the amount of rows to return. When set to 0, no limitations are specified.</param>
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		''' <summary>
		''' Retrieves in the calling McecatCorralesCabCollection object all McecatCorralesCabEntity objects
		...
		Public Function GetMultiUsingAplicMediCollectionViaAplicMediDet(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, aplicMediInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(McecatCorralesCabEntity.Relations.AplicMediDetEntityUsingIdCorral, "AplicMediDet_")
		...
		Public Function GetMultiUsingAplicMediCollectionViaAplicMediDetDet(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, aplicMediInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.AplicMediDetDetEntityUsingIdCorral, "AplicMediDetDet_")
...
selectFilter.Add(New FieldCompareValuePredicate(aplicMediDetInstance.Fields(CInt(AplicMediDetFieldIndex.IdCorral)), ComparisonOperator.Equal))
		...
		Public Function GetMultiUsingCabMovGanCollectionViaCabRegCom(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.CabRegComEntityUsingCveCorral, "CabRegCom_")
		...
		Public Function GetMultiUsingCabAplForCollectionViaDetAplFor(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabAplForInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.DetAplForEntityUsingCveCorral, "DetAplFor_")
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingProductoCollectionViaDetAplFor(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, productoInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.DetAplForEntityUsingCveCorral, "DetAplFor_")
		...
		''' <summary>
		''' Retrieves in the calling McecatCorralesCabCollection object all McecatCorralesCabEntity objects
		''' which are related via a relation of type 'm:n' with the passed in CierreLoteEntity. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCierreLoteCollectionViaMcecatLotesCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cierreLoteInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.McecatLotesCabEntityUsingIdCorral, "McecatLotesCab_")
			...
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			selectFilter.Add(New FieldCompareValuePredicate(cierreLoteInstance.Fields(CInt(CierreLoteFieldIndex.IdCierreLote)), ComparisonOperator.Equal))
			Return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCierreLoteCollectionViaMcecatLotesCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cierreLoteInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As  New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.McecatLotesCabEntityUsingIdCorral, "McecatLotesCab_")
			relations.Add(McecatLotesCabEntity.Relations.CierreLoteEntityUsingIdCierreLote, "McecatLotesCab_", String.Empty, JoinHint.None)
		...
		''' <summary>
		''' Retrieves in the calling McecatCorralesCabCollection object all McecatCorralesCabEntity objects
		''' which are related via a relation of type 'm:n' with the passed in CatProveedoresEntity. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCatProveedoresCollectionViaMcgcompraGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, catProveedoresInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.McgcompraGanadoCabEntityUsingIdCorral, "McgcompraGanadoCab_")
			...
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			selectFilter.Add(New FieldCompareValuePredicate(catProveedoresInstance.Fields(CInt(CatProveedoresFieldIndex.IdProveedor)), ComparisonOperator.Equal))
			Return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingCatProveedoresCollectionViaMcgcompraGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, catProveedoresInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As  New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.McgcompraGanadoCabEntityUsingIdCorral, "McgcompraGanadoCab_")
			relations.Add(McgcompraGanadoCabEntity.Relations.CatProveedoresEntityUsingIdProveedor, "McgcompraGanadoCab_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingMcecatLotesCabCollectionViaProrraRec(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, mcecatLotesCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.ProrraRecEntityUsingIdCorralReciba, "ProrraRec_")
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingSalidaGanadoCabCollectionViaProrraRec(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, salidaGanadoCabInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.ProrraRecEntityUsingIdCorralReciba, "ProrraRec_")
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingSalidaGanadoCabCollectionViaProrraRec(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, salidaGanadoCabInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As  New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.ProrraRecEntityUsingIdCorralReciba, "ProrraRec_")
			relations.Add(ProrraRecEntity.Relations.SalidaGanadoCabEntityUsingIdSalidaGanadoCab, "ProrraRec_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingCabMovGanCollectionViaSalidaGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim relations As New RelationCollection()
			relations.Add(McecatCorralesCabEntity.Relations.SalidaGanadoCabEntityUsingIdCorral, "SalidaGanadoCab_")
		...
		''' <summary>
		''' Deletes from the persistent storage all 'McecatCorralesCab' entities which have data in common
		''' with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="mcecatTiposCorralInstance">McecatTiposCorralEntity instance to use as a filter for the McecatCorralesCabEntity objects to delete</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function DeleteMulti(containingTransaction As ITransaction, mcecatTiposCorralInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim deleteFilter As IPredicateExpression = CreateFilterUsingForeignKeys(mcecatTiposCorralInstance, fields)
		...
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="mcecatTiposCorralInstance">McecatTiposCorralEntity instance to use as a filter for the McecatCorralesCabEntity objects to update</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As IEntity, containingTransaction As ITransaction, mcecatTiposCorralInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McecatCorralesCabEntity)
			Dim updateFilter As IPredicateExpression = CreateFilterUsingForeignKeys(mcecatTiposCorralInstance, fields)
		...
		''' </summary>
		''' <param name="mcecatTiposCorralInstance">McecatTiposCorralEntity instance to use as a filter for the McecatCorralesCabEntity objects</param>
		''' <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		''' <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		Private Function CreateFilterUsingForeignKeys(mcecatTiposCorralInstance As IEntity, fieldsToReturn As IEntityFields) As IPredicateExpression
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			
			If Not mcecatTiposCorralInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(McecatCorralesCabFieldIndex.IdTipoCorral)), ComparisonOperator.Equal, CType(mcecatTiposCorralInstance, McecatTiposCorralEntity).IdTipoCorral))
			End If
			Return selectFilter
		End Function
