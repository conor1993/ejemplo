...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the Zona Entity. It will perform database oriented actions for
	''' a entity of type 'ZonaEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class ZonaDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "ZonaEntity", New ZonaEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'ZonaEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ZonaEntity)
