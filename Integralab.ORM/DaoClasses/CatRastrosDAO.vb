...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the CatRastros Entity. It will perform database oriented actions for
	''' a entity of type 'CatRastrosEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class CatRastrosDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "CatRastrosEntity", New CatRastrosEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'CatRastrosEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CatRastrosEntity)
		...
		''' <summary>
		''' Retrieves in the calling CatRastrosCollection object all CatRastrosEntity objects
		...
		Public Function GetMultiUsingMsccatProductosCollectionViaMscrelacionProductosRastros(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, msccatProductosInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CatRastrosEntity)
			Dim relations As New RelationCollection()
			relations.Add(CatRastrosEntity.Relations.MscrelacionProductosRastrosEntityUsingCodRastro, "MscrelacionProductosRastros_")
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingMsccatProductosCollectionViaMscrelacionProductosRastros(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, msccatProductosInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CatRastrosEntity)
			Dim relations As  New RelationCollection()
			relations.Add(CatRastrosEntity.Relations.MscrelacionProductosRastrosEntityUsingCodRastro, "MscrelacionProductosRastros_")
			relations.Add(MscrelacionProductosRastrosEntity.Relations.MsccatProductosEntityUsingCodProducto, "MscrelacionProductosRastros_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingCabMovGanCollectionViaSalidaGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CatRastrosEntity)
			Dim relations As New RelationCollection()
			relations.Add(CatRastrosEntity.Relations.SalidaGanadoCabEntityUsingIdRastro, "SalidaGanadoCab_")
