...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the MinvTransferenciaAlmacenProd Entity. It will perform database oriented actions for
	''' a entity of type 'MinvTransferenciaAlmacenProdEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class MinvTransferenciaAlmacenProdDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "MinvTransferenciaAlmacenProdEntity", New MinvTransferenciaAlmacenProdEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'MinvTransferenciaAlmacenProdEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MinvTransferenciaAlmacenProdEntity)
		...
		''' <summary>
		''' Retrieves in the calling MinvTransferenciaAlmacenProdCollection object all MinvTransferenciaAlmacenProdEntity objects
