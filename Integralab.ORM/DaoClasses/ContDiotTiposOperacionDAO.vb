...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the ContDiotTiposOperacion Entity. It will perform database oriented actions for
	''' a entity of type 'ContDiotTiposOperacionEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class ContDiotTiposOperacionDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "ContDiotTiposOperacionEntity", New ContDiotTiposOperacionEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'ContDiotTiposOperacionEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity)
		...
		''' <summary>
		''' Retrieves in the calling ContDiotTiposOperacionCollection object all ContDiotTiposOperacionEntity objects
		...
		Public Function GetMultiUsingCatLugaresDeCompraCollectionViaProveedor(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, catLugaresDeCompraInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, "Proveedor_")
