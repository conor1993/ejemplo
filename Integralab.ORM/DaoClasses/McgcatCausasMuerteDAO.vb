...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the McgcatCausasMuerte Entity. It will perform database oriented actions for
	''' a entity of type 'McgcatCausasMuerteEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class McgcatCausasMuerteDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "McgcatCausasMuerteEntity", New McgcatCausasMuerteEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'McgcatCausasMuerteEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.McgcatCausasMuerteEntity)
		...
		''' <summary>
		''' Retrieves in the calling McgcatCausasMuerteCollection object all McgcatCausasMuerteEntity objects
		...
		Public Function GetMultiUsingCabMovGanCollectionViaSalidaGanadoCab(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(McgcatCausasMuerteEntity.Relations.SalidaGanadoCabEntityUsingIdCausaMuerte, "SalidaGanadoCab_")
