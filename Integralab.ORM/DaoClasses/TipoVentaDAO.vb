...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the TipoVenta Entity. It will perform database oriented actions for
	''' a entity of type 'TipoVentaEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class TipoVentaDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "TipoVentaEntity", New TipoVentaEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'TipoVentaEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.TipoVentaEntity)
		...
		''' <summary>
		''' Retrieves in the calling TipoVentaCollection object all TipoVentaEntity objects
		...
		Public Function GetMultiUsingPlazaCollectionViaListaPrecio(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, plazaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(TipoVentaEntity.Relations.ListaPrecioEntityUsingLpidTipoVenta, "ListaPrecio_")
