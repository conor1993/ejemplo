...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the Bancos Entity. It will perform database oriented actions for
	''' a entity of type 'BancosEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class BancosDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "BancosEntity", New BancosEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'BancosEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.BancosEntity)
		...
		''' <summary>
		''' Retrieves in the calling BancosCollection object all BancosEntity objects
		''' which are related via a relation of type 'm:n' with the passed in TipoProveedorEntity. 
		''' </summary>
		...
		Public Function GetMultiUsingTipoProveedorCollectionViaProveedorAvanzado(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, tipoProveedorInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.BancosEntity)
			Dim relations As New RelationCollection()
			relations.Add(BancosEntity.Relations.ProveedorAvanzadoEntityUsingCodigoBanco, "ProveedorAvanzado_")
			...
			selectFilter.Add(New FieldCompareValuePredicate(tipoProveedorInstance.Fields(CInt(TipoProveedorFieldIndex.Codigo)), ComparisonOperator.Equal))
		...
		Public Function GetMultiUsingTipoMonedaCollectionViaCuenta(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, tipoMonedaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.BancosEntity)
			Dim relations As New RelationCollection()
			relations.Add(BancosEntity.Relations.CuentaEntityUsingBancoId, "Cuenta_")
