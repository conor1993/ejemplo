...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the MotivoCancelacion Entity. It will perform database oriented actions for
	''' a entity of type 'MotivoCancelacionEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class MotivoCancelacionDAO 
		...
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "MotivoCancelacionEntity", New MotivoCancelacionEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'MotivoCancelacionEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MotivoCancelacionEntity)
		...
		''' <summary>
		''' Retrieves in the calling MotivoCancelacionCollection object all MotivoCancelacionEntity objects
		''' which are related via a relation of type 'm:n' with the passed in ModuloEntity. 
		''' </summary>
		...
		Public Function GetMultiUsingModuloCollectionViaMotivosCancelacionDetalle(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, moduloInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MotivoCancelacionEntity)
			Dim relations As New RelationCollection()
			relations.Add(MotivoCancelacionEntity.Relations.MotivoCancelacionDetalleEntityUsingIdmotivo, "MotivoCancelacionDetalle_")
			...
			selectFilter.Add(New FieldCompareValuePredicate(moduloInstance.Fields(CInt(ModuloFieldIndex.Codigo)), ComparisonOperator.Equal))
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingModuloCollectionViaMotivosCancelacionDetalle(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, moduloInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MotivoCancelacionEntity)
			Dim relations As  New RelationCollection()
			relations.Add(MotivoCancelacionEntity.Relations.MotivoCancelacionDetalleEntityUsingIdmotivo, "MotivoCancelacionDetalle_")
			relations.Add(MotivoCancelacionDetalleEntity.Relations.ModuloEntityUsingIdmodulo, "MotivoCancelacionDetalle_", String.Empty, JoinHint.None)
		...
		''' <summary>
		''' Retrieves in the calling MotivoCancelacionCollection object all MotivoCancelacionEntity objects
		''' which are related via a relation of type 'm:n' with the passed in TipoPresupuestoEntity. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="collectionToFill">Collection to fill with the entity objects retrieved</param>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingTipoPresupuestoCollectionViaMcomPresupuesto(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, tipoPresupuestoInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MotivoCancelacionEntity)
			Dim relations As New RelationCollection()
			relations.Add(MotivoCancelacionEntity.Relations.PresupuestoEntityUsingMotivoCancelacionId, "Presupuesto_")
			...
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			selectFilter.Add(New FieldCompareValuePredicate(tipoPresupuestoInstance.Fields(CInt(TipoPresupuestoFieldIndex.Codigo)), ComparisonOperator.Equal))
			Return GetMulti(containingTransaction, collectionToFill, maxNumberOfItemsToReturn, sortClauses, entityFactoryToUse, selectFilter, relations, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Function GetMultiUsingTipoPresupuestoCollectionViaMcomPresupuesto(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, tipoPresupuestoInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MotivoCancelacionEntity)
			Dim relations As  New RelationCollection()
			relations.Add(MotivoCancelacionEntity.Relations.PresupuestoEntityUsingMotivoCancelacionId, "Presupuesto_")
			relations.Add(PresupuestoEntity.Relations.TipoPresupuestoEntityUsingTipoPresupuestoId, "Presupuesto_", String.Empty, JoinHint.None)
		...
		Public Function GetMultiUsingAlmacenCollectionViaRecepcionOrdenCompra(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, almacenInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MotivoCancelacionEntity)
			Dim relations As New RelationCollection()
			relations.Add(MotivoCancelacionEntity.Relations.RecepcionOrdenCompraEntityUsingMotivoCancelacionId, "RecepcionOrdenCompra_")
