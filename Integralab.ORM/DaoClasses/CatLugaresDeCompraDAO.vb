...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the CatLugaresDeCompra Entity. It will perform database oriented actions for
	''' a entity of type 'CatLugaresDeCompraEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class CatLugaresDeCompraDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "CatLugaresDeCompraEntity", New CatLugaresDeCompraEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'CatLugaresDeCompraEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CatLugaresDeCompraEntity)
		...
		''' <summary>
		''' Retrieves in the calling CatLugaresDeCompraCollection object all CatLugaresDeCompraEntity objects
		...
		Public Function GetMultiUsingCabMovGanCollectionViaCabRegCom(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabMovGanInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(CatLugaresDeCompraEntity.Relations.CabRegComEntityUsingCveLugCom, "CabRegCom_")
		...
		Public Function GetMultiUsingCuentaContableCollectionViaProveedor(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.CatLugaresDeCompraEntity)
			Dim relations As New RelationCollection()
			relations.Add(CatLugaresDeCompraEntity.Relations.ProveedorEntityUsingIdLugarCompra, "Proveedor_")
