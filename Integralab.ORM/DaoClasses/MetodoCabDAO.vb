...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the MetodoCab Entity. It will perform database oriented actions for
	''' a entity of type 'MetodoCabEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class MetodoCabDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "MetodoCabEntity", New MetodoCabEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'MetodoCabEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.MetodoCabEntity)
		...
		''' <summary>
		''' Retrieves in the calling MetodoCabCollection object all MetodoCabEntity objects
		...
		Public Function GetMultiUsingCuentaContableCollectionViaGastosDepartamentos(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(MetodoCabEntity.Relations.GastosDepartamentosEntityUsingIdMetodoProrrateo, "GastosDepartamentos_")
