...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the NomCatPuestos Entity. It will perform database oriented actions for
	''' a entity of type 'NomCatPuestosEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class NomCatPuestosDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "NomCatPuestosEntity", New NomCatPuestosEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'NomCatPuestosEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.NomCatPuestosEntity)
		...
		''' <summary>
		''' Retrieves in the calling NomCatPuestosCollection object all NomCatPuestosEntity objects
		...
		Public Function GetMultiUsingCatDeptosCollectionViaNomCatEmpleados(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, catDeptosInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.NomCatPuestosEntity)
			Dim relations As New RelationCollection()
			relations.Add(NomCatPuestosEntity.Relations.NomCatEmpleadosEntityUsingIdPuesto, "NomCatEmpleados_")
