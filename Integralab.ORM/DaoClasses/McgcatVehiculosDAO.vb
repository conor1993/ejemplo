...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the McgcatVehiculos Entity. It will perform database oriented actions for
	''' a entity of type 'McgcatVehiculosEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class McgcatVehiculosDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "McgcatVehiculosEntity", New McgcatVehiculosEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'McgcatVehiculosEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
