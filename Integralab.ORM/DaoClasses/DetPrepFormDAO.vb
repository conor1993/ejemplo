...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the DetPrepForm Entity. It will perform database oriented actions for
	''' a entity of type 'DetPrepFormEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class DetPrepFormDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "DetPrepFormEntity", New DetPrepFormEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves in the calling DetPrepFormCollection object all DetPrepFormEntity objects which have data in common
		...
		Public Overloads Function GetMulti(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression, cabPrepFormInstance As IEntity, productoInstance As IEntity, plazaInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			Dim fieldsToReturn  As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.DetPrepFormEntity)
			Dim selectFilter As IPredicateExpression= CreateFilterUsingForeignKeys(cabPrepFormInstance, productoInstance, plazaInstance, fieldsToReturn)
		...
		''' <summary>
		''' Retrieves entities of the type 'DetPrepFormEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		''' <param name="maxNumberOfItemsToReturn"> The maximum number of items to return with this retrieval query. 
		''' If the used Dynamic Query Engine supports it, 'TOP' is used to limit the amount of rows to return. When set to 0, no limitations are specified.</param>
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		...
		''' <summary>
		''' Retrieves in the calling DetPrepFormCollection object all DetPrepFormEntity objects
		...
		Public Function GetMultiUsingCabPrepFormCollectionViaDetPrepFormLote(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cabPrepFormInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			relations.Add(DetPrepFormEntity.Relations.DetPrepFormLoteEntityUsingFolPrepFormCveProductoIdPlaza, "DetPrepFormLote_")
...
selectFilter.Add(New FieldCompareValuePredicate(cabPrepFormInstance.Fields(CInt(CabPrepFormFieldIndex.IdPlaza)), ComparisonOperator.Equal))
		...
		''' <summary>
		''' Deletes from the persistent storage all 'DetPrepForm' entities which have data in common
		''' with the specified related Entities. If one is omitted, that entity is not used as a filter. 
		''' </summary>
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="cabPrepFormInstance">CabPrepFormEntity instance to use as a filter for the DetPrepFormEntity objects to delete</param>
		''' <param name="productoInstance">ProductoEntity instance to use as a filter for the DetPrepFormEntity objects to delete</param>
		''' <param name="plazaInstance">PlazaEntity instance to use as a filter for the DetPrepFormEntity objects to delete</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function DeleteMulti(containingTransaction As ITransaction, cabPrepFormInstance As IEntity, productoInstance As IEntity, plazaInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.DetPrepFormEntity)
			Dim deleteFilter As IPredicateExpression = CreateFilterUsingForeignKeys(cabPrepFormInstance, productoInstance, plazaInstance, fields)
		...
		''' <param name="containingTransaction">A containing transaction, if caller is added to a transaction, or Nothing if not.</param>
		''' <param name="cabPrepFormInstance">CabPrepFormEntity instance to use as a filter for the DetPrepFormEntity objects to update</param>
		''' <param name="productoInstance">ProductoEntity instance to use as a filter for the DetPrepFormEntity objects to update</param>
		''' <param name="plazaInstance">PlazaEntity instance to use as a filter for the DetPrepFormEntity objects to update</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As IEntity, containingTransaction As ITransaction, cabPrepFormInstance As IEntity, productoInstance As IEntity, plazaInstance As IEntity) As Integer
			Dim fields As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.DetPrepFormEntity)
			Dim updateFilter As IPredicateExpression = CreateFilterUsingForeignKeys(cabPrepFormInstance, productoInstance, plazaInstance, fields)
		...
		''' </summary>
		''' <param name="cabPrepFormInstance">CabPrepFormEntity instance to use as a filter for the DetPrepFormEntity objects</param>
		''' <param name="productoInstance">ProductoEntity instance to use as a filter for the DetPrepFormEntity objects</param>
		''' <param name="plazaInstance">PlazaEntity instance to use as a filter for the DetPrepFormEntity objects</param>
		''' <param name="fieldsToReturn">IEntityFields implementation which forms the definition of the fieldset of the target entity.</param>
		''' <returns>A ready to use PredicateExpression based on the passed in foreign key value holders.</returns>
		Private Function CreateFilterUsingForeignKeys(cabPrepFormInstance As IEntity, productoInstance As IEntity, plazaInstance As IEntity, fieldsToReturn As IEntityFields) As IPredicateExpression
			Dim selectFilter As IPredicateExpression = New PredicateExpression()
			
			If Not cabPrepFormInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(DetPrepFormFieldIndex.FolPrepForm)), ComparisonOperator.Equal, CType(cabPrepFormInstance, CabPrepFormEntity).FolPrepForm))
selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(DetPrepFormFieldIndex.IdPlaza)), ComparisonOperator.Equal, CType(cabPrepFormInstance, CabPrepFormEntity).IdPlaza))
			End If
			If Not productoInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(DetPrepFormFieldIndex.CveProducto)), ComparisonOperator.Equal, CType(productoInstance, ProductoEntity).Codigo))
			End If
			If Not plazaInstance Is Nothing Then
				selectFilter.Add(New FieldCompareValuePredicate(fieldsToReturn(CInt(DetPrepFormFieldIndex.IdPlaza)), ComparisonOperator.Equal, CType(plazaInstance, PlazaEntity).Codigo))
			End If
			Return selectFilter
		End Function
