...
Namespace Integralab.ORM.DaoClasses
	...
	''' <summary>
	''' General DAO class for the PeriodosCont Entity. It will perform database oriented actions for
	''' a entity of type 'PeriodosContEntity'. This DAO works on an EntityFields object. 
	''' </summary>
	Public Class PeriodosContDAO 
		Inherits DaoBase
		
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(InheritanceInfoProviderSingleton.GetInstance(), New DynamicQueryEngine(), InheritanceHierarchyType.None, "PeriodosContEntity", New PeriodosContEntityFactory())
		End Sub
		...
		''' <summary>
		''' Retrieves entities of the type 'PeriodosContEntity' in a datatable which match the specified filter. It will always create a new connection to the database.
		''' </summary>
		...
		Public Overridable Function GetMultiAsDataTable(maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, selectFilter As IPredicate, relations As IRelationCollection, pageNumber As Integer, pageSize As Integer) As  DataTable
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PeriodosContEntity)
		...
		''' <summary>
		''' Retrieves in the calling PeriodosContCollection object all PeriodosContEntity objects
		...
		Public Function GetMultiUsingCuentaContableCollectionViaAcumuladoCuentasContables(containingTransaction As ITransaction, collectionToFill As IEntityCollection, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, entityFactoryToUse As IEntityFactory, cuentaContableInstance As IEntity, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim fieldsToReturn As IEntityFields = EntityFieldsFactory.CreateEntityFieldsObject(Integralab.ORM.EntityType.PeriodosContEntity)
			Dim relations As New RelationCollection()
			relations.Add(PeriodosContEntity.Relations.AcumuladoCuentasContablesEntityUsingEjercicio, "AcumuladoCuentasContables_")
