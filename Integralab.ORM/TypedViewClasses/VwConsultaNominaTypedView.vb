...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwConsultaNomina'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwConsultaNominaTypedView 
#Else
	Public Class VwConsultaNominaTypedView 
#End If	
		Inherits DataTable
...
#Region "Class Constants"
		...
		''' </summary>
		Private Const AmountOfFields As Integer = 3
#End Region
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwConsultaNominaTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwConsultaNominaTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwConsultaNominaRow(rowBuilder)
		End Function
		...
		Protected Overrides Function GetRowType() As Type
			Return GetType(VwConsultaNominaRow)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwConsultaNominaTypedView = CType(MyBase.Clone(), VwConsultaNominaTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwConsultaNominaTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwConsultaNominaTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwConsultaNominaTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwConsultaNominaRow
			Get 
				Return CType(Me.Rows(index), VwConsultaNominaRow)
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwConsultaNomina
	''' </summary>
	Public Class VwConsultaNominaRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwConsultaNominaTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwConsultaNominaTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwConsultaNomina"."Folio"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwConsultaNomina"."Quincena"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwConsultaNomina"."Fecha"<br/>
