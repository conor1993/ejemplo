...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwAlmKardexProduccionDet'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwAlmKardexProduccionDetTypedView 
#Else
	Public Class VwAlmKardexProduccionDetTypedView 
#End If	
		Inherits DataTable
...
#End Region
		...
		''' </summary>
		Public Sub New()
			MyBase.New("VwAlmKardexProduccionDet")
			InitClass()
		End Sub
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwAlmKardexProduccionDetTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwAlmKardexProduccionDetTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwAlmKardexProduccionDetRow(rowBuilder)
		End Function
		...
		Protected Overrides Function GetRowType() As Type
			Return GetType(VwAlmKardexProduccionDetRow)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwAlmKardexProduccionDetTypedView = CType(MyBase.Clone(), VwAlmKardexProduccionDetTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwAlmKardexProduccionDetTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwAlmKardexProduccionDetTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwAlmKardexProduccionDetTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwAlmKardexProduccionDetRow
			Get 
				Return CType(Me.Rows(index), VwAlmKardexProduccionDetRow)
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwAlmKardexProduccionDet
	''' </summary>
	Public Class VwAlmKardexProduccionDetRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwAlmKardexProduccionDetTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwAlmKardexProduccionDetTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."IdFolioMovimiento"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."FechaMovimiento"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."IdCodProducto"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."Descripcion"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."CantKilos"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."CantPzas"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."CostoUnitario"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."IdCodAlmacen"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."Almacen"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccionDet"."Direccion"<br/>
