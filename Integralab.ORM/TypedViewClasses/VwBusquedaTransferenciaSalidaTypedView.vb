...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwBusquedaTransferenciaSalida'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwBusquedaTransferenciaSalidaTypedView 
#Else
	Public Class VwBusquedaTransferenciaSalidaTypedView 
#End If	
		Inherits DataTable
...
#Region "Class Member Declarations"
		Private _columnFolioTransferencia As DataColumn
...
#End Region
		...
		''' </summary>
		Public Sub New()
			MyBase.New("VwBusquedaTransferenciaSalida")
			InitClass()
		End Sub
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwBusquedaTransferenciaSalidaTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwBusquedaTransferenciaSalidaTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwBusquedaTransferenciaSalidaRow(rowBuilder)
		End Function
		...
		Private Sub InitClass()
			...
			_columnFolioTransferencia = New DataColumn("FolioTransferencia", GetType(System.String), Nothing, MappingType.Element)
			_columnFolioTransferencia.ReadOnly = True
			_columnFolioTransferencia.Caption = "FolioTransferencia"
			Me.Columns.Add(_columnFolioTransferencia)
		...
		Private Sub InitMembers()
			_columnFolioTransferencia = Me.Columns("FolioTransferencia")
		...
		Protected Overrides Function GetRowType() As Type
			Return GetType(VwBusquedaTransferenciaSalidaRow)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwBusquedaTransferenciaSalidaTypedView = CType(MyBase.Clone(), VwBusquedaTransferenciaSalidaTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwBusquedaTransferenciaSalidaTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwBusquedaTransferenciaSalidaTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwBusquedaTransferenciaSalidaTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwBusquedaTransferenciaSalidaRow
			Get 
				Return CType(Me.Rows(index), VwBusquedaTransferenciaSalidaRow)
			End Get
		End Property

	
		''' <summary>
		''' Returns the column Object belonging to the TypedView field FolioTransferencia
		''' </summary>
		ReadOnly Friend Property FolioTransferenciaColumn As DataColumn
			Get 
				Return _columnFolioTransferencia 
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwBusquedaTransferenciaSalida
	''' </summary>
	Public Class VwBusquedaTransferenciaSalidaRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwBusquedaTransferenciaSalidaTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwBusquedaTransferenciaSalidaTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' <summary>
		''' Gets / sets the value of the TypedView field FolioTransferencia<br/><br/>
		''' 
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."FolioTransferencia"<br/>
		''' View field characteristics (type, precision, scale, length): Char, 0, 0, 12
		''' </remarks>
		Public Property [FolioTransferencia]() As System.String
			Get 
				If IsFolioTransferenciaNull() Then
					' return default value for this type.
					Return CType(TypeDefaultValue.GetDefaultValue(GetType(System.String)), System.String)
				Else
					Return CType(Me(_parent.FolioTransferenciaColumn), System.String)
				End If
			End Get
			Set 
				Me(_parent.FolioTransferenciaColumn) = Value
			End Set
		End Property

		''' <summary>
		''' Returns True if the TypedView field FolioTransferencia is NULL, False otherwise.
		''' </summary>
		Public Function IsFolioTransferenciaNull() As Boolean
			Return IsNull(_parent.FolioTransferenciaColumn)
		End Function

		''' <summary>
		''' Sets the TypedView field FolioTransferencia to NULL. Not recommended a typed view should be used
		''' as a readonly Object.
		''' </summary>
    	Public Sub SetFolioTransferenciaNull() 
			Me(_parent.FolioTransferenciaColumn) = System.Convert.DBNull
		End Sub
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."IdAlmacenOrigen"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."AlmacenOrigen"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."IdAlmacenDestino"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."AlmacenDestino"<br/>
		''' View field characteristics (type, precision, scale, length): VarChar, 0, 0, 50
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."FechaMovimiento"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."TotalProductos"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."Importe"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."Estatus"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwBusquedaTransferenciaSalida"."EstatusStr"<br/>
