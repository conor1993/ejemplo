...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwReporteDeEmbarquesConcentrado'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwReporteDeEmbarquesConcentradoTypedView 
#Else
	Public Class VwReporteDeEmbarquesConcentradoTypedView 
#End If	
		Inherits DataTable
...
#Region "Class Member Declarations"
		...
		Private _columnImporteFactura As DataColumn
...
#End Region
		...
		''' </summary>
		Public Sub New()
			MyBase.New("VwReporteDeEmbarquesConcentrado")
			InitClass()
		End Sub
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwReporteDeEmbarquesConcentradoTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwReporteDeEmbarquesConcentradoTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwReporteDeEmbarquesConcentradoRow(rowBuilder)
		End Function
		...
		Private Sub InitClass()
			...
			_columnImporteFactura = New DataColumn("ImporteFactura", GetType(System.Decimal), Nothing, MappingType.Element)
			_columnImporteFactura.ReadOnly = True
			_columnImporteFactura.Caption = "ImporteFactura"
			Me.Columns.Add(_columnImporteFactura)
		...
		Private Sub InitMembers()
			...
			_columnImporteFactura = Me.Columns("ImporteFactura")
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("ImporteFactura", fieldHashtable)
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwReporteDeEmbarquesConcentradoTypedView = CType(MyBase.Clone(), VwReporteDeEmbarquesConcentradoTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwReporteDeEmbarquesConcentradoTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwReporteDeEmbarquesConcentradoTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwReporteDeEmbarquesConcentradoTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwReporteDeEmbarquesConcentradoRow
			Get 
		...
		''' <summary>
		''' Returns the column Object belonging to the TypedView field ImporteFactura
		''' </summary>
		ReadOnly Friend Property ImporteFacturaColumn As DataColumn
			Get 
				Return _columnImporteFactura 
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwReporteDeEmbarquesConcentrado
	''' </summary>
	Public Class VwReporteDeEmbarquesConcentradoRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwReporteDeEmbarquesConcentradoTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwReporteDeEmbarquesConcentradoTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."IdCliente"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."Nombre"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."FechaEmbarque"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."IdFolioEmbarque"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."FolioEmbarqueEmp"<br/>
		''' View field characteristics (type, precision, scale, length): Char, 0, 0, 10
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."NoFactura"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."Estatus"<br/>
		...
		''' <summary>
		''' Gets / sets the value of the TypedView field ImporteFactura<br/><br/>
		''' 
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."ImporteFactura"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		Public Property [ImporteFactura]() As System.Decimal
			Get 
				If IsImporteFacturaNull() Then
					' return default value for this type.
					Return CType(TypeDefaultValue.GetDefaultValue(GetType(System.Decimal)), System.Decimal)
				Else
					Return CType(Me(_parent.ImporteFacturaColumn), System.Decimal)
				End If
			End Get
			Set 
				Me(_parent.ImporteFacturaColumn) = Value
			End Set
		End Property

		''' <summary>
		''' Returns True if the TypedView field ImporteFactura is NULL, False otherwise.
		''' </summary>
		Public Function IsImporteFacturaNull() As Boolean
			Return IsNull(_parent.ImporteFacturaColumn)
		End Function

		''' <summary>
		''' Sets the TypedView field ImporteFactura to NULL. Not recommended a typed view should be used
		''' as a readonly Object.
		''' </summary>
    	Public Sub SetImporteFacturaNull() 
			Me(_parent.ImporteFacturaColumn) = System.Convert.DBNull
		End Sub
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwReporteDeEmbarquesConcentrado"."Descripcion"<br/>
