...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwClientes'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwClientesTypedView 
#Else
	Public Class VwClientesTypedView 
#End If	
		Inherits DataTable
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwClientesTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwClientesTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwClientesRow(rowBuilder)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwClientesTypedView = CType(MyBase.Clone(), VwClientesTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwClientesTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwClientesTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwClientesTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwClientesRow
			Get 
				Return CType(Me.Rows(index), VwClientesRow)
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwClientes
	''' </summary>
	Public Class VwClientesRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwClientesTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwClientesTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwClientes"."IdCliente"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "VwClientes"."Nombre"<br/>
