...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwCompSolicitudServicios'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwCompSolicitudServiciosTypedView 
#Else
	Public Class VwCompSolicitudServiciosTypedView 
#End If	
		Inherits DataTable
...
#End Region
		...
		''' </summary>
		Public Sub New()
			MyBase.New("VwCompSolicitudServicios")
			InitClass()
		End Sub
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwCompSolicitudServiciosTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwCompSolicitudServiciosTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwCompSolicitudServiciosRow(rowBuilder)
		End Function
		...
		Protected Overrides Function GetRowType() As Type
			Return GetType(VwCompSolicitudServiciosRow)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwCompSolicitudServiciosTypedView = CType(MyBase.Clone(), VwCompSolicitudServiciosTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwCompSolicitudServiciosTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwCompSolicitudServiciosTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwCompSolicitudServiciosTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwCompSolicitudServiciosRow
			Get 
				Return CType(Me.Rows(index), VwCompSolicitudServiciosRow)
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwCompSolicitudServicios
	''' </summary>
	Public Class VwCompSolicitudServiciosRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwCompSolicitudServiciosTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwCompSolicitudServiciosTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."SucursalId"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."SCDescripcion"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."Folio"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."FechaAlta"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."PLDescripcion"<br/>
		''' View field characteristics (type, precision, scale, length): VarChar, 0, 0, 150
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."PLIdPlaza"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCompSolicitudServicios"."Estatus"<br/>
