...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwCxpfacturasAgrupadas'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwCxpfacturasAgrupadasTypedView 
#Else
	Public Class VwCxpfacturasAgrupadasTypedView 
#End If	
		Inherits DataTable
...
#End Region
		...
		''' </summary>
		Public Sub New()
			MyBase.New("VwCxpfacturasAgrupadas")
			InitClass()
		End Sub
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwCxpfacturasAgrupadasTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwCxpfacturasAgrupadasTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwCxpfacturasAgrupadasRow(rowBuilder)
		End Function
		...
		Protected Overrides Function GetRowType() As Type
			Return GetType(VwCxpfacturasAgrupadasRow)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwCxpfacturasAgrupadasTypedView = CType(MyBase.Clone(), VwCxpfacturasAgrupadasTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwCxpfacturasAgrupadasTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwCxpfacturasAgrupadasTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwCxpfacturasAgrupadasTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwCxpfacturasAgrupadasRow
			Get 
				Return CType(Me.Rows(index), VwCxpfacturasAgrupadasRow)
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwCxpfacturasAgrupadas
	''' </summary>
	Public Class VwCxpfacturasAgrupadasRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwCxpfacturasAgrupadasTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwCxpfacturasAgrupadasTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."NoFactura"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."IdProveedor"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."FechaFactura"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."PrIdTipoProveedor"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."TPrDescripcion"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."PrRazSocial"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."FechaVencimiento"<br/>
		''' View field characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."SubTotal"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."IVA"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."Total"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."Anticipo"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."Cheque"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."EstatusFacturas"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwCXPFacturasAgrupadas"."EsServicio"<br/>
