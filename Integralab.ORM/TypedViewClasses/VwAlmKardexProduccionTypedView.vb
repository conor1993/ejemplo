...
' // Code is generated on: martes, 26 de diciembre de 2017 16:41:40
...
Namespace Integralab.ORM.TypedViewClasses
	''' <summary>
	''' Typed datatable for the view 'VwAlmKardexProduccion'.<br/><br/>
	''' 
	''' </summary>
	''' <remarks>
...
#If Not CF Then	
	...
	Public Class VwAlmKardexProduccionTypedView 
#Else
	Public Class VwAlmKardexProduccionTypedView 
#End If	
		Inherits DataTable
...
#Region "Class Member Declarations"
		...
		Private _columnExtPiezasInicial As DataColumn
		Private _columnExtKilosInicial As DataColumn
		Private _columnCostoProm As DataColumn
...
#End Region
		...
		''' </summary>
		Public Sub New()
			MyBase.New("VwAlmKardexProduccion")
			InitClass()
		End Sub
...
#End If		
		...
		Public Function GetFields() As IEntityFields Implements ITypedView.GetFields
			Return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwAlmKardexProduccionTypedView)
		End Function
		...
		Public Overridable Function GetDbCount(allowDuplicates As Boolean, Filter As IPredicateExpression, groupByClause As GroupByCollection) As Integer Implements ITypedView.GetDbCount
			Dim fieldsInResultset As IEntityFields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.VwAlmKardexProduccionTypedView)
			Dim dao As TypedListDAO = DAOFactory.CreateTypedListDAO()
		...
		Protected Overrides Function NewRowFromBuilder(rowBuilder As DataRowBuilder) As DataRow
			Return New VwAlmKardexProduccionRow(rowBuilder)
		End Function
		...
		Private Sub InitClass()
			...
			_columnExtPiezasInicial = New DataColumn("ExtPiezasInicial", GetType(System.Int32), Nothing, MappingType.Element)
			_columnExtPiezasInicial.ReadOnly = True
			_columnExtPiezasInicial.Caption = "ExtPiezasInicial"
			Me.Columns.Add(_columnExtPiezasInicial)

			_columnExtKilosInicial = New DataColumn("ExtKilosInicial", GetType(System.Decimal), Nothing, MappingType.Element)
			_columnExtKilosInicial.ReadOnly = True
			_columnExtKilosInicial.Caption = "ExtKilosInicial"
			Me.Columns.Add(_columnExtKilosInicial)

			_columnCostoProm = New DataColumn("CostoProm", GetType(System.Decimal), Nothing, MappingType.Element)
			_columnCostoProm.ReadOnly = True
			_columnCostoProm.Caption = "CostoProm"
			Me.Columns.Add(_columnCostoProm)
		...
		Private Sub InitMembers()
			...
			_columnExtPiezasInicial = Me.Columns("ExtPiezasInicial")
			_columnExtKilosInicial = Me.Columns("ExtKilosInicial")
			_columnCostoProm = Me.Columns("CostoProm")
		...
		Protected Overrides Function GetRowType() As Type
			Return GetType(VwAlmKardexProduccionRow)
		End Function
		...
		Public Overrides Function Clone() As DataTable
			Dim cloneToReturn As VwAlmKardexProduccionTypedView = CType(MyBase.Clone(), VwAlmKardexProduccionTypedView)
...
#If Not CF Then
		...
		Protected Overrides Function CreateInstance() As DataTable
			Return New VwAlmKardexProduccionTypedView()
		End Function
#End If
...
#Region "Class Property Declarations"
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Hashtable
			Get
				Return VwAlmKardexProduccionTypedView.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Hashtable
			Get
				Return VwAlmKardexProduccionTypedView.FieldsCustomProperties
			End Get
		End Property
		...
		''' </summary>
		Default ReadOnly Public Property  Item(index As Integer) As VwAlmKardexProduccionRow
			Get 
				Return CType(Me.Rows(index), VwAlmKardexProduccionRow)
			End Get
		End Property
		...
		''' <summary>
		''' Returns the column Object belonging to the TypedView field ExtPiezasInicial
		''' </summary>
		ReadOnly Friend Property ExtPiezasInicialColumn As DataColumn
			Get 
				Return _columnExtPiezasInicial 
			End Get
		End Property
    
		''' <summary>
		''' Returns the column Object belonging to the TypedView field ExtKilosInicial
		''' </summary>
		ReadOnly Friend Property ExtKilosInicialColumn As DataColumn
			Get 
				Return _columnExtKilosInicial 
			End Get
		End Property
    
		''' <summary>
		''' Returns the column Object belonging to the TypedView field CostoProm
		''' </summary>
		ReadOnly Friend Property CostoPromColumn As DataColumn
			Get 
				Return _columnCostoProm 
			End Get
		End Property
...
#End Region
	...
	''' <summary>
	''' Typed datarow for the typed datatable VwAlmKardexProduccion
	''' </summary>
	Public Class VwAlmKardexProduccionRow 
		Inherits DataRow
...
#Region "Class Member Declarations"
		Private _parent As VwAlmKardexProduccionTypedView
#End Region
		...
		Friend Sub New(rowBuilder As DataRowBuilder)
			...
			_parent = CType(Me.Table, VwAlmKardexProduccionTypedView)
		End Sub
...
#Region "Class Property Declarations"
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."IdCodAlmacen"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."IdCodProducto"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."Descripcion"<br/>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."Año"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."Mes"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		...
		''' <summary>
		''' Gets / sets the value of the TypedView field ExtPiezasInicial<br/><br/>
		''' 
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."ExtPiezasInicial"<br/>
		''' View field characteristics (type, precision, scale, length): Int, 10, 0, 0
		''' </remarks>
		Public Property [ExtPiezasInicial]() As System.Int32
			Get 
				If IsExtPiezasInicialNull() Then
					' return default value for this type.
					Return CType(TypeDefaultValue.GetDefaultValue(GetType(System.Int32)), System.Int32)
				Else
					Return CType(Me(_parent.ExtPiezasInicialColumn), System.Int32)
				End If
			End Get
			Set 
				Me(_parent.ExtPiezasInicialColumn) = Value
			End Set
		End Property

		''' <summary>
		''' Returns True if the TypedView field ExtPiezasInicial is NULL, False otherwise.
		''' </summary>
		Public Function IsExtPiezasInicialNull() As Boolean
			Return IsNull(_parent.ExtPiezasInicialColumn)
		End Function

		''' <summary>
		''' Sets the TypedView field ExtPiezasInicial to NULL. Not recommended a typed view should be used
		''' as a readonly Object.
		''' </summary>
    	Public Sub SetExtPiezasInicialNull() 
			Me(_parent.ExtPiezasInicialColumn) = System.Convert.DBNull
		End Sub

	

		''' <summary>
		''' Gets / sets the value of the TypedView field ExtKilosInicial<br/><br/>
		''' 
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."ExtKilosInicial"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		Public Property [ExtKilosInicial]() As System.Decimal
			Get 
				If IsExtKilosInicialNull() Then
					' return default value for this type.
					Return CType(TypeDefaultValue.GetDefaultValue(GetType(System.Decimal)), System.Decimal)
				Else
					Return CType(Me(_parent.ExtKilosInicialColumn), System.Decimal)
				End If
			End Get
			Set 
				Me(_parent.ExtKilosInicialColumn) = Value
			End Set
		End Property

		''' <summary>
		''' Returns True if the TypedView field ExtKilosInicial is NULL, False otherwise.
		''' </summary>
		Public Function IsExtKilosInicialNull() As Boolean
			Return IsNull(_parent.ExtKilosInicialColumn)
		End Function

		''' <summary>
		''' Sets the TypedView field ExtKilosInicial to NULL. Not recommended a typed view should be used
		''' as a readonly Object.
		''' </summary>
    	Public Sub SetExtKilosInicialNull() 
			Me(_parent.ExtKilosInicialColumn) = System.Convert.DBNull
		End Sub

	

		''' <summary>
		''' Gets / sets the value of the TypedView field CostoProm<br/><br/>
		''' 
		''' </summary>
		''' <remarks>
		''' Mapped on view field: "vwAlmKardexProduccion"."CostoProm"<br/>
		''' View field characteristics (type, precision, scale, length): Money, 19, 4, 0
		''' </remarks>
		Public Property [CostoProm]() As System.Decimal
			Get 
				If IsCostoPromNull() Then
					' return default value for this type.
					Return CType(TypeDefaultValue.GetDefaultValue(GetType(System.Decimal)), System.Decimal)
				Else
					Return CType(Me(_parent.CostoPromColumn), System.Decimal)
				End If
			End Get
			Set 
				Me(_parent.CostoPromColumn) = Value
			End Set
		End Property

		''' <summary>
		''' Returns True if the TypedView field CostoProm is NULL, False otherwise.
		''' </summary>
		Public Function IsCostoPromNull() As Boolean
			Return IsNull(_parent.CostoPromColumn)
		End Function

		''' <summary>
		''' Sets the TypedView field CostoProm to NULL. Not recommended a typed view should be used
		''' as a readonly Object.
		''' </summary>
    	Public Sub SetCostoPromNull() 
			Me(_parent.CostoPromColumn) = System.Convert.DBNull
		End Sub
