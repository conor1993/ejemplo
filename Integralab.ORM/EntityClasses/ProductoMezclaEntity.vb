...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'ProductoMezcla'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class ProductoMezclaEntity 
#Else
	<Serializable()> _
	Public Class ProductoMezclaEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="codigoProducto">PK value for ProductoMezcla which data should be fetched into this ProductoMezcla Object</param>
		''' <param name="codigoIngrediente">PK value for ProductoMezcla which data should be fetched into this ProductoMezcla Object</param>
		Public Sub New(codigoProducto As System.Int32, codigoIngrediente As System.Int32)

			InitClassFetch(codigoProducto, codigoIngrediente, CreateValidator(), Nothing)
		End Sub
		...
		Public Sub New(codigoProducto As System.Int32, codigoIngrediente As System.Int32, prefetchPathToUse As IPrefetchPath)

			InitClassFetch(codigoProducto, codigoIngrediente, CreateValidator(), prefetchPathToUse)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="codigoProducto">PK value for ProductoMezcla which data should be fetched into this ProductoMezcla Object</param>
		''' <param name="codigoIngrediente">PK value for ProductoMezcla which data should be fetched into this ProductoMezcla Object</param>
		''' <param name="validator">The custom validator Object for this ProductoMezclaEntity</param>
		Public Sub New(codigoProducto As System.Int32, codigoIngrediente As System.Int32, validator As IValidator)

			InitClassFetch(codigoProducto, codigoIngrediente, validator, Nothing)
		End Sub
		...
		Public Function FetchUsingPK(codigoProducto As System.Int32, codigoIngrediente As System.Int32) As Boolean
			Return FetchUsingPK(codigoProducto, codigoIngrediente, Nothing, Nothing)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(codigoProducto As System.Int32, codigoIngrediente As System.Int32, prefetchPathToUse As IPrefetchPath) As Boolean
			Return FetchUsingPK(codigoProducto, codigoIngrediente, prefetchPathToUse, Nothing)
		End Function
		...
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(codigoProducto As System.Int32, codigoIngrediente As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Return Fetch(codigoProducto, codigoIngrediente, prefetchPathToUse, contextToUse)
		End Function
		...
		Public Overrides Overloads Function Refetch() As Boolean
			Return Fetch(Me.CodigoProducto, Me.CodigoIngrediente, Nothing, Nothing)
		End Function
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As ProductoMezclaFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As ProductoMezclaFieldIndex) As Boolean
		...
		Public Overridable Function GetSingleProducto(forceFetch As Boolean) As ProductoEntity
			If ( Not _alreadyFetchedProducto Or forceFetch Or _alwaysFetchProducto) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				If MyBase.CheckIfLazyLoadingShouldOccur(ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoProducto) Then
		...
		Public Overridable Function GetSingleProducto_(forceFetch As Boolean) As ProductoEntity
			If ( Not _alreadyFetchedProducto_ Or forceFetch Or _alwaysFetchProducto_) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				End If
				Dim fetchResult As Boolean = False
				If MyBase.CheckIfLazyLoadingShouldOccur(ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoIngrediente) Then
					fetchResult = newEntity.FetchUsingPK(Me.CodigoIngrediente)
				End If
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(ProductoMezclaFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, ProductoMezclaFieldIndex)
					Case ProductoMezclaFieldIndex.CodigoProducto
						DesetupSyncProducto(True, False)
						_alreadyFetchedProducto = False
					Case ProductoMezclaFieldIndex.CodigoIngrediente
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As ProductoMezclaDAO = CType(CreateDAOInstance(), ProductoMezclaDAO)
		...
		''' <param name="validatorToUse">The validator Object for this ProductoMezclaEntity</param>
		...
		''' <param name="codigoProducto">PK value for ProductoMezcla which data should be fetched into this ProductoMezcla Object</param>
		''' <param name="codigoIngrediente">PK value for ProductoMezcla which data should be fetched into this ProductoMezcla Object</param>
		''' <param name="validator">The validator Object for this ProductoMezclaEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Protected Overridable Sub InitClassFetch(codigoProducto As System.Int32, codigoIngrediente As System.Int32, validator As IValidator, prefetchPathToUse As IPrefetchPath)
			OnInitializing()
			InitClassMembers()
			
			MyBase.Fields = CreateFields()
			Dim wasSuccesful As Boolean = Fetch(codigoProducto, codigoIngrediente, prefetchPathToUse, Nothing)
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("CodigoIngrediente", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()
		...
		Private Sub DesetupSyncProducto(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _producto, AddressOf OnProductoPropertyChanged, "Producto", ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoProducto, True, signalRelatedEntity, "ProductoMezcla", resetFKFields, New Integer() { CInt(ProductoMezclaFieldIndex.CodigoProducto) } )
			_producto = Nothing
		End Sub
		...
		Private Sub SetupSyncProducto(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _producto, AddressOf OnProductoPropertyChanged, "Producto", ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoProducto, True, _alreadyFetchedProducto, New String() {  } )
		End Sub
		...
		Private Sub DesetupSyncProducto_(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _producto_, AddressOf OnProducto_PropertyChanged, "Producto_", ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoIngrediente, True, signalRelatedEntity, "ProductoMezcla_", resetFKFields, New Integer() { CInt(ProductoMezclaFieldIndex.CodigoIngrediente) } )
			_producto_ = Nothing
		End Sub
		...
		Private Sub SetupSyncProducto_(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _producto_, AddressOf OnProducto_PropertyChanged, "Producto_", ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoIngrediente, True, _alreadyFetchedProducto_, New String() {  } )
		End Sub
		...
		''' <param name="contextToUse">The context to fetch the prefetch path with.</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Private Function Fetch(codigoProducto As System.Int32, codigoIngrediente As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				OnFetch()
				Dim dao As IDao = Me.CreateDAOInstance()
				MyBase.Fields(CInt(ProductoMezclaFieldIndex.CodigoProducto)).ForcedCurrentValueWrite(codigoProducto)
				MyBase.Fields(CInt(ProductoMezclaFieldIndex.CodigoIngrediente)).ForcedCurrentValueWrite(codigoIngrediente)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateProductoMezclaDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New ProductoMezclaEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As ProductoMezclaRelations
			Get	
				Return New ProductoMezclaRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoProducto, _
					CType(Integralab.ORM.EntityType.ProductoMezclaEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto_() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					ProductoMezclaEntity.Relations.ProductoEntityUsingCodigoIngrediente, _
					CType(Integralab.ORM.EntityType.ProductoMezclaEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return ProductoMezclaEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return ProductoMezclaEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The CodigoProducto property of the Entity ProductoMezcla<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatCompProductosMezclas"."PdIdProducto"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [CodigoProducto]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(ProductoMezclaFieldIndex.CodigoProducto, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(ProductoMezclaFieldIndex.CodigoProducto, Integer), value)
			End Set
		End Property
	
		''' <summary>The CodigoIngrediente property of the Entity ProductoMezcla<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatCompProductosMezclas"."PdIdIngrediente"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [CodigoIngrediente]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(ProductoMezclaFieldIndex.CodigoIngrediente, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(ProductoMezclaFieldIndex.CodigoIngrediente, Integer), value)
			End Set
		End Property
	
		''' <summary>The Porcentaje property of the Entity ProductoMezcla<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatCompProductosMezclas"."PdPorcentaje"<br/>
		...
		Public Overridable Property [Porcentaje]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(ProductoMezclaFieldIndex.Porcentaje, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(ProductoMezclaFieldIndex.Porcentaje, Integer), value)
			End Set
		End Property
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _producto Is Nothing Then
							_producto.UnsetRelatedEntity(Me, "ProductoMezcla")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "ProductoMezcla")
					End If
				End If
			End Set
		End Property
		...
		Public Overridable Property [Producto_]() As ProductoEntity
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _producto_ Is Nothing Then
							_producto_.UnsetRelatedEntity(Me, "ProductoMezcla_")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "ProductoMezcla_")
					End If
				End If
			End Set
		End Property
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.ProductoMezclaEntity)
			End Get
		End Property
#End Region
