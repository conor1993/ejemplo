...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'InventarioFisico'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class InventarioFisicoEntity 
#Else
	<Serializable()> _
	Public Class InventarioFisicoEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="almacenId">PK value for InventarioFisico which data should be fetched into this InventarioFisico Object</param>
		''' <param name="productoId">PK value for InventarioFisico which data should be fetched into this InventarioFisico Object</param>
		Public Sub New(almacenId As System.Int32, productoId As System.Int32)

			InitClassFetch(almacenId, productoId, CreateValidator(), Nothing)
		End Sub
		...
		Public Sub New(almacenId As System.Int32, productoId As System.Int32, prefetchPathToUse As IPrefetchPath)

			InitClassFetch(almacenId, productoId, CreateValidator(), prefetchPathToUse)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="almacenId">PK value for InventarioFisico which data should be fetched into this InventarioFisico Object</param>
		''' <param name="productoId">PK value for InventarioFisico which data should be fetched into this InventarioFisico Object</param>
		''' <param name="validator">The custom validator Object for this InventarioFisicoEntity</param>
		Public Sub New(almacenId As System.Int32, productoId As System.Int32, validator As IValidator)

			InitClassFetch(almacenId, productoId, validator, Nothing)
		End Sub
		...
		Public Function FetchUsingPK(almacenId As System.Int32, productoId As System.Int32) As Boolean
			Return FetchUsingPK(almacenId, productoId, Nothing, Nothing)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(almacenId As System.Int32, productoId As System.Int32, prefetchPathToUse As IPrefetchPath) As Boolean
			Return FetchUsingPK(almacenId, productoId, prefetchPathToUse, Nothing)
		End Function
		...
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(almacenId As System.Int32, productoId As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Return Fetch(almacenId, productoId, prefetchPathToUse, contextToUse)
		End Function
		...
		Public Overrides Overloads Function Refetch() As Boolean
			Return Fetch(Me.AlmacenId, Me.ProductoId, Nothing, Nothing)
		End Function
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As InventarioFisicoFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As InventarioFisicoFieldIndex) As Boolean
		...
		Public Overridable Function GetSingleAlmacen(forceFetch As Boolean) As AlmacenEntity
			If ( Not _alreadyFetchedAlmacen Or forceFetch Or _alwaysFetchAlmacen) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				If MyBase.CheckIfLazyLoadingShouldOccur(InventarioFisicoEntity.Relations.AlmacenEntityUsingAlmacenId) Then
		...
		Public Overridable Function GetSingleProducto(forceFetch As Boolean) As ProductoEntity
			If ( Not _alreadyFetchedProducto Or forceFetch Or _alwaysFetchProducto) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				End If
				Dim fetchResult As Boolean = False
				If MyBase.CheckIfLazyLoadingShouldOccur(InventarioFisicoEntity.Relations.ProductoEntityUsingProductoId) Then
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(InventarioFisicoFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, InventarioFisicoFieldIndex)
					Case InventarioFisicoFieldIndex.AlmacenId
						DesetupSyncAlmacen(True, False)
						_alreadyFetchedAlmacen = False
					Case InventarioFisicoFieldIndex.ProductoId
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As InventarioFisicoDAO = CType(CreateDAOInstance(), InventarioFisicoDAO)
		...
		''' <param name="validatorToUse">The validator Object for this InventarioFisicoEntity</param>
		...
		''' <param name="almacenId">PK value for InventarioFisico which data should be fetched into this InventarioFisico Object</param>
		''' <param name="productoId">PK value for InventarioFisico which data should be fetched into this InventarioFisico Object</param>
		''' <param name="validator">The validator Object for this InventarioFisicoEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Protected Overridable Sub InitClassFetch(almacenId As System.Int32, productoId As System.Int32, validator As IValidator, prefetchPathToUse As IPrefetchPath)
			OnInitializing()
			InitClassMembers()
			
			MyBase.Fields = CreateFields()
			Dim wasSuccesful As Boolean = Fetch(almacenId, productoId, prefetchPathToUse, Nothing)
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("CantidadSistema", fieldHashtable)
		End Sub
		...
		Private Sub DesetupSyncAlmacen(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _almacen, AddressOf OnAlmacenPropertyChanged, "Almacen", InventarioFisicoEntity.Relations.AlmacenEntityUsingAlmacenId, True, signalRelatedEntity, "UsrAlmInvFisico", resetFKFields, New Integer() { CInt(InventarioFisicoFieldIndex.AlmacenId) } )
			_almacen = Nothing
		End Sub
		...
		Private Sub SetupSyncAlmacen(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _almacen, AddressOf OnAlmacenPropertyChanged, "Almacen", InventarioFisicoEntity.Relations.AlmacenEntityUsingAlmacenId, True, _alreadyFetchedAlmacen, New String() {  } )
		End Sub
		...
		Private Sub DesetupSyncProducto(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _producto, AddressOf OnProductoPropertyChanged, "Producto", InventarioFisicoEntity.Relations.ProductoEntityUsingProductoId, True, signalRelatedEntity, "UsrAlmInvFisico", resetFKFields, New Integer() { CInt(InventarioFisicoFieldIndex.ProductoId) } )
			_producto = Nothing
		End Sub
		...
		Private Sub SetupSyncProducto(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _producto, AddressOf OnProductoPropertyChanged, "Producto", InventarioFisicoEntity.Relations.ProductoEntityUsingProductoId, True, _alreadyFetchedProducto, New String() {  } )
		End Sub
		...
		''' <param name="contextToUse">The context to fetch the prefetch path with.</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Private Function Fetch(almacenId As System.Int32, productoId As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				OnFetch()
				Dim dao As IDao = Me.CreateDAOInstance()
				MyBase.Fields(CInt(InventarioFisicoFieldIndex.AlmacenId)).ForcedCurrentValueWrite(almacenId)
				MyBase.Fields(CInt(InventarioFisicoFieldIndex.ProductoId)).ForcedCurrentValueWrite(productoId)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateInventarioFisicoDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New InventarioFisicoEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As InventarioFisicoRelations
			Get	
				Return New InventarioFisicoRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathAlmacen() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.AlmacenCollection(), _
					InventarioFisicoEntity.Relations.AlmacenEntityUsingAlmacenId, _
					CType(Integralab.ORM.EntityType.InventarioFisicoEntity, Integer), CType(Integralab.ORM.EntityType.AlmacenEntity, Integer), 0, Nothing, Nothing, Nothing, "Almacen", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					InventarioFisicoEntity.Relations.ProductoEntityUsingProductoId, _
					CType(Integralab.ORM.EntityType.InventarioFisicoEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return InventarioFisicoEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return InventarioFisicoEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The AlmacenId property of the Entity InventarioFisico<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "UsrAlmInvFisico"."AlmacenId"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [AlmacenId]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(InventarioFisicoFieldIndex.AlmacenId, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(InventarioFisicoFieldIndex.AlmacenId, Integer), value)
			End Set
		End Property
	
		''' <summary>The ProductoId property of the Entity InventarioFisico<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "UsrAlmInvFisico"."ProductoId"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [ProductoId]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(InventarioFisicoFieldIndex.ProductoId, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(InventarioFisicoFieldIndex.ProductoId, Integer), value)
			End Set
		End Property
	
		''' <summary>The Cantidad property of the Entity InventarioFisico<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "UsrAlmInvFisico"."Cantidad"<br/>
		...
		Public Overridable Property [Cantidad]() As Nullable(Of System.Decimal)
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(InventarioFisicoFieldIndex.Cantidad, Integer))

				Return CType(valueToReturn, Nullable(Of System.Decimal))
			End Get
			Set
				SetNewFieldValue(CType(InventarioFisicoFieldIndex.Cantidad, Integer), value)
			End Set
		End Property
	
		''' <summary>The FechaInventario property of the Entity InventarioFisico<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "UsrAlmInvFisico"."FechaInventario"<br/>
		''' Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [FechaInventario]() As System.DateTime
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(InventarioFisicoFieldIndex.FechaInventario, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(InventarioFisicoFieldIndex.FechaInventario, Integer), value)
			End Set
		End Property
	
		''' <summary>The CantidadSistema property of the Entity InventarioFisico<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "UsrAlmInvFisico"."CantidadSistema"<br/>
		''' Table field type characteristics (type, precision, scale, length): Decimal, 16, 3, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): True, False, False
		''' </remarks>
		Public Overridable Property [CantidadSistema]() As Nullable(Of System.Decimal)
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(InventarioFisicoFieldIndex.CantidadSistema, Integer))

				Return CType(valueToReturn, Nullable(Of System.Decimal))
			End Get
			Set
				SetNewFieldValue(CType(InventarioFisicoFieldIndex.CantidadSistema, Integer), value)
			End Set
		End Property
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _almacen Is Nothing Then
							_almacen.UnsetRelatedEntity(Me, "UsrAlmInvFisico")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "UsrAlmInvFisico")
					End If
				End If
			End Set
		End Property
		...
		Public Overridable Property [Producto]() As ProductoEntity
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _producto Is Nothing Then
							_producto.UnsetRelatedEntity(Me, "UsrAlmInvFisico")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "UsrAlmInvFisico")
					End If
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.InventarioFisicoEntity)
			End Get
		End Property
#End Region
