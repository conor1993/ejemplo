...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'MsccatMotivoDevolucion'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class MsccatMotivoDevolucionEntity 
#Else
	<Serializable()> _
	Public Class MsccatMotivoDevolucionEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="idMotivoDevolucion">PK value for MsccatMotivoDevolucion which data should be fetched into this MsccatMotivoDevolucion Object</param>
		Public Sub New(idMotivoDevolucion As System.Int32)

			InitClassFetch(idMotivoDevolucion, CreateValidator(), Nothing)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="idMotivoDevolucion">PK value for MsccatMotivoDevolucion which data should be fetched into this MsccatMotivoDevolucion Object</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Public Sub New(idMotivoDevolucion As System.Int32, prefetchPathToUse As IPrefetchPath)

			InitClassFetch(idMotivoDevolucion, CreateValidator(), prefetchPathToUse)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="idMotivoDevolucion">PK value for MsccatMotivoDevolucion which data should be fetched into this MsccatMotivoDevolucion Object</param>
		''' <param name="validator">The custom validator Object for this MsccatMotivoDevolucionEntity</param>
		Public Sub New(idMotivoDevolucion As System.Int32, validator As IValidator)

			InitClassFetch(idMotivoDevolucion, validator, Nothing)
		End Sub
		...
		Public Function FetchUsingPK(idMotivoDevolucion As System.Int32) As Boolean
			Return FetchUsingPK(idMotivoDevolucion, Nothing, Nothing)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(idMotivoDevolucion As System.Int32, prefetchPathToUse As IPrefetchPath) As Boolean
			Return FetchUsingPK(idMotivoDevolucion, prefetchPathToUse, Nothing)
		End Function
		...
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(idMotivoDevolucion As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Return Fetch(idMotivoDevolucion, prefetchPathToUse, contextToUse)
		End Function
		...
		Public Overrides Overloads Function Refetch() As Boolean
			Return Fetch(Me.IdMotivoDevolucion, Nothing, Nothing)
		End Function
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As MsccatMotivoDevolucionFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As MsccatMotivoDevolucionFieldIndex) As Boolean
		...
		Public Overridable Function GetMultiDevolucionProductos(forceFetch As Boolean, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression) As Integralab.ORM.CollectionClasses.DevolucionProductosCollection
			If ( Not _alreadyFetchedDevolucionProductos Or forceFetch Or _alwaysFetchDevolucionProductos) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing AndAlso Not MyBase.InDesignMode Then
				...
				End If
				_devolucionProductos.GetMultiManyToOne(Nothing, Nothing, Me, Nothing, Filter)
		...
		Public Overridable Function GetMultiMfacEmbarquesCabCollectionViaDevolucionProductos(forceFetch As Boolean, entityFactoryToUse As IEntityFactory) As Integralab.ORM.CollectionClasses.MfacEmbarquesCabCollection
			If ( Not _alreadyFetchedMfacEmbarquesCabCollectionViaDevolucionProductos Or forceFetch Or _alwaysFetchMfacEmbarquesCabCollectionViaDevolucionProductos) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing AndAlso Not MyBase.InDesignMode Then
				...
				relations.Add(MsccatMotivoDevolucionEntity.Relations.DevolucionProductosEntityUsingIdMotivoDevolucion, "__MsccatMotivoDevolucionEntity__", "DevolucionProductos_", JoinHint.None)
				...
				Filter.Add(New FieldCompareValuePredicate(EntityFieldFactory.Create(MsccatMotivoDevolucionFieldIndex.IdMotivoDevolucion), ComparisonOperator.Equal, Me.IdMotivoDevolucion))
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(MsccatMotivoDevolucionFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, MsccatMotivoDevolucionFieldIndex)
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As MsccatMotivoDevolucionDAO = CType(CreateDAOInstance(), MsccatMotivoDevolucionDAO)
		...
		''' <param name="validatorToUse">The validator Object for this MsccatMotivoDevolucionEntity</param>
		...
		''' <param name="idMotivoDevolucion">PK value for MsccatMotivoDevolucion which data should be fetched into this MsccatMotivoDevolucion Object</param>
		''' <param name="validator">The validator Object for this MsccatMotivoDevolucionEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Protected Overridable Sub InitClassFetch(idMotivoDevolucion As System.Int32, validator As IValidator, prefetchPathToUse As IPrefetchPath)
			OnInitializing()
			InitClassMembers()
			
			MyBase.Fields = CreateFields()
			Dim wasSuccesful As Boolean = Fetch(idMotivoDevolucion, prefetchPathToUse, Nothing)
		...
		Private Sub InitClassMembers()
			...
			_devolucionProductos.SetContainingEntityInfo(Me, "MsccatMotivoDevolucion")
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("IdUsuarioBaja", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()
		...
		''' <param name="contextToUse">The context to fetch the prefetch path with.</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Private Function Fetch(idMotivoDevolucion As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				OnFetch()
				Dim dao As IDao = Me.CreateDAOInstance()
				MyBase.Fields(CInt(MsccatMotivoDevolucionFieldIndex.IdMotivoDevolucion)).ForcedCurrentValueWrite(idMotivoDevolucion)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateMsccatMotivoDevolucionDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New MsccatMotivoDevolucionEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As MsccatMotivoDevolucionRelations
			Get	
				Return New MsccatMotivoDevolucionRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathDevolucionProductos() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.DevolucionProductosCollection(), _
					MsccatMotivoDevolucionEntity.Relations.DevolucionProductosEntityUsingIdMotivoDevolucion, _
					CType(Integralab.ORM.EntityType.MsccatMotivoDevolucionEntity, Integer), CType(Integralab.ORM.EntityType.DevolucionProductosEntity, Integer), 0, Nothing, Nothing, Nothing, "DevolucionProductos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathMfacEmbarquesCabCollectionViaDevolucionProductos() As IPrefetchPathElement
			Get
				Dim relations As IRelationCollection = New RelationCollection()
				relations.Add(MsccatMotivoDevolucionEntity.Relations.DevolucionProductosEntityUsingIdMotivoDevolucion, "__MsccatMotivoDevolucionEntity__", String.Empty, JoinHint.None)
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.MfacEmbarquesCabCollection(), _
					MsccatMotivoDevolucionEntity.Relations.DevolucionProductosEntityUsingIdMotivoDevolucion, _
					CType(Integralab.ORM.EntityType.MsccatMotivoDevolucionEntity, Integer), CType(Integralab.ORM.EntityType.MfacEmbarquesCabEntity, Integer), 0, Nothing, Nothing, relations, "MfacEmbarquesCabCollectionViaDevolucionProductos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return MsccatMotivoDevolucionEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return MsccatMotivoDevolucionEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The IdMotivoDevolucion property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."IdMotivoDevolucion"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, True
		''' </remarks>
		Public Overridable Property [IdMotivoDevolucion]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.IdMotivoDevolucion, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.IdMotivoDevolucion, Integer), value)
			End Set
		End Property
	
		''' <summary>The Descripcion property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."Descripcion"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 100<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Descripcion]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.Descripcion, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.Descripcion, Integer), value)
			End Set
		End Property
	
		''' <summary>The DescripcionCorta property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."DescripcionCorta"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [DescripcionCorta]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.DescripcionCorta, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.DescripcionCorta, Integer), value)
			End Set
		End Property
	
		''' <summary>The Estatus property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."Estatus"<br/>
		''' Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Estatus]() As System.Int16
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.Estatus, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.Estatus, Integer), value)
			End Set
		End Property
	
		''' <summary>The IdUsuarioAlta property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."IdUsuarioAlta"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [IdUsuarioAlta]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.IdUsuarioAlta, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.IdUsuarioAlta, Integer), value)
			End Set
		End Property
	
		''' <summary>The FechaCaptura property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."FechaCaptura"<br/>
		''' Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [FechaCaptura]() As System.DateTime
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.FechaCaptura, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.FechaCaptura, Integer), value)
			End Set
		End Property
	
		''' <summary>The IdUsuarioBaja property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."IdUsuarioBaja"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): True, False, False
		''' </remarks>
		Public Overridable Property [IdUsuarioBaja]() As Nullable(Of System.Int32)
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.IdUsuarioBaja, Integer))

				Return CType(valueToReturn, Nullable(Of System.Int32))
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.IdUsuarioBaja, Integer), value)
			End Set
		End Property
	
		''' <summary>The FechaCancelacion property of the Entity MsccatMotivoDevolucion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCCatMotivoDevolucion"."FechaCancelacion"<br/>
		''' Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): True, False, False
		''' </remarks>
		Public Overridable Property [FechaCancelacion]() As Nullable(Of System.DateTime)
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MsccatMotivoDevolucionFieldIndex.FechaCancelacion, Integer))

				Return CType(valueToReturn, Nullable(Of System.DateTime))
			End Get
			Set
				SetNewFieldValue(CType(MsccatMotivoDevolucionFieldIndex.FechaCancelacion, Integer), value)
			End Set
		End Property
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.MsccatMotivoDevolucionEntity)
			End Get
		End Property
#End Region
