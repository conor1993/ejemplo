...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'ContDiotTiposOperacion'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class ContDiotTiposOperacionEntity 
#Else
	<Serializable()> _
	Public Class ContDiotTiposOperacionEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="codDiot">PK value for ContDiotTiposOperacion which data should be fetched into this ContDiotTiposOperacion Object</param>
		...
		''' <summary>CTor</summary>
		''' <param name="codDiot">PK value for ContDiotTiposOperacion which data should be fetched into this ContDiotTiposOperacion Object</param>
		''' <param name="validator">The custom validator Object for this ContDiotTiposOperacionEntity</param>
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As ContDiotTiposOperacionFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As ContDiotTiposOperacionFieldIndex) As Boolean
		...
		Public Overridable Function GetMultiProveedor(forceFetch As Boolean, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression) As Integralab.ORM.CollectionClasses.ProveedorCollection
			If ( Not _alreadyFetchedProveedor Or forceFetch Or _alwaysFetchProveedor) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing AndAlso Not MyBase.InDesignMode Then
				...
				End If
				_proveedor.GetMultiManyToOne(Nothing, Me, Nothing, Nothing, Nothing, Filter)
		...
		Public Overridable Function GetMultiCatLugaresDeCompraCollectionViaProveedor(forceFetch As Boolean, entityFactoryToUse As IEntityFactory) As Integralab.ORM.CollectionClasses.CatLugaresDeCompraCollection
			If ( Not _alreadyFetchedCatLugaresDeCompraCollectionViaProveedor Or forceFetch Or _alwaysFetchCatLugaresDeCompraCollectionViaProveedor) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing AndAlso Not MyBase.InDesignMode Then
				...
				relations.Add(ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, "__ContDiotTiposOperacionEntity__", "Proveedor_", JoinHint.None)
				relations.Add(ProveedorEntity.Relations.CatLugaresDeCompraEntityUsingIdLugarCompra, "Proveedor_", String.Empty, JoinHint.None)
				Filter.Add(New FieldCompareValuePredicate(EntityFieldFactory.Create(ContDiotTiposOperacionFieldIndex.CodDiot), ComparisonOperator.Equal, Me.CodDiot))
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(ContDiotTiposOperacionFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, ContDiotTiposOperacionFieldIndex)
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As ContDiotTiposOperacionDAO = CType(CreateDAOInstance(), ContDiotTiposOperacionDAO)
		...
		''' <param name="validatorToUse">The validator Object for this ContDiotTiposOperacionEntity</param>
		...
		''' <param name="codDiot">PK value for ContDiotTiposOperacion which data should be fetched into this ContDiotTiposOperacion Object</param>
		''' <param name="validator">The validator Object for this ContDiotTiposOperacionEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		Private Sub InitClassMembers()
			...
			_proveedor.SetContainingEntityInfo(Me, "ContDiotTiposOperacion")
		...
		Private Function Fetch(codDiot As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				...
				MyBase.Fields(CInt(ContDiotTiposOperacionFieldIndex.CodDiot)).ForcedCurrentValueWrite(codDiot)
		...
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New ContDiotTiposOperacionEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As ContDiotTiposOperacionRelations
			Get	
				Return New ContDiotTiposOperacionRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProveedor() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProveedorCollection(), _
					ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, _
					CType(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity, Integer), CType(Integralab.ORM.EntityType.ProveedorEntity, Integer), 0, Nothing, Nothing, Nothing, "Proveedor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathCatLugaresDeCompraCollectionViaProveedor() As IPrefetchPathElement
			Get
				Dim relations As IRelationCollection = New RelationCollection()
				relations.Add(ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, "__ContDiotTiposOperacionEntity__", String.Empty, JoinHint.None)
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.CatLugaresDeCompraCollection(), _
					ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, _
					CType(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity, Integer), CType(Integralab.ORM.EntityType.CatLugaresDeCompraEntity, Integer), 0, Nothing, Nothing, relations, "CatLugaresDeCompraCollectionViaProveedor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathContDiotTiposTercerosCollectionViaProveedor() As IPrefetchPathElement
			Get
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ContDiotTiposTercerosCollection(), _
					ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, _
					CType(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity, Integer), CType(Integralab.ORM.EntityType.ContDiotTiposTercerosEntity, Integer), 0, Nothing, Nothing, relations, "ContDiotTiposTercerosCollectionViaProveedor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathCuentaContableCollectionViaProveedor() As IPrefetchPathElement
			Get
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.CuentaContableCollection(), _
					ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, _
					CType(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity, Integer), CType(Integralab.ORM.EntityType.CuentaContableEntity, Integer), 0, Nothing, Nothing, relations, "CuentaContableCollectionViaProveedor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathCuentaContableCollectionViaProveedor_() As IPrefetchPathElement
			Get
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.CuentaContableCollection(), _
					ContDiotTiposOperacionEntity.Relations.ProveedorEntityUsingIdcontdiottiposoperacion, _
					CType(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity, Integer), CType(Integralab.ORM.EntityType.CuentaContableEntity, Integer), 0, Nothing, Nothing, relations, "CuentaContableCollectionViaProveedor_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return ContDiotTiposOperacionEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return ContDiotTiposOperacionEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The CodDiot property of the Entity ContDiotTiposOperacion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "ContDiotTiposOperacion"."CodDiot"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, True
		''' </remarks>
		Public Overridable Property [CodDiot]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(ContDiotTiposOperacionFieldIndex.CodDiot, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(ContDiotTiposOperacionFieldIndex.CodDiot, Integer), value)
			End Set
		End Property
	
		''' <summary>The ClaveHacienda property of the Entity ContDiotTiposOperacion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "ContDiotTiposOperacion"."ClaveHacienda"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [ClaveHacienda]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(ContDiotTiposOperacionFieldIndex.ClaveHacienda, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(ContDiotTiposOperacionFieldIndex.ClaveHacienda, Integer), value)
			End Set
		End Property
	
		''' <summary>The Descripcion property of the Entity ContDiotTiposOperacion<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "ContDiotTiposOperacion"."Descripcion"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Descripcion]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(ContDiotTiposOperacionFieldIndex.Descripcion, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(ContDiotTiposOperacionFieldIndex.Descripcion, Integer), value)
			End Set
		End Property
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.ContDiotTiposOperacionEntity)
			End Get
		End Property
#End Region
