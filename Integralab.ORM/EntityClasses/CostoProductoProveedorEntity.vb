...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'CostoProductoProveedor'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class CostoProductoProveedorEntity 
#Else
	<Serializable()> _
	Public Class CostoProductoProveedorEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="producto">PK value for CostoProductoProveedor which data should be fetched into this CostoProductoProveedor Object</param>
		''' <param name="proveedor">PK value for CostoProductoProveedor which data should be fetched into this CostoProductoProveedor Object</param>
		Public Sub New(producto As System.Int32, proveedor As System.Int32)

			InitClassFetch(producto, proveedor, CreateValidator(), Nothing)
		End Sub
		...
		Public Sub New(producto As System.Int32, proveedor As System.Int32, prefetchPathToUse As IPrefetchPath)

			InitClassFetch(producto, proveedor, CreateValidator(), prefetchPathToUse)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="producto">PK value for CostoProductoProveedor which data should be fetched into this CostoProductoProveedor Object</param>
		''' <param name="proveedor">PK value for CostoProductoProveedor which data should be fetched into this CostoProductoProveedor Object</param>
		''' <param name="validator">The custom validator Object for this CostoProductoProveedorEntity</param>
		Public Sub New(producto As System.Int32, proveedor As System.Int32, validator As IValidator)

			InitClassFetch(producto, proveedor, validator, Nothing)
		End Sub
		...
		Public Function FetchUsingPK(producto As System.Int32, proveedor As System.Int32) As Boolean
			Return FetchUsingPK(producto, proveedor, Nothing, Nothing)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(producto As System.Int32, proveedor As System.Int32, prefetchPathToUse As IPrefetchPath) As Boolean
			Return FetchUsingPK(producto, proveedor, prefetchPathToUse, Nothing)
		End Function
		...
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(producto As System.Int32, proveedor As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Return Fetch(producto, proveedor, prefetchPathToUse, contextToUse)
		End Function
		...
		Public Overrides Overloads Function Refetch() As Boolean
			Return Fetch(Me.Producto, Me.Proveedor, Nothing, Nothing)
		End Function
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As CostoProductoProveedorFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As CostoProductoProveedorFieldIndex) As Boolean
		...
		Public Overridable Function GetSingleProducto_(forceFetch As Boolean) As ProductoEntity
			If ( Not _alreadyFetchedProducto_ Or forceFetch Or _alwaysFetchProducto_) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				If MyBase.CheckIfLazyLoadingShouldOccur(CostoProductoProveedorEntity.Relations.ProductoEntityUsingProducto) Then
		...
		Public Overridable Function GetSingleProveedor_(forceFetch As Boolean) As ProveedorEntity
			If ( Not _alreadyFetchedProveedor_ Or forceFetch Or _alwaysFetchProveedor_) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				End If
				Dim fetchResult As Boolean = False
				If MyBase.CheckIfLazyLoadingShouldOccur(CostoProductoProveedorEntity.Relations.ProveedorEntityUsingProveedor) Then
					fetchResult = newEntity.FetchUsingPK(Me.Proveedor)
				End If
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(CostoProductoProveedorFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, CostoProductoProveedorFieldIndex)
					Case CostoProductoProveedorFieldIndex.Producto
						DesetupSyncProducto_(True, False)
						_alreadyFetchedProducto_ = False
					Case CostoProductoProveedorFieldIndex.Proveedor
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As CostoProductoProveedorDAO = CType(CreateDAOInstance(), CostoProductoProveedorDAO)
		...
		''' <param name="validatorToUse">The validator Object for this CostoProductoProveedorEntity</param>
		...
		''' <param name="producto">PK value for CostoProductoProveedor which data should be fetched into this CostoProductoProveedor Object</param>
		''' <param name="proveedor">PK value for CostoProductoProveedor which data should be fetched into this CostoProductoProveedor Object</param>
		''' <param name="validator">The validator Object for this CostoProductoProveedorEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Protected Overridable Sub InitClassFetch(producto As System.Int32, proveedor As System.Int32, validator As IValidator, prefetchPathToUse As IPrefetchPath)
			OnInitializing()
			InitClassMembers()
			
			MyBase.Fields = CreateFields()
			Dim wasSuccesful As Boolean = Fetch(producto, proveedor, prefetchPathToUse, Nothing)
		...
		Private Sub DesetupSyncProducto_(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _producto_, AddressOf OnProducto_PropertyChanged, "Producto_", CostoProductoProveedorEntity.Relations.ProductoEntityUsingProducto, True, signalRelatedEntity, "CostoProductoProveedor", resetFKFields, New Integer() { CInt(CostoProductoProveedorFieldIndex.Producto) } )
			_producto_ = Nothing
		End Sub
		...
		Private Sub SetupSyncProducto_(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _producto_, AddressOf OnProducto_PropertyChanged, "Producto_", CostoProductoProveedorEntity.Relations.ProductoEntityUsingProducto, True, _alreadyFetchedProducto_, New String() {  } )
		End Sub
		...
		Private Sub DesetupSyncProveedor_(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _proveedor_, AddressOf OnProveedor_PropertyChanged, "Proveedor_", CostoProductoProveedorEntity.Relations.ProveedorEntityUsingProveedor, True, signalRelatedEntity, "CostoProductoProveedor", resetFKFields, New Integer() { CInt(CostoProductoProveedorFieldIndex.Proveedor) } )
			_proveedor_ = Nothing
		End Sub
		...
		Private Sub SetupSyncProveedor_(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _proveedor_, AddressOf OnProveedor_PropertyChanged, "Proveedor_", CostoProductoProveedorEntity.Relations.ProveedorEntityUsingProveedor, True, _alreadyFetchedProveedor_, New String() {  } )
		End Sub
		...
		''' <param name="contextToUse">The context to fetch the prefetch path with.</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Private Function Fetch(producto As System.Int32, proveedor As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				OnFetch()
				Dim dao As IDao = Me.CreateDAOInstance()
				MyBase.Fields(CInt(CostoProductoProveedorFieldIndex.Producto)).ForcedCurrentValueWrite(producto)
				MyBase.Fields(CInt(CostoProductoProveedorFieldIndex.Proveedor)).ForcedCurrentValueWrite(proveedor)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateCostoProductoProveedorDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New CostoProductoProveedorEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As CostoProductoProveedorRelations
			Get	
				Return New CostoProductoProveedorRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto_() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					CostoProductoProveedorEntity.Relations.ProductoEntityUsingProducto, _
					CType(Integralab.ORM.EntityType.CostoProductoProveedorEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProveedor_() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProveedorCollection(), _
					CostoProductoProveedorEntity.Relations.ProveedorEntityUsingProveedor, _
					CType(Integralab.ORM.EntityType.CostoProductoProveedorEntity, Integer), CType(Integralab.ORM.EntityType.ProveedorEntity, Integer), 0, Nothing, Nothing, Nothing, "Proveedor_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return CostoProductoProveedorEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return CostoProductoProveedorEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The Producto property of the Entity CostoProductoProveedor<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatCompCostoProductoProveedor"."Producto"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [Producto]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(CostoProductoProveedorFieldIndex.Producto, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(CostoProductoProveedorFieldIndex.Producto, Integer), value)
			End Set
		End Property
	
		''' <summary>The Proveedor property of the Entity CostoProductoProveedor<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatCompCostoProductoProveedor"."Proveedor"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [Proveedor]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(CostoProductoProveedorFieldIndex.Proveedor, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(CostoProductoProveedorFieldIndex.Proveedor, Integer), value)
			End Set
		End Property
	
		''' <summary>The Costo property of the Entity CostoProductoProveedor<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatCompCostoProductoProveedor"."Costo"<br/>
		''' Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Costo]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(CostoProductoProveedorFieldIndex.Costo, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(CostoProductoProveedorFieldIndex.Costo, Integer), value)
			End Set
		End Property
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _producto_ Is Nothing Then
							_producto_.UnsetRelatedEntity(Me, "CostoProductoProveedor")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "CostoProductoProveedor")
					End If
				End If
			End Set
		End Property
		...
		Public Overridable Property [Proveedor_]() As ProveedorEntity
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _proveedor_ Is Nothing Then
							_proveedor_.UnsetRelatedEntity(Me, "CostoProductoProveedor")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "CostoProductoProveedor")
					End If
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.CostoProductoProveedorEntity)
			End Get
		End Property
#End Region
