...
#Region "Class Property Declarations"
		...
		''' <summary>The TipoComprobante property of the Entity CabFacturas<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "CabFacturas"."TipoComprobante"<br/>
		''' Table field type characteristics (type, precision, scale, length): Char, 0, 0, 1<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): True, False, False
		''' </remarks>
		Public Overridable Property [TipoComprobante]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(CabFacturasFieldIndex.TipoComprobante, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
