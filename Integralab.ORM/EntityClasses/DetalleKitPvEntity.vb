...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'DetalleKitPv'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class DetalleKitPvEntity 
#Else
	<Serializable()> _
	Public Class DetalleKitPvEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="idKit">PK value for DetalleKitPv which data should be fetched into this DetalleKitPv Object</param>
		''' <param name="idProducto">PK value for DetalleKitPv which data should be fetched into this DetalleKitPv Object</param>
		Public Sub New(idKit As System.Int32, idProducto As System.Int32)

			InitClassFetch(idKit, idProducto, CreateValidator(), Nothing)
		End Sub
		...
		Public Sub New(idKit As System.Int32, idProducto As System.Int32, prefetchPathToUse As IPrefetchPath)

			InitClassFetch(idKit, idProducto, CreateValidator(), prefetchPathToUse)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="idKit">PK value for DetalleKitPv which data should be fetched into this DetalleKitPv Object</param>
		''' <param name="idProducto">PK value for DetalleKitPv which data should be fetched into this DetalleKitPv Object</param>
		''' <param name="validator">The custom validator Object for this DetalleKitPvEntity</param>
		Public Sub New(idKit As System.Int32, idProducto As System.Int32, validator As IValidator)

			InitClassFetch(idKit, idProducto, validator, Nothing)
		End Sub
		...
		Public Function FetchUsingPK(idKit As System.Int32, idProducto As System.Int32) As Boolean
			Return FetchUsingPK(idKit, idProducto, Nothing, Nothing)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(idKit As System.Int32, idProducto As System.Int32, prefetchPathToUse As IPrefetchPath) As Boolean
			Return FetchUsingPK(idKit, idProducto, prefetchPathToUse, Nothing)
		End Function
		...
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(idKit As System.Int32, idProducto As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Return Fetch(idKit, idProducto, prefetchPathToUse, contextToUse)
		End Function
		...
		Public Overrides Overloads Function Refetch() As Boolean
			Return Fetch(Me.IdKit, Me.IdProducto, Nothing, Nothing)
		End Function
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As DetalleKitPvFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As DetalleKitPvFieldIndex) As Boolean
		...
		Public Overridable Function GetSingleProducto(forceFetch As Boolean) As ProductoEntity
			If ( Not _alreadyFetchedProducto Or forceFetch Or _alwaysFetchProducto) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				If MyBase.CheckIfLazyLoadingShouldOccur(DetalleKitPvEntity.Relations.ProductoEntityUsingIdKit) Then
					fetchResult = newEntity.FetchUsingPK(Me.IdKit)
				End If
		...
		Public Overridable Function GetSingleProducto_(forceFetch As Boolean) As ProductoEntity
			If ( Not _alreadyFetchedProducto_ Or forceFetch Or _alwaysFetchProducto_) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				End If
				Dim fetchResult As Boolean = False
				If MyBase.CheckIfLazyLoadingShouldOccur(DetalleKitPvEntity.Relations.ProductoEntityUsingIdProducto) Then
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(DetalleKitPvFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, DetalleKitPvFieldIndex)
					Case DetalleKitPvFieldIndex.IdKit
						DesetupSyncProducto(True, False)
						_alreadyFetchedProducto = False
					Case DetalleKitPvFieldIndex.IdProducto
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As DetalleKitPvDAO = CType(CreateDAOInstance(), DetalleKitPvDAO)
		...
		''' <param name="validatorToUse">The validator Object for this DetalleKitPvEntity</param>
		...
		''' <param name="idKit">PK value for DetalleKitPv which data should be fetched into this DetalleKitPv Object</param>
		''' <param name="idProducto">PK value for DetalleKitPv which data should be fetched into this DetalleKitPv Object</param>
		''' <param name="validator">The validator Object for this DetalleKitPvEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Protected Overridable Sub InitClassFetch(idKit As System.Int32, idProducto As System.Int32, validator As IValidator, prefetchPathToUse As IPrefetchPath)
			OnInitializing()
			InitClassMembers()
			
			MyBase.Fields = CreateFields()
			Dim wasSuccesful As Boolean = Fetch(idKit, idProducto, prefetchPathToUse, Nothing)
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("IdKit", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()
		...
		Private Sub DesetupSyncProducto(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _producto, AddressOf OnProductoPropertyChanged, "Producto", DetalleKitPvEntity.Relations.ProductoEntityUsingIdKit, True, signalRelatedEntity, "DetalleKitPv", resetFKFields, New Integer() { CInt(DetalleKitPvFieldIndex.IdKit) } )
			_producto = Nothing
		End Sub
		...
		Private Sub SetupSyncProducto(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _producto, AddressOf OnProductoPropertyChanged, "Producto", DetalleKitPvEntity.Relations.ProductoEntityUsingIdKit, True, _alreadyFetchedProducto, New String() {  } )
		End Sub
		...
		Private Sub DesetupSyncProducto_(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _producto_, AddressOf OnProducto_PropertyChanged, "Producto_", DetalleKitPvEntity.Relations.ProductoEntityUsingIdProducto, True, signalRelatedEntity, "DetalleKitPv_", resetFKFields, New Integer() { CInt(DetalleKitPvFieldIndex.IdProducto) } )
			_producto_ = Nothing
		End Sub
		...
		Private Sub SetupSyncProducto_(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _producto_, AddressOf OnProducto_PropertyChanged, "Producto_", DetalleKitPvEntity.Relations.ProductoEntityUsingIdProducto, True, _alreadyFetchedProducto_, New String() {  } )
		End Sub
		...
		''' <param name="contextToUse">The context to fetch the prefetch path with.</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Private Function Fetch(idKit As System.Int32, idProducto As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				OnFetch()
				Dim dao As IDao = Me.CreateDAOInstance()
				MyBase.Fields(CInt(DetalleKitPvFieldIndex.IdKit)).ForcedCurrentValueWrite(idKit)
				MyBase.Fields(CInt(DetalleKitPvFieldIndex.IdProducto)).ForcedCurrentValueWrite(idProducto)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateDetalleKitPvDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New DetalleKitPvEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As DetalleKitPvRelations
			Get	
				Return New DetalleKitPvRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					DetalleKitPvEntity.Relations.ProductoEntityUsingIdKit, _
					CType(Integralab.ORM.EntityType.DetalleKitPvEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto_() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					DetalleKitPvEntity.Relations.ProductoEntityUsingIdProducto, _
					CType(Integralab.ORM.EntityType.DetalleKitPvEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto_", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return DetalleKitPvEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return DetalleKitPvEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The IdKit property of the Entity DetalleKitPv<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "DetalleKitPV"."IdKit"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [IdKit]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(DetalleKitPvFieldIndex.IdKit, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(DetalleKitPvFieldIndex.IdKit, Integer), value)
			End Set
		End Property
	
		''' <summary>The IdProducto property of the Entity DetalleKitPv<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "DetalleKitPV"."idProducto"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [IdProducto]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(DetalleKitPvFieldIndex.IdProducto, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(DetalleKitPvFieldIndex.IdProducto, Integer), value)
			End Set
		End Property
	
		''' <summary>The Cantidad property of the Entity DetalleKitPv<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "DetalleKitPV"."Cantidad"<br/>
		...
		Public Overridable Property [Cantidad]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(DetalleKitPvFieldIndex.Cantidad, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(DetalleKitPvFieldIndex.Cantidad, Integer), value)
			End Set
		End Property
	
		''' <summary>The Precio property of the Entity DetalleKitPv<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "DetalleKitPV"."Precio"<br/>
		''' Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Precio]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(DetalleKitPvFieldIndex.Precio, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Decimal))
				End If
				Return CType(valueToReturn, System.Decimal)
			End Get
			Set
				SetNewFieldValue(CType(DetalleKitPvFieldIndex.Precio, Integer), value)
			End Set
		End Property
	
		''' <summary>The Iva property of the Entity DetalleKitPv<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "DetalleKitPV"."Iva"<br/>
		''' Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Iva]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(DetalleKitPvFieldIndex.Iva, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Decimal))
				End If
				Return CType(valueToReturn, System.Decimal)
			End Get
			Set
				SetNewFieldValue(CType(DetalleKitPvFieldIndex.Iva, Integer), value)
			End Set
		End Property
	
		''' <summary>The Ieps property of the Entity DetalleKitPv<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "DetalleKitPV"."Ieps"<br/>
		''' Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Ieps]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(DetalleKitPvFieldIndex.Ieps, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Decimal))
				End If
				Return CType(valueToReturn, System.Decimal)
			End Get
			Set
				SetNewFieldValue(CType(DetalleKitPvFieldIndex.Ieps, Integer), value)
			End Set
		End Property
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _producto Is Nothing Then
							_producto.UnsetRelatedEntity(Me, "DetalleKitPv")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "DetalleKitPv")
					End If
				End If
			End Set
		End Property
		...
		Public Overridable Property [Producto_]() As ProductoEntity
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _producto_ Is Nothing Then
							_producto_.UnsetRelatedEntity(Me, "DetalleKitPv_")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "DetalleKitPv_")
					End If
				End If
			End Set
		End Property
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.DetalleKitPvEntity)
			End Get
		End Property
#End Region
