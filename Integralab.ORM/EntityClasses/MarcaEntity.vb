...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'Marca'<br/><br/>
	''' </summary>
#If CF Then
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="codigo">PK value for Marca which data should be fetched into this Marca Object</param>
		...
		''' <summary>CTor</summary>
		''' <param name="codigo">PK value for Marca which data should be fetched into this Marca Object</param>
		''' <param name="validator">The custom validator Object for this MarcaEntity</param>
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As MarcaFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As MarcaFieldIndex) As Boolean
		...
		Public Overridable Function GetMultiProducto(forceFetch As Boolean, entityFactoryToUse As IEntityFactory, Filter As IPredicateExpression) As Integralab.ORM.CollectionClasses.ProductoCollection
			If ( Not _alreadyFetchedProducto Or forceFetch Or _alwaysFetchProducto) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing AndAlso Not MyBase.InDesignMode Then
				...
				End If
				_producto.GetMultiManyToOne(Nothing, Nothing, Nothing, Nothing, Me, Filter)
		...
		Public Overridable Function GetMultiLineaCollectionViaProducto(forceFetch As Boolean, entityFactoryToUse As IEntityFactory) As Integralab.ORM.CollectionClasses.LineaCollection
			If ( Not _alreadyFetchedLineaCollectionViaProducto Or forceFetch Or _alwaysFetchLineaCollectionViaProducto) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing AndAlso Not MyBase.InDesignMode Then
				...
				relations.Add(MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, "__MarcaEntity__", "Producto_", JoinHint.None)
				relations.Add(ProductoEntity.Relations.LineaEntityUsingPdIdLinea, "Producto_", String.Empty, JoinHint.None)
				Filter.Add(New FieldCompareValuePredicate(EntityFieldFactory.Create(MarcaFieldIndex.Codigo), ComparisonOperator.Equal, Me.Codigo))
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(MarcaFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, MarcaFieldIndex)
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As MarcaDAO = CType(CreateDAOInstance(), MarcaDAO)
		...
		''' <param name="validatorToUse">The validator Object for this MarcaEntity</param>
		...
		''' <param name="codigo">PK value for Marca which data should be fetched into this Marca Object</param>
		''' <param name="validator">The validator Object for this MarcaEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		Private Sub InitClassMembers()
			...
			_producto.SetContainingEntityInfo(Me, "Marca")
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("McaPuntoVenta", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()

			_fieldsCustomProperties.Add("McaMeat", fieldHashtable)
		End Sub
		...
		Private Function Fetch(codigo As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				...
				MyBase.Fields(CInt(MarcaFieldIndex.Codigo)).ForcedCurrentValueWrite(codigo)
...
#Region "Class Property Declarations"
		...
		Public  Shared ReadOnly Property Relations() As MarcaRelations
			Get	
				Return New MarcaRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathProducto() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ProductoCollection(), _
					MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, _
					CType(Integralab.ORM.EntityType.MarcaEntity, Integer), CType(Integralab.ORM.EntityType.ProductoEntity, Integer), 0, Nothing, Nothing, Nothing, "Producto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathLineaCollectionViaProducto() As IPrefetchPathElement
			Get
				Dim relations As IRelationCollection = New RelationCollection()
				relations.Add(MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, "__MarcaEntity__", String.Empty, JoinHint.None)
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.LineaCollection(), _
					MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, _
					CType(Integralab.ORM.EntityType.MarcaEntity, Integer), CType(Integralab.ORM.EntityType.LineaEntity, Integer), 0, Nothing, Nothing, relations, "LineaCollectionViaProducto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathPresentacionCollectionViaProducto() As IPrefetchPathElement
			Get
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.PresentacionCollection(), _
					MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, _
					CType(Integralab.ORM.EntityType.MarcaEntity, Integer), CType(Integralab.ORM.EntityType.PresentacionEntity, Integer), 0, Nothing, Nothing, relations, "PresentacionCollectionViaProducto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathTipoProductoCollectionViaProducto() As IPrefetchPathElement
			Get
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.TipoProductoCollection(), _
					MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, _
					CType(Integralab.ORM.EntityType.MarcaEntity, Integer), CType(Integralab.ORM.EntityType.TipoProductoEntity, Integer), 0, Nothing, Nothing, relations, "TipoProductoCollectionViaProducto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathUnidadMedidaCollectionViaProducto() As IPrefetchPathElement
			Get
				...
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.UnidadMedidaCollection(), _
					MarcaEntity.Relations.ProductoEntityUsingCodigoMarca, _
					CType(Integralab.ORM.EntityType.MarcaEntity, Integer), CType(Integralab.ORM.EntityType.UnidadMedidaEntity, Integer), 0, Nothing, Nothing, relations, "UnidadMedidaCollectionViaProducto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return MarcaEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return MarcaEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The Codigo property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."maridMarca"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, True
		''' </remarks>
		Public Overridable Property [Codigo]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.Codigo, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.Codigo, Integer), value)
			End Set
		End Property
	
		''' <summary>The DescripcionCorta property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marnombrec"<br/>
		...
		Public Overridable Property [DescripcionCorta]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.DescripcionCorta, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.DescripcionCorta, Integer), value)
			End Set
		End Property
	
		''' <summary>The Descripcion property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marnombre"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Descripcion]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.Descripcion, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.Descripcion, Integer), value)
			End Set
		End Property
	
		''' <summary>The Estatus property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marestatus"<br/>
		''' Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Estatus]() As System.Int16
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.Estatus, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.Estatus, Integer), value)
			End Set
		End Property
	
		''' <summary>The Observaciones property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marobservaciones"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 250<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Observaciones]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.Observaciones, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.Observaciones, Integer), value)
			End Set
		End Property
	
		''' <summary>The UsuarioAlta property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marIdUsuarioAlta"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [UsuarioAlta]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.UsuarioAlta, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.UsuarioAlta, Integer), value)
			End Set
		End Property
	
		''' <summary>The FechaAlta property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marFechaAlta"<br/>
		...
		Public Overridable Property [FechaAlta]() As System.DateTime
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.FechaAlta, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.FechaAlta, Integer), value)
			End Set
		End Property
	
		''' <summary>The UsuarioBaja property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marIdUsuarioBaja"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [UsuarioBaja]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.UsuarioBaja, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.UsuarioBaja, Integer), value)
			End Set
		End Property
	
		''' <summary>The FechaBaja property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marFechaBaja"<br/>
		''' Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [FechaBaja]() As System.DateTime
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.FechaBaja, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.DateTime))
				End If
				Return CType(valueToReturn, System.DateTime)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.FechaBaja, Integer), value)
			End Set
		End Property
	
		''' <summary>The MotivoBaja property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marIdMotivoBaja"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [MotivoBaja]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.MotivoBaja, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.MotivoBaja, Integer), value)
			End Set
		End Property
	
		''' <summary>The ObservacionBaja property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marObservacionBaja"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [ObservacionBaja]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.ObservacionBaja, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.ObservacionBaja, Integer), value)
			End Set
		End Property
	
		''' <summary>The McaPuntoVenta property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marPuntoVenta"<br/>
		''' Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [McaPuntoVenta]() As System.Boolean
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.McaPuntoVenta, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.McaPuntoVenta, Integer), value)
			End Set
		End Property
	
		''' <summary>The McaMeat property of the Entity Marca<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MCatGenMarcas"."marMeat"<br/>
		''' Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [McaMeat]() As System.Boolean
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MarcaFieldIndex.McaMeat, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Boolean))
				End If
				Return CType(valueToReturn, System.Boolean)
			End Get
			Set
				SetNewFieldValue(CType(MarcaFieldIndex.McaMeat, Integer), value)
			End Set
		End Property
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.MarcaEntity)
			End Get
		End Property
#End Region
