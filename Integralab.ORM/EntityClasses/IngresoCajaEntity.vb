...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'IngresoCaja'<br/><br/>
	''' </summary>
#If CF Then
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="id">PK value for IngresoCaja which data should be fetched into this IngresoCaja Object</param>
		...
		''' <summary>CTor</summary>
		''' <param name="id">PK value for IngresoCaja which data should be fetched into this IngresoCaja Object</param>
		''' <param name="validator">The custom validator Object for this IngresoCajaEntity</param>
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As IngresoCajaFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As IngresoCajaFieldIndex) As Boolean
		...
		Public Overridable Function GetSingleConceptoCaja(forceFetch As Boolean) As ConceptoCajaEntity
			If ( Not _alreadyFetchedConceptoCaja Or forceFetch Or _alwaysFetchConceptoCaja) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				If MyBase.CheckIfLazyLoadingShouldOccur(IngresoCajaEntity.Relations.ConceptoCajaEntityUsingIdConcepto) Then
		...
		Public Overridable Function GetSingleControlTurno(forceFetch As Boolean) As ControlTurnoEntity
			If ( Not _alreadyFetchedControlTurno Or forceFetch Or _alwaysFetchControlTurno) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				End If
				Dim fetchResult As Boolean = False
				If MyBase.CheckIfLazyLoadingShouldOccur(IngresoCajaEntity.Relations.ControlTurnoEntityUsingCodControlTurno) Then
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(IngresoCajaFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, IngresoCajaFieldIndex)


					Case IngresoCajaFieldIndex.CodControlTurno
					...
					Case IngresoCajaFieldIndex.IdConcepto
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As IngresoCajaDAO = CType(CreateDAOInstance(), IngresoCajaDAO)
		...
		''' <param name="validatorToUse">The validator Object for this IngresoCajaEntity</param>
		...
		''' <param name="id">PK value for IngresoCaja which data should be fetched into this IngresoCaja Object</param>
		''' <param name="validator">The validator Object for this IngresoCajaEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		Private Sub DesetupSyncConceptoCaja(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _conceptoCaja, AddressOf OnConceptoCajaPropertyChanged, "ConceptoCaja", IngresoCajaEntity.Relations.ConceptoCajaEntityUsingIdConcepto, True, signalRelatedEntity, "IngresosCaja", resetFKFields, New Integer() { CInt(IngresoCajaFieldIndex.IdConcepto) } )
			_conceptoCaja = Nothing
		End Sub
		...
		Private Sub SetupSyncConceptoCaja(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _conceptoCaja, AddressOf OnConceptoCajaPropertyChanged, "ConceptoCaja", IngresoCajaEntity.Relations.ConceptoCajaEntityUsingIdConcepto, True, _alreadyFetchedConceptoCaja, New String() {  } )
		End Sub
		...
		Private Sub DesetupSyncControlTurno(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _controlTurno, AddressOf OnControlTurnoPropertyChanged, "ControlTurno", IngresoCajaEntity.Relations.ControlTurnoEntityUsingCodControlTurno, True, signalRelatedEntity, "IngresoCaja", resetFKFields, New Integer() { CInt(IngresoCajaFieldIndex.CodControlTurno) } )
			_controlTurno = Nothing
		End Sub
		...
		Private Sub SetupSyncControlTurno(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _controlTurno, AddressOf OnControlTurnoPropertyChanged, "ControlTurno", IngresoCajaEntity.Relations.ControlTurnoEntityUsingCodControlTurno, True, _alreadyFetchedControlTurno, New String() {  } )
		End Sub
		...
		Private Function Fetch(id As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				...
				MyBase.Fields(CInt(IngresoCajaFieldIndex.Id)).ForcedCurrentValueWrite(id)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateIngresoCajaDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New IngresoCajaEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As IngresoCajaRelations
			Get	
				Return New IngresoCajaRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathConceptoCaja() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ConceptoCajaCollection(), _
					IngresoCajaEntity.Relations.ConceptoCajaEntityUsingIdConcepto, _
					CType(Integralab.ORM.EntityType.IngresoCajaEntity, Integer), CType(Integralab.ORM.EntityType.ConceptoCajaEntity, Integer), 0, Nothing, Nothing, Nothing, "ConceptoCaja", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathControlTurno() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.ControlTurnoCollection(), _
					IngresoCajaEntity.Relations.ControlTurnoEntityUsingCodControlTurno, _
					CType(Integralab.ORM.EntityType.IngresoCajaEntity, Integer), CType(Integralab.ORM.EntityType.ControlTurnoEntity, Integer), 0, Nothing, Nothing, Nothing, "ControlTurno", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return IngresoCajaEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return IngresoCajaEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The Id property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."Id"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, True
		''' </remarks>
		Public Overridable Property [Id]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.Id, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.Id, Integer), value)
			End Set
		End Property
	
		''' <summary>The CodUsuario property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."CodUsuario"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [CodUsuario]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.CodUsuario, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.CodUsuario, Integer), value)
			End Set
		End Property
	
		''' <summary>The CodControlTurno property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."CodControlTurno"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [CodControlTurno]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.CodControlTurno, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.CodControlTurno, Integer), value)
			End Set
		End Property
	
		''' <summary>The CodCaja property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."CodCaja"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [CodCaja]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.CodCaja, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.CodCaja, Integer), value)
			End Set
		End Property
	
		''' <summary>The FechaHora property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."FechaHora"<br/>
		''' Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [FechaHora]() As System.DateTime
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.FechaHora, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.FechaHora, Integer), value)
			End Set
		End Property
	
		''' <summary>The Importe property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."Importe"<br/>
		''' Table field type characteristics (type, precision, scale, length): Money, 19, 4, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [Importe]() As System.Decimal
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.Importe, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.Importe, Integer), value)
			End Set
		End Property
	
		''' <summary>The Estatus property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."Estatus"<br/>
		...
		Public Overridable Property [Estatus]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.Estatus, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.Estatus, Integer), value)
			End Set
		End Property
	
		''' <summary>The IdConcepto property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."IdConcepto"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [IdConcepto]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.IdConcepto, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.IdConcepto, Integer), value)
			End Set
		End Property
	
		''' <summary>The Observaciones property of the Entity IngresoCaja<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MVentaIngresoCaja"."Observaciones"<br/>
		...
		Public Overridable Property [Observaciones]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(IngresoCajaFieldIndex.Observaciones, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
			End Get
			Set
				SetNewFieldValue(CType(IngresoCajaFieldIndex.Observaciones, Integer), value)
			End Set
		End Property
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _conceptoCaja Is Nothing Then
							_conceptoCaja.UnsetRelatedEntity(Me, "IngresosCaja")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "IngresosCaja")
					End If
				End If
			End Set
		End Property
		...
		Public Overridable Property [ControlTurno]() As ControlTurnoEntity
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _controlTurno Is Nothing Then
							_controlTurno.UnsetRelatedEntity(Me, "IngresoCaja")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "IngresoCaja")
					End If
				End If
			End Set
		End Property
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.IngresoCajaEntity)
			End Get
		End Property
#End Region
