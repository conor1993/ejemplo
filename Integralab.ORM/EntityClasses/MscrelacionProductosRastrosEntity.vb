...
Namespace Integralab.ORM.EntityClasses
	''' <summary>Entity class which represents the entity 'MscrelacionProductosRastros'<br/><br/>
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class MscrelacionProductosRastrosEntity 
#Else
	<Serializable()> _
	Public Class MscrelacionProductosRastrosEntity 
#End If
...
#End Region
		...
		''' <summary>CTor</summary>
		''' <param name="codRastro">PK value for MscrelacionProductosRastros which data should be fetched into this MscrelacionProductosRastros Object</param>
		''' <param name="codProducto">PK value for MscrelacionProductosRastros which data should be fetched into this MscrelacionProductosRastros Object</param>
		Public Sub New(codRastro As System.Int32, codProducto As System.Int32)

			InitClassFetch(codRastro, codProducto, CreateValidator(), Nothing)
		End Sub
		...
		Public Sub New(codRastro As System.Int32, codProducto As System.Int32, prefetchPathToUse As IPrefetchPath)

			InitClassFetch(codRastro, codProducto, CreateValidator(), prefetchPathToUse)
		End Sub

		''' <summary>CTor</summary>
		''' <param name="codRastro">PK value for MscrelacionProductosRastros which data should be fetched into this MscrelacionProductosRastros Object</param>
		''' <param name="codProducto">PK value for MscrelacionProductosRastros which data should be fetched into this MscrelacionProductosRastros Object</param>
		''' <param name="validator">The custom validator Object for this MscrelacionProductosRastrosEntity</param>
		Public Sub New(codRastro As System.Int32, codProducto As System.Int32, validator As IValidator)

			InitClassFetch(codRastro, codProducto, validator, Nothing)
		End Sub
		...
		Public Function FetchUsingPK(codRastro As System.Int32, codProducto As System.Int32) As Boolean
			Return FetchUsingPK(codRastro, codProducto, Nothing, Nothing)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(codRastro As System.Int32, codProducto As System.Int32, prefetchPathToUse As IPrefetchPath) As Boolean
			Return FetchUsingPK(codRastro, codProducto, prefetchPathToUse, Nothing)
		End Function
		...
		''' <returns>True if succeeded, False otherwise.</returns>
		Public Function FetchUsingPK(codRastro As System.Int32, codProducto As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Return Fetch(codRastro, codProducto, prefetchPathToUse, contextToUse)
		End Function
		...
		Public Overrides Overloads Function Refetch() As Boolean
			Return Fetch(Me.CodRastro, Me.CodProducto, Nothing, Nothing)
		End Function
		...
		Public  Function TestOriginalFieldValueForNull(fieldIndex As MscrelacionProductosRastrosFieldIndex) As Boolean
		...
		Public  Function TestCurrentFieldValueForNull(fieldIndex As MscrelacionProductosRastrosFieldIndex) As Boolean
		...
		Public Overridable Function GetSingleCatRastros(forceFetch As Boolean) As CatRastrosEntity
			If ( Not _alreadyFetchedCatRastros Or forceFetch Or _alwaysFetchCatRastros) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				If MyBase.CheckIfLazyLoadingShouldOccur(MscrelacionProductosRastrosEntity.Relations.CatRastrosEntityUsingCodRastro) Then
					fetchResult = newEntity.FetchUsingPK(Me.CodRastro)
				End If
		...
		Public Overridable Function GetSingleMsccatProductos(forceFetch As Boolean) As MsccatProductosEntity
			If ( Not _alreadyFetchedMsccatProductos Or forceFetch Or _alwaysFetchMsccatProductos) AndAlso Not MyBase.IsSerializing AndAlso Not MyBase.IsDeserializing Then
				...
				End If
				Dim fetchResult As Boolean = False
				If MyBase.CheckIfLazyLoadingShouldOccur(MscrelacionProductosRastrosEntity.Relations.MsccatProductosEntityUsingCodProducto) Then
					fetchResult = newEntity.FetchUsingPK(Me.CodProducto)
				End If
		...
		Protected Overrides Overloads Function SetNewFieldValue(fieldIndex As Integer, value As Object, checkForRefetch As Boolean) As Boolean
			...
			If toReturn AndAlso System.Enum.IsDefined(GetType(MscrelacionProductosRastrosFieldIndex), fieldIndex) Then
				Select Case CType(fieldIndex, MscrelacionProductosRastrosFieldIndex)
					Case MscrelacionProductosRastrosFieldIndex.CodRastro
						DesetupSyncCatRastros(True, False)
						_alreadyFetchedCatRastros = False
					Case MscrelacionProductosRastrosFieldIndex.CodProducto
		...
		Protected Overrides Overloads Function InsertEntity() As Boolean
			Dim dao As MscrelacionProductosRastrosDAO = CType(CreateDAOInstance(), MscrelacionProductosRastrosDAO)
		...
		''' <param name="validatorToUse">The validator Object for this MscrelacionProductosRastrosEntity</param>
		...
		''' <param name="codRastro">PK value for MscrelacionProductosRastros which data should be fetched into this MscrelacionProductosRastros Object</param>
		''' <param name="codProducto">PK value for MscrelacionProductosRastros which data should be fetched into this MscrelacionProductosRastros Object</param>
		''' <param name="validator">The validator Object for this MscrelacionProductosRastrosEntity</param>
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		Protected Overridable Sub InitClassFetch(codRastro As System.Int32, codProducto As System.Int32, validator As IValidator, prefetchPathToUse As IPrefetchPath)
			OnInitializing()
			InitClassMembers()
			
			MyBase.Fields = CreateFields()
			Dim wasSuccesful As Boolean = Fetch(codRastro, codProducto, prefetchPathToUse, Nothing)
		...
		Private Shared Sub SetupCustomPropertyHashtables()
			...
			_fieldsCustomProperties.Add("CodRastro", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()

			_fieldsCustomProperties.Add("CodProducto", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()

			_fieldsCustomProperties.Add("CodProductoRastro", fieldHashtable)
			fieldHashtable = New Dictionary(Of String, String)()
		...
		Private Sub DesetupSyncCatRastros(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _catRastros, AddressOf OnCatRastrosPropertyChanged, "CatRastros", MscrelacionProductosRastrosEntity.Relations.CatRastrosEntityUsingCodRastro, True, signalRelatedEntity, "MscrelacionProductosRastros", resetFKFields, New Integer() { CInt(MscrelacionProductosRastrosFieldIndex.CodRastro) } )
			_catRastros = Nothing
		End Sub
		...
		Private Sub SetupSyncCatRastros(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _catRastros, AddressOf OnCatRastrosPropertyChanged, "CatRastros", MscrelacionProductosRastrosEntity.Relations.CatRastrosEntityUsingCodRastro, True, _alreadyFetchedCatRastros, New String() {  } )
		End Sub
		...
		Private Sub DesetupSyncMsccatProductos(signalRelatedEntity As Boolean, resetFKFields As Boolean)
			MyBase.PerformDesetupSyncRelatedEntity( _msccatProductos, AddressOf OnMsccatProductosPropertyChanged, "MsccatProductos", MscrelacionProductosRastrosEntity.Relations.MsccatProductosEntityUsingCodProducto, True, signalRelatedEntity, "MscrelacionProductosRastros", resetFKFields, New Integer() { CInt(MscrelacionProductosRastrosFieldIndex.CodProducto) } )
			_msccatProductos = Nothing
		End Sub
		...
		Private Sub SetupSyncMsccatProductos(relatedEntity As IEntity)
			...
			MyBase.PerformSetupSyncRelatedEntity( _msccatProductos, AddressOf OnMsccatProductosPropertyChanged, "MsccatProductos", MscrelacionProductosRastrosEntity.Relations.MsccatProductosEntityUsingCodProducto, True, _alreadyFetchedMsccatProductos, New String() {  } )
		End Sub
		...
		''' <param name="contextToUse">The context to fetch the prefetch path with.</param>
		''' <returns>True if succeeded, False otherwise.</returns>
		Private Function Fetch(codRastro As System.Int32, codProducto As System.Int32, prefetchPathToUse As IPrefetchPath, contextToUse As Context) As Boolean
			Try
				OnFetch()
				Dim dao As IDao = Me.CreateDAOInstance()
				MyBase.Fields(CInt(MscrelacionProductosRastrosFieldIndex.CodRastro)).ForcedCurrentValueWrite(codRastro)
				MyBase.Fields(CInt(MscrelacionProductosRastrosFieldIndex.CodProducto)).ForcedCurrentValueWrite(codProducto)
		...
		Protected Overrides Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateMscrelacionProductosRastrosDAO()
		End Function
		
		''' <summary>Creates the entity factory For this type.</summary>
		''' <returns></returns>
		Protected Overrides Function CreateEntityFactory() As IEntityFactory 
			Return New MscrelacionProductosRastrosEntityFactory()
		End Function

#Region "Class Property Declarations"
		''' <summary>The relations Object holding all relations of this entity with other entity classes.</summary>
		Public  Shared ReadOnly Property Relations() As MscrelacionProductosRastrosRelations
			Get	
				Return New MscrelacionProductosRastrosRelations() 
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathCatRastros() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.CatRastrosCollection(), _
					MscrelacionProductosRastrosEntity.Relations.CatRastrosEntityUsingCodRastro, _
					CType(Integralab.ORM.EntityType.MscrelacionProductosRastrosEntity, Integer), CType(Integralab.ORM.EntityType.CatRastrosEntity, Integer), 0, Nothing, Nothing, Nothing, "CatRastros", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Shared ReadOnly Property PrefetchPathMsccatProductos() As IPrefetchPathElement
			Get
				Return New PrefetchPathElement( New Integralab.ORM.CollectionClasses.MsccatProductosCollection(), _
					MscrelacionProductosRastrosEntity.Relations.MsccatProductosEntityUsingCodProducto, _
					CType(Integralab.ORM.EntityType.MscrelacionProductosRastrosEntity, Integer), CType(Integralab.ORM.EntityType.MsccatProductosEntity, Integer), 0, Nothing, Nothing, Nothing, "MsccatProductos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
			End Get
		End Property
		...
		Public Overridable ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
			Get
				Return MscrelacionProductosRastrosEntity.CustomProperties
			End Get
		End Property
		...
		Public Overridable ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
			Get
				Return MscrelacionProductosRastrosEntity.FieldsCustomProperties
			End Get
		End Property

	
		''' <summary>The CodRastro property of the Entity MscrelacionProductosRastros<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCRelacionProductosRastros"."CodRastro"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [CodRastro]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MscrelacionProductosRastrosFieldIndex.CodRastro, Integer))
			...
			End Get
			Set
				SetNewFieldValue(CType(MscrelacionProductosRastrosFieldIndex.CodRastro, Integer), value)
			End Set
		End Property
	
		''' <summary>The CodProducto property of the Entity MscrelacionProductosRastros<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCRelacionProductosRastros"."CodProducto"<br/>
		''' Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, True, False
		''' </remarks>
		Public Overridable Property [CodProducto]() As System.Int32
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MscrelacionProductosRastrosFieldIndex.CodProducto, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.Int32))
				End If
				Return CType(valueToReturn, System.Int32)
			End Get
			Set
				SetNewFieldValue(CType(MscrelacionProductosRastrosFieldIndex.CodProducto, Integer), value)
			End Set
		End Property
	
		''' <summary>The CodProductoRastro property of the Entity MscrelacionProductosRastros<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCRelacionProductosRastros"."CodProductoRastro"<br/>
		''' Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 10<br/>
		''' Table field behavior characteristics (is nullable, is PK, is identity): False, False, False
		''' </remarks>
		Public Overridable Property [CodProductoRastro]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MscrelacionProductosRastrosFieldIndex.CodProductoRastro, Integer))
				If valueToReturn Is Nothing Then
			...
			End Get
			Set
				SetNewFieldValue(CType(MscrelacionProductosRastrosFieldIndex.CodProductoRastro, Integer), value)
			End Set
		End Property
	
		''' <summary>The Descripcion property of the Entity MscrelacionProductosRastros<br/><br/>
		''' </summary>
		''' <remarks>
		''' Mapped on table field: "MSCRelacionProductosRastros"."Descripcion"<br/>
		...
		Public Overridable Property [Descripcion]() As System.String
			Get
				Dim valueToReturn As Object = MyBase.GetCurrentFieldValue(CType(MscrelacionProductosRastrosFieldIndex.Descripcion, Integer))
				If valueToReturn Is Nothing Then
					valueToReturn = TypeDefaultValue.GetDefaultValue(GetType(System.String))
				End If
				Return CType(valueToReturn, System.String)
			End Get
			Set
				SetNewFieldValue(CType(MscrelacionProductosRastrosFieldIndex.Descripcion, Integer), value)
			End Set
		End Property
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _catRastros Is Nothing Then
							_catRastros.UnsetRelatedEntity(Me, "MscrelacionProductosRastros")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "MscrelacionProductosRastros")
					End If
				End If
			End Set
		End Property
		...
		Public Overridable Property [MsccatProductos]() As MsccatProductosEntity
			...
			Set
				...
				Else
					If value Is Nothing Then
						If Not _msccatProductos Is Nothing Then
							_msccatProductos.UnsetRelatedEntity(Me, "MscrelacionProductosRastros")
						End If
					Else
						CType(value, IEntity).SetRelatedEntity(Me, "MscrelacionProductosRastros")
					End If
		...
		Public Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
			Get 
				Return CInt(Integralab.ORM.EntityType.MscrelacionProductosRastrosEntity)
			End Get
		End Property
#End Region
