...
#Region "Class Property Declarations"
		...
		''' <summary>Returns a new IEntityRelation Object, between CatDeptosEntity and MfacClientesDatosFiscalesEntity over the 1:n relation they have, using the relation between the fields:
		''' CatDeptos.CveDepto - MfacClientesDatosFiscales.IdDepartamento
		''' </summary>
		Public Overridable ReadOnly Property MfacClientesDatosFiscalesEntityUsingIdDepartamento() As IEntityRelation
			Get
				...
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CatDeptosEntity", True)
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("MfacClientesDatosFiscalesEntity", False)
				Return relation
			End Get
		End Property
