...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of FacturasClientesCabEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class FacturasClientesCabCollection 
#Else
	<Serializable()> _
	Public Class FacturasClientesCabCollection 
#End If
		Inherits EntityCollectionBase(Of FacturasClientesCabEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New FacturasClientesCabEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of FacturasClientesCabEntity))
		...
		''' <summary>Retrieves in this FacturasClientesCabCollection Object all FacturasClientesCabEntity objects which have data in common
		...
		Public Overloads Function GetMultiManyToOne(mfacCatClientesInstance As IEntity, mfacCatClientes_Instance As IEntity, polizaInstance As IEntity) As Boolean
			Return GetMultiManyToOne(mfacCatClientesInstance, mfacCatClientes_Instance, polizaInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(mfacCatClientesInstance As IEntity, mfacCatClientes_Instance As IEntity, polizaInstance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(mfacCatClientesInstance, mfacCatClientes_Instance, polizaInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(mfacCatClientesInstance As IEntity, mfacCatClientes_Instance As IEntity, polizaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(mfacCatClientesInstance, mfacCatClientes_Instance, polizaInstance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Overridable Function GetMultiManyToOne(mfacCatClientesInstance As IEntity, mfacCatClientes_Instance As IEntity, polizaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As FacturasClientesCabDAO = DAOFactory.CreateFacturasClientesCabDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, mfacCatClientesInstance, mfacCatClientes_Instance, polizaInstance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all FacturasClientesCab entities which have data in common
		''' with the specified related Entities.
		...
		Public Overloads Function DeleteMultiManyToOne(mfacCatClientesInstance As IEntity, mfacCatClientes_Instance As IEntity, polizaInstance As IEntity) As Integer
			Dim dao As FacturasClientesCabDAO = DAOFactory.CreateFacturasClientesCabDAO()
			Return dao.DeleteMulti(MyBase.Transaction, mfacCatClientesInstance, mfacCatClientes_Instance, polizaInstance)
		End Function


		''' <summary>Updates in the persistent storage all FacturasClientesCab entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">FacturasClientesCabEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="mfacCatClientesInstance">MfacCatClientesEntity instance to use as a filter for the FacturasClientesCabEntity objects to Return</param>
		''' <param name="mfacCatClientes_Instance">MfacCatClientesEntity instance to use as a filter for the FacturasClientesCabEntity objects to Return</param>
		''' <param name="polizaInstance">PolizaEntity instance to use as a filter for the FacturasClientesCabEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As FacturasClientesCabEntity, mfacCatClientesInstance As IEntity, mfacCatClientes_Instance As IEntity, polizaInstance As IEntity) As Integer
			Dim dao As FacturasClientesCabDAO = DAOFactory.CreateFacturasClientesCabDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, mfacCatClientesInstance, mfacCatClientes_Instance, polizaInstance)
		End Function
	
	
		''' <summary>Retrieves in this FacturasClientesCabCollection Object all FacturasClientesCabEntity objects which are related via a 
		...
		''' <summary>Retrieves FacturasClientesCabEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all FacturasClientesCab entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all FacturasClientesCab entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As FacturasClientesCabFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As FacturasClientesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As FacturasClientesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As FacturasClientesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As FacturasClientesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified FacturasClientesCabEntity. 
		...
		''' will result in an update action which will affect all FacturasClientesCab entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As FacturasClientesCabEntity, updateFilter As IPredicate) As Integer
			Dim dao As FacturasClientesCabDAO = DAOFactory.CreateFacturasClientesCabDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As FacturasClientesCabEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As FacturasClientesCabDAO = DAOFactory.CreateFacturasClientesCabDAO()
