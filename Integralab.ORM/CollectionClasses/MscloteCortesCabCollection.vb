...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of MscloteCortesCabEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class MscloteCortesCabCollection 
#Else
	<Serializable()> _
	Public Class MscloteCortesCabCollection 
#End If
		Inherits EntityCollectionBase(Of MscloteCortesCabEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New MscloteCortesCabEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of MscloteCortesCabEntity))
		...
		''' <summary>Updates in the persistent storage all MscloteCortesCab entities which have data in common with the specified related Entities.
		...
		''' <summary>Retrieves in this MscloteCortesCabCollection Object all MscloteCortesCabEntity objects which are related via a 
		...
		Public Function GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance As IEntity) As Boolean
			Return GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, 0, 0)
		End Function
		...
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression) As Boolean
			Return GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0)
		End Function
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As MscloteCortesCabDAO = DAOFactory.CreateMscloteCortesCabDAO()
			Return dao.GetMultiUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, mscmovtosAlmacenCabInstance, pageNumber, pageSize)
		End Function
		...
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Return GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, prefetchPathToUse)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Overridable Function GetMultiManyToManyUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(mscmovtosAlmacenCabInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, prefetchPathToUse As IPrefetchPath) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As MscloteCortesCabDAO = DAOFactory.CreateMscloteCortesCabDAO()
			Return dao.GetMultiUsingMscmovtosAlmacenCabCollectionViaMscloteCortesDet(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, mscmovtosAlmacenCabInstance, prefetchPathToUse)
		End Function
	

		''' <summary>Retrieves MscloteCortesCabEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all MscloteCortesCab entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all MscloteCortesCab entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As MscloteCortesCabFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MscloteCortesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MscloteCortesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MscloteCortesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As MscloteCortesCabFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified MscloteCortesCabEntity. 
		...
		''' will result in an update action which will affect all MscloteCortesCab entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As MscloteCortesCabEntity, updateFilter As IPredicate) As Integer
			Dim dao As MscloteCortesCabDAO = DAOFactory.CreateMscloteCortesCabDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As MscloteCortesCabEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As MscloteCortesCabDAO = DAOFactory.CreateMscloteCortesCabDAO()
