...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of McgcatCausasMuerteEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class McgcatCausasMuerteCollection 
#Else
	<Serializable()> _
	Public Class McgcatCausasMuerteCollection 
#End If
		Inherits EntityCollectionBase(Of McgcatCausasMuerteEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New McgcatCausasMuerteEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of McgcatCausasMuerteEntity))
		...
		''' <summary>Retrieves in this McgcatCausasMuerteCollection Object all McgcatCausasMuerteEntity objects which are related via a 
		...
		Public Function GetMultiManyToManyUsingCabMovGanCollectionViaSalidaGanadoCab(cabMovGanInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			Dim dao As McgcatCausasMuerteDAO = DAOFactory.CreateMcgcatCausasMuerteDAO()
		...
		''' <summary>Retrieves McgcatCausasMuerteEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all McgcatCausasMuerte entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all McgcatCausasMuerte entities from the persistent storage</param>
		...
		Public Overloads Function GetScalar(fieldIndex As McgcatCausasMuerteFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As McgcatCausasMuerteFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As McgcatCausasMuerteFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As McgcatCausasMuerteFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As McgcatCausasMuerteFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified McgcatCausasMuerteEntity. 
		...
		''' <param name="entityWithNewValues">McgcatCausasMuerteEntity instance which holds the new values for the matching entities to update. Only
		...
		''' will result in an update action which will affect all McgcatCausasMuerte entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As McgcatCausasMuerteEntity, updateFilter As IPredicate) As Integer
			Dim dao As McgcatCausasMuerteDAO = DAOFactory.CreateMcgcatCausasMuerteDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As McgcatCausasMuerteEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As McgcatCausasMuerteDAO = DAOFactory.CreateMcgcatCausasMuerteDAO()
