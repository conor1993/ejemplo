...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of ContDiotTiposTercerosEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class ContDiotTiposTercerosCollection 
#Else
	<Serializable()> _
	Public Class ContDiotTiposTercerosCollection 
#End If
		Inherits EntityCollectionBase(Of ContDiotTiposTercerosEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New ContDiotTiposTercerosEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of ContDiotTiposTercerosEntity))
		...
		''' <summary>Retrieves in this ContDiotTiposTercerosCollection Object all ContDiotTiposTercerosEntity objects which are related via a 
		...
		Public Function GetMultiManyToManyUsingCatLugaresDeCompraCollectionViaProveedor(catLugaresDeCompraInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			Dim dao As ContDiotTiposTercerosDAO = DAOFactory.CreateContDiotTiposTercerosDAO()
		...
		''' <summary>Retrieves ContDiotTiposTercerosEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all ContDiotTiposTerceros entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all ContDiotTiposTerceros entities from the persistent storage</param>
		...
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposTercerosFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposTercerosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposTercerosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposTercerosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As ContDiotTiposTercerosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified ContDiotTiposTercerosEntity. 
		...
		''' <param name="entityWithNewValues">ContDiotTiposTercerosEntity instance which holds the new values for the matching entities to update. Only
		...
		''' will result in an update action which will affect all ContDiotTiposTerceros entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As ContDiotTiposTercerosEntity, updateFilter As IPredicate) As Integer
			Dim dao As ContDiotTiposTercerosDAO = DAOFactory.CreateContDiotTiposTercerosDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As ContDiotTiposTercerosEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As ContDiotTiposTercerosDAO = DAOFactory.CreateContDiotTiposTercerosDAO()
