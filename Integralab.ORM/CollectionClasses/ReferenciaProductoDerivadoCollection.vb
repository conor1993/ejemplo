...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of ReferenciaProductoDerivadoEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class ReferenciaProductoDerivadoCollection 
#Else
	<Serializable()> _
	Public Class ReferenciaProductoDerivadoCollection 
#End If
		Inherits EntityCollectionBase(Of ReferenciaProductoDerivadoEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New ReferenciaProductoDerivadoEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of ReferenciaProductoDerivadoEntity))
		...
		''' <summary>Retrieves in this ReferenciaProductoDerivadoCollection Object all ReferenciaProductoDerivadoEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="msccatProductosInstance">MsccatProductosEntity instance to use as a filter for the ReferenciaProductoDerivadoEntity objects to Return</param>
		...
		Public Overloads Overridable Function GetMultiManyToOne(msccatProductosInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As ReferenciaProductoDerivadoDAO = DAOFactory.CreateReferenciaProductoDerivadoDAO()
		...
		''' <summary>Deletes from the persistent storage all ReferenciaProductoDerivado entities which have data in common
		''' with the specified related Entities.
		...
		''' <summary>Updates in the persistent storage all ReferenciaProductoDerivado entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">ReferenciaProductoDerivadoEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="msccatProductosInstance">MsccatProductosEntity instance to use as a filter for the ReferenciaProductoDerivadoEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As ReferenciaProductoDerivadoEntity, msccatProductosInstance As IEntity) As Integer
			Dim dao As ReferenciaProductoDerivadoDAO = DAOFactory.CreateReferenciaProductoDerivadoDAO()
		...
		''' <summary>Retrieves ReferenciaProductoDerivadoEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all ReferenciaProductoDerivado entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all ReferenciaProductoDerivado entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As ReferenciaProductoDerivadoFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ReferenciaProductoDerivadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ReferenciaProductoDerivadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ReferenciaProductoDerivadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As ReferenciaProductoDerivadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified ReferenciaProductoDerivadoEntity. 
		...
		''' will result in an update action which will affect all ReferenciaProductoDerivado entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As ReferenciaProductoDerivadoEntity, updateFilter As IPredicate) As Integer
			Dim dao As ReferenciaProductoDerivadoDAO = DAOFactory.CreateReferenciaProductoDerivadoDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As ReferenciaProductoDerivadoEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As ReferenciaProductoDerivadoDAO = DAOFactory.CreateReferenciaProductoDerivadoDAO()
