...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of AplicMediEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class AplicMediCollection 
#Else
	<Serializable()> _
	Public Class AplicMediCollection 
#End If
		Inherits EntityCollectionBase(Of AplicMediEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New AplicMediEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of AplicMediEntity))
		...
		''' <summary>Retrieves in this AplicMediCollection Object all AplicMediEntity objects which have data in common
		...
		Public Overloads Function GetMultiManyToOne(almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Boolean
			Return GetMultiManyToOne(almacenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(almacenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(almacenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Overridable Function GetMultiManyToOne(almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As AplicMediDAO = DAOFactory.CreateAplicMediDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, almacenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all AplicMedi entities which have data in common
		''' with the specified related Entities.
		...
		Public Overloads Function DeleteMultiManyToOne(almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Integer
			Dim dao As AplicMediDAO = DAOFactory.CreateAplicMediDAO()
			Return dao.DeleteMulti(MyBase.Transaction, almacenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance)
		End Function


		''' <summary>Updates in the persistent storage all AplicMedi entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">AplicMediEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="almacenInstance">AlmacenEntity instance to use as a filter for the AplicMediEntity objects to Return</param>
		''' <param name="inventarioMovimientoAlmacenInstance">InventarioMovimientoAlmacenEntity instance to use as a filter for the AplicMediEntity objects to Return</param>
		''' <param name="inventarioMovimientoAlmacen_Instance">InventarioMovimientoAlmacenEntity instance to use as a filter for the AplicMediEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As AplicMediEntity, almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Integer
			Dim dao As AplicMediDAO = DAOFactory.CreateAplicMediDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, almacenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance)
		End Function
	
	
		''' <summary>Retrieves in this AplicMediCollection Object all AplicMediEntity objects which are related via a 
		...
		''' <summary>Retrieves AplicMediEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all AplicMedi entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all AplicMedi entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As AplicMediFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As AplicMediFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As AplicMediFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As AplicMediFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As AplicMediFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified AplicMediEntity. 
		...
		''' will result in an update action which will affect all AplicMedi entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As AplicMediEntity, updateFilter As IPredicate) As Integer
			Dim dao As AplicMediDAO = DAOFactory.CreateAplicMediDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As AplicMediEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As AplicMediDAO = DAOFactory.CreateAplicMediDAO()
