...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of ContDiotTiposOperacionEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class ContDiotTiposOperacionCollection 
#Else
	<Serializable()> _
	Public Class ContDiotTiposOperacionCollection 
#End If
		Inherits EntityCollectionBase(Of ContDiotTiposOperacionEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New ContDiotTiposOperacionEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of ContDiotTiposOperacionEntity))
		...
		''' <summary>Retrieves in this ContDiotTiposOperacionCollection Object all ContDiotTiposOperacionEntity objects which are related via a 
		...
		Public Function GetMultiManyToManyUsingCatLugaresDeCompraCollectionViaProveedor(catLugaresDeCompraInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
		...
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance As IEntity) As Boolean
			Return GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, 0, 0)
		End Function
		...
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression) As Boolean
			Return GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0)
		End Function
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
			Return dao.GetMultiUsingCuentaContableCollectionViaProveedor(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, cuentaContableInstance, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Return GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, prefetchPathToUse)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Overridable Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, prefetchPathToUse As IPrefetchPath) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
			Return dao.GetMultiUsingCuentaContableCollectionViaProveedor(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, cuentaContableInstance, prefetchPathToUse)
		End Function
		...
		''' <param name="cuentaContableInstance">CuentaContableEntity Object to be used as a filter in the m:n relation</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance As IEntity) As Boolean
			Return GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, 0, 0)
		End Function
		...
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression) As Boolean
			Return GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0)
		End Function
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
			Return dao.GetMultiUsingCuentaContableCollectionViaProveedor_(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, cuentaContableInstance, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Return GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, prefetchPathToUse)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Overridable Function GetMultiManyToManyUsingCuentaContableCollectionViaProveedor_(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, prefetchPathToUse As IPrefetchPath) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
			Return dao.GetMultiUsingCuentaContableCollectionViaProveedor_(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, cuentaContableInstance, prefetchPathToUse)
		End Function
	

		''' <summary>Retrieves ContDiotTiposOperacionEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all ContDiotTiposOperacion entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all ContDiotTiposOperacion entities from the persistent storage</param>
		...
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposOperacionFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposOperacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposOperacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As ContDiotTiposOperacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As ContDiotTiposOperacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified ContDiotTiposOperacionEntity. 
		...
		''' <param name="entityWithNewValues">ContDiotTiposOperacionEntity instance which holds the new values for the matching entities to update. Only
		...
		''' will result in an update action which will affect all ContDiotTiposOperacion entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As ContDiotTiposOperacionEntity, updateFilter As IPredicate) As Integer
			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As ContDiotTiposOperacionEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As ContDiotTiposOperacionDAO = DAOFactory.CreateContDiotTiposOperacionDAO()
		...
		Protected Overrides Overloads Function CreateDAOInstance() As IDao
			Return DAOFactory.CreateContDiotTiposOperacionDAO()
		End Function
