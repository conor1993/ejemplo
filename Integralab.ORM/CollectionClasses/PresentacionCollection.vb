...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of PresentacionEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class PresentacionCollection 
#Else
	<Serializable()> _
	Public Class PresentacionCollection 
#End If
		Inherits EntityCollectionBase(Of PresentacionEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New PresentacionEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of PresentacionEntity))
		...
		''' <summary>Retrieves in this PresentacionCollection Object all PresentacionEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="unidadMedidaInstance">UnidadMedidaEntity instance to use as a filter for the PresentacionEntity objects to Return</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(unidadMedidaInstance As IEntity) As Boolean
			Return GetMultiManyToOne(unidadMedidaInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(unidadMedidaInstance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(unidadMedidaInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(unidadMedidaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(unidadMedidaInstance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Overridable Function GetMultiManyToOne(unidadMedidaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, unidadMedidaInstance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all Presentacion entities which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter.</summary>
		''' <remarks>Runs directly on the persistent storage. It will not delete entity objects from the current collection.</remarks>
		''' <param name="unidadMedidaInstance">UnidadMedidaEntity instance to use as a filter for the PresentacionEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function DeleteMultiManyToOne(unidadMedidaInstance As IEntity) As Integer
			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
			Return dao.DeleteMulti(MyBase.Transaction, unidadMedidaInstance)
		End Function


		''' <summary>Updates in the persistent storage all Presentacion entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">PresentacionEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="unidadMedidaInstance">UnidadMedidaEntity instance to use as a filter for the PresentacionEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As PresentacionEntity, unidadMedidaInstance As IEntity) As Integer
			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, unidadMedidaInstance)
		End Function
	
	
		''' <summary>Retrieves in this PresentacionCollection Object all PresentacionEntity objects which are related via a 
		...
		''' <summary>Retrieves in this PresentacionCollection Object all PresentacionEntity objects which are related via a 
		''' Relation of type 'm:n' with the passed in MarcaEntity. 
		''' All current elements in the collection are removed from the collection.</summary>
		''' <param name="marcaInstance">MarcaEntity Object to be used as a filter in the m:n relation</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance As IEntity) As Boolean
			Return GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, 0, 0)
		End Function
		...
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression) As Boolean
			Return GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0)
		End Function
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
			Return dao.GetMultiUsingMarcaCollectionViaProducto(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, marcaInstance, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Return GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, prefetchPathToUse)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Overridable Function GetMultiManyToManyUsingMarcaCollectionViaProducto(marcaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, prefetchPathToUse As IPrefetchPath) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
			Return dao.GetMultiUsingMarcaCollectionViaProducto(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, marcaInstance, prefetchPathToUse)
		End Function
	

		''' <summary>Retrieves PresentacionEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all Presentacion entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all Presentacion entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As PresentacionFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As PresentacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As PresentacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As PresentacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As PresentacionFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified PresentacionEntity. 
		...
		''' will result in an update action which will affect all Presentacion entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As PresentacionEntity, updateFilter As IPredicate) As Integer
			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As PresentacionEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As PresentacionDAO = DAOFactory.CreatePresentacionDAO()
