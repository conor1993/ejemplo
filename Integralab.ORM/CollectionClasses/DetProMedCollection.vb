...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of DetProMedEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class DetProMedCollection 
#Else
	<Serializable()> _
	Public Class DetProMedCollection 
#End If
		Inherits EntityCollectionBase(Of DetProMedEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New DetProMedEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of DetProMedEntity))
		...
		''' <summary>Retrieves in this DetProMedCollection Object all DetProMedEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="cabProMedInstance">CabProMedEntity instance to use as a filter for the DetProMedEntity objects to Return</param>
		''' <param name="productoInstance">ProductoEntity instance to use as a filter for the DetProMedEntity objects to Return</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(cabProMedInstance As IEntity, productoInstance As IEntity) As Boolean
			Return GetMultiManyToOne(cabProMedInstance, productoInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(cabProMedInstance As IEntity, productoInstance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(cabProMedInstance, productoInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(cabProMedInstance As IEntity, productoInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(cabProMedInstance, productoInstance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Overridable Function GetMultiManyToOne(cabProMedInstance As IEntity, productoInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As DetProMedDAO = DAOFactory.CreateDetProMedDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, cabProMedInstance, productoInstance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all DetProMed entities which have data in common
		''' with the specified related Entities.
		...
		Public Overloads Function DeleteMultiManyToOne(cabProMedInstance As IEntity, productoInstance As IEntity) As Integer
			Dim dao As DetProMedDAO = DAOFactory.CreateDetProMedDAO()
			Return dao.DeleteMulti(MyBase.Transaction, cabProMedInstance, productoInstance)
		End Function


		''' <summary>Updates in the persistent storage all DetProMed entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">DetProMedEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="cabProMedInstance">CabProMedEntity instance to use as a filter for the DetProMedEntity objects to Return</param>
		''' <param name="productoInstance">ProductoEntity instance to use as a filter for the DetProMedEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As DetProMedEntity, cabProMedInstance As IEntity, productoInstance As IEntity) As Integer
			Dim dao As DetProMedDAO = DAOFactory.CreateDetProMedDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, cabProMedInstance, productoInstance)
		End Function
	
	
		''' <summary>Retrieves in this DetProMedCollection Object all DetProMedEntity objects which are related via a 
		...
		''' <summary>Retrieves DetProMedEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all DetProMed entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all DetProMed entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As DetProMedFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As DetProMedFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As DetProMedFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As DetProMedFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As DetProMedFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified DetProMedEntity. 
		...
		''' will result in an update action which will affect all DetProMed entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As DetProMedEntity, updateFilter As IPredicate) As Integer
			Dim dao As DetProMedDAO = DAOFactory.CreateDetProMedDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As DetProMedEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As DetProMedDAO = DAOFactory.CreateDetProMedDAO()
