...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of McgcatCompradoresdeGanadoEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class McgcatCompradoresdeGanadoCollection 
#Else
	<Serializable()> _
	Public Class McgcatCompradoresdeGanadoCollection 
#End If
		Inherits EntityCollectionBase(Of McgcatCompradoresdeGanadoEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New McgcatCompradoresdeGanadoEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of McgcatCompradoresdeGanadoEntity))
		...
		''' <summary>Retrieves in this McgcatCompradoresdeGanadoCollection Object all McgcatCompradoresdeGanadoEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="cuentaContableInstance">CuentaContableEntity instance to use as a filter for the McgcatCompradoresdeGanadoEntity objects to Return</param>
		...
		Public Overloads Overridable Function GetMultiManyToOne(cuentaContableInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As McgcatCompradoresdeGanadoDAO = DAOFactory.CreateMcgcatCompradoresdeGanadoDAO()
		...
		''' <summary>Deletes from the persistent storage all McgcatCompradoresdeGanado entities which have data in common
		''' with the specified related Entities.
		...
		''' <summary>Updates in the persistent storage all McgcatCompradoresdeGanado entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">McgcatCompradoresdeGanadoEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="cuentaContableInstance">CuentaContableEntity instance to use as a filter for the McgcatCompradoresdeGanadoEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As McgcatCompradoresdeGanadoEntity, cuentaContableInstance As IEntity) As Integer
			Dim dao As McgcatCompradoresdeGanadoDAO = DAOFactory.CreateMcgcatCompradoresdeGanadoDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, cuentaContableInstance)
		End Function
	
	
		''' <summary>Retrieves in this McgcatCompradoresdeGanadoCollection Object all McgcatCompradoresdeGanadoEntity objects which are related via a 
		...
		''' <summary>Retrieves McgcatCompradoresdeGanadoEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all McgcatCompradoresdeGanado entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all McgcatCompradoresdeGanado entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As McgcatCompradoresdeGanadoFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As McgcatCompradoresdeGanadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As McgcatCompradoresdeGanadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As McgcatCompradoresdeGanadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As McgcatCompradoresdeGanadoFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified McgcatCompradoresdeGanadoEntity. 
		...
		''' will result in an update action which will affect all McgcatCompradoresdeGanado entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As McgcatCompradoresdeGanadoEntity, updateFilter As IPredicate) As Integer
			Dim dao As McgcatCompradoresdeGanadoDAO = DAOFactory.CreateMcgcatCompradoresdeGanadoDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As McgcatCompradoresdeGanadoEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As McgcatCompradoresdeGanadoDAO = DAOFactory.CreateMcgcatCompradoresdeGanadoDAO()
