...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of CabGasTransEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class CabGasTransCollection 
#Else
	<Serializable()> _
	Public Class CabGasTransCollection 
#End If
		Inherits EntityCollectionBase(Of CabGasTransEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New CabGasTransEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of CabGasTransEntity))
		...
		''' Relation of type 'm:n' with the passed in McgcatConcepGastosEntity. 
		...
		Public Function GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance As IEntity) As Boolean
			Return GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, 0, 0)
		End Function
		...
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression) As Boolean
			Return GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0)
		End Function
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As CabGasTransDAO = DAOFactory.CreateCabGasTransDAO()
			Return dao.GetMultiUsingMcgcatConcepGastosCollectionViaDetGasTrans(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, mcgcatConcepGastosInstance, pageNumber, pageSize)
		End Function
		...
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Return GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, prefetchPathToUse)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Overridable Function GetMultiManyToManyUsingMcgcatConcepGastosCollectionViaDetGasTrans(mcgcatConcepGastosInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, prefetchPathToUse As IPrefetchPath) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As CabGasTransDAO = DAOFactory.CreateCabGasTransDAO()
			Return dao.GetMultiUsingMcgcatConcepGastosCollectionViaDetGasTrans(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, mcgcatConcepGastosInstance, prefetchPathToUse)
		End Function
	

		''' <summary>Retrieves CabGasTransEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all CabGasTrans entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all CabGasTrans entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As CabGasTransFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As CabGasTransFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As CabGasTransFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As CabGasTransFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As CabGasTransFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified CabGasTransEntity. 
		...
		''' will result in an update action which will affect all CabGasTrans entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As CabGasTransEntity, updateFilter As IPredicate) As Integer
			Dim dao As CabGasTransDAO = DAOFactory.CreateCabGasTransDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As CabGasTransEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As CabGasTransDAO = DAOFactory.CreateCabGasTransDAO()
