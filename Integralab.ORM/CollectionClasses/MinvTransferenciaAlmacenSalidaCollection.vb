...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of MinvTransferenciaAlmacenSalidaEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class MinvTransferenciaAlmacenSalidaCollection 
#Else
	<Serializable()> _
	Public Class MinvTransferenciaAlmacenSalidaCollection 
#End If
		Inherits EntityCollectionBase(Of MinvTransferenciaAlmacenSalidaEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New MinvTransferenciaAlmacenSalidaEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of MinvTransferenciaAlmacenSalidaEntity))
		...
		''' <summary>Retrieves in this MinvTransferenciaAlmacenSalidaCollection Object all MinvTransferenciaAlmacenSalidaEntity objects which have data in common
		...
		Public Overloads Function GetMultiManyToOne(almacenDestinoInstance As IEntity, almacenOrigenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Boolean
			Return GetMultiManyToOne(almacenDestinoInstance, almacenOrigenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(almacenDestinoInstance As IEntity, almacenOrigenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(almacenDestinoInstance, almacenOrigenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(almacenDestinoInstance As IEntity, almacenOrigenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(almacenDestinoInstance, almacenOrigenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Overridable Function GetMultiManyToOne(almacenDestinoInstance As IEntity, almacenOrigenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, almacenDestinoInstance, almacenOrigenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all MinvTransferenciaAlmacenSalida entities which have data in common
		''' with the specified related Entities.
		...
		Public Overloads Function DeleteMultiManyToOne(almacenDestinoInstance As IEntity, almacenOrigenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Integer
			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
			Return dao.DeleteMulti(MyBase.Transaction, almacenDestinoInstance, almacenOrigenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance)
		End Function


		''' <summary>Updates in the persistent storage all MinvTransferenciaAlmacenSalida entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">MinvTransferenciaAlmacenSalidaEntity instance which holds the new values for the matching entities to update. Only
		...
		''' <param name="inventarioMovimientoAlmacen_Instance">InventarioMovimientoAlmacenEntity instance to use as a filter for the MinvTransferenciaAlmacenSalidaEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As MinvTransferenciaAlmacenSalidaEntity, almacenDestinoInstance As IEntity, almacenOrigenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Integer
			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, almacenDestinoInstance, almacenOrigenInstance, inventarioMovimientoAlmacenInstance, inventarioMovimientoAlmacen_Instance)
		End Function
	
	
		''' <summary>Retrieves in this MinvTransferenciaAlmacenSalidaCollection Object all MinvTransferenciaAlmacenSalidaEntity objects which are related via a 
		...
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance As IEntity) As Boolean
			Return GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, 0, 0)
		End Function
		...
		''' <param name="sortClauses">The order by specifications for the sorting of the resultset. When not specified, no sorting is applied.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression) As Boolean
			Return GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance, maxNumberOfItemsToReturn, sortClauses, 0, 0)
		End Function
		...
		''' <param name="pageSize">The page size of the page to retrieve.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
			Return dao.GetMultiUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, productoInstance, pageNumber, pageSize)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Function GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance As IEntity, prefetchPathToUse As IPrefetchPath) As Boolean
			Return GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, prefetchPathToUse)
		End Function
		...
		''' <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch.</param>
		''' <returns>true if the retrieval succeeded, false otherwise</returns>
		Public Overridable Function GetMultiManyToManyUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(productoInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, prefetchPathToUse As IPrefetchPath) As Boolean
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If

			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
			Return dao.GetMultiUsingProductoCollectionViaMinvTransferenciaAlmacenSalidaDetalle(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, productoInstance, prefetchPathToUse)
		End Function
	

		''' <summary>Retrieves MinvTransferenciaAlmacenSalidaEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all MinvTransferenciaAlmacenSalida entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all MinvTransferenciaAlmacenSalida entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As MinvTransferenciaAlmacenSalidaFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MinvTransferenciaAlmacenSalidaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MinvTransferenciaAlmacenSalidaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MinvTransferenciaAlmacenSalidaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As MinvTransferenciaAlmacenSalidaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified MinvTransferenciaAlmacenSalidaEntity. 
		...
		''' will result in an update action which will affect all MinvTransferenciaAlmacenSalida entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As MinvTransferenciaAlmacenSalidaEntity, updateFilter As IPredicate) As Integer
			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As MinvTransferenciaAlmacenSalidaEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As MinvTransferenciaAlmacenSalidaDAO = DAOFactory.CreateMinvTransferenciaAlmacenSalidaDAO()
