...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of TipoComicionistaEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class TipoComicionistaCollection 
#Else
	<Serializable()> _
	Public Class TipoComicionistaCollection 
#End If
		Inherits EntityCollectionBase(Of TipoComicionistaEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New TipoComicionistaEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of TipoComicionistaEntity))
		...
		''' <summary>Retrieves in this TipoComicionistaCollection Object all TipoComicionistaEntity objects which are related via a 
		...
		Public Function GetMultiManyToManyUsingPlazaCollectionViaComicionista(plazaInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			Dim dao As TipoComicionistaDAO = DAOFactory.CreateTipoComicionistaDAO()
		...
		''' <summary>Retrieves TipoComicionistaEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all TipoComicionista entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all TipoComicionista entities from the persistent storage</param>
		...
		Public Overloads Function GetScalar(fieldIndex As TipoComicionistaFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As TipoComicionistaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As TipoComicionistaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As TipoComicionistaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As TipoComicionistaFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified TipoComicionistaEntity. 
		...
		''' <param name="entityWithNewValues">TipoComicionistaEntity instance which holds the new values for the matching entities to update. Only
		...
		''' will result in an update action which will affect all TipoComicionista entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As TipoComicionistaEntity, updateFilter As IPredicate) As Integer
			Dim dao As TipoComicionistaDAO = DAOFactory.CreateTipoComicionistaDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As TipoComicionistaEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As TipoComicionistaDAO = DAOFactory.CreateTipoComicionistaDAO()
