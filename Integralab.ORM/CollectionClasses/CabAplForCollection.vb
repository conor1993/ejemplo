...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of CabAplForEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class CabAplForCollection 
#Else
	<Serializable()> _
	Public Class CabAplForCollection 
#End If
		Inherits EntityCollectionBase(Of CabAplForEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New CabAplForEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of CabAplForEntity))
		...
		''' <summary>Retrieves in this CabAplForCollection Object all CabAplForEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="almacenInstance">AlmacenEntity instance to use as a filter for the CabAplForEntity objects to Return</param>
		''' <param name="inventarioMovimientoAlmacenInstance">InventarioMovimientoAlmacenEntity instance to use as a filter for the CabAplForEntity objects to Return</param>
		''' <param name="inventarioMovimientoAlmacen_Instance">InventarioMovimientoAlmacenEntity instance to use as a filter for the CabAplForEntity objects to Return</param>
		...
		Public Overloads Overridable Function GetMultiManyToOne(almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As CabAplForDAO = DAOFactory.CreateCabAplForDAO()
		...
		''' <summary>Deletes from the persistent storage all CabAplFor entities which have data in common
		''' with the specified related Entities.
		...
		''' <summary>Updates in the persistent storage all CabAplFor entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">CabAplForEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="almacenInstance">AlmacenEntity instance to use as a filter for the CabAplForEntity objects to Return</param>
		''' <param name="inventarioMovimientoAlmacenInstance">InventarioMovimientoAlmacenEntity instance to use as a filter for the CabAplForEntity objects to Return</param>
		''' <param name="inventarioMovimientoAlmacen_Instance">InventarioMovimientoAlmacenEntity instance to use as a filter for the CabAplForEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As CabAplForEntity, almacenInstance As IEntity, inventarioMovimientoAlmacenInstance As IEntity, inventarioMovimientoAlmacen_Instance As IEntity) As Integer
			Dim dao As CabAplForDAO = DAOFactory.CreateCabAplForDAO()
		...
		''' <summary>Retrieves in this CabAplForCollection Object all CabAplForEntity objects which are related via a 
		...
		''' <summary>Retrieves CabAplForEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all CabAplFor entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all CabAplFor entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As CabAplForFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As CabAplForFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As CabAplForFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As CabAplForFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As CabAplForFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified CabAplForEntity. 
		...
		''' will result in an update action which will affect all CabAplFor entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As CabAplForEntity, updateFilter As IPredicate) As Integer
			Dim dao As CabAplForDAO = DAOFactory.CreateCabAplForDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As CabAplForEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As CabAplForDAO = DAOFactory.CreateCabAplForDAO()
