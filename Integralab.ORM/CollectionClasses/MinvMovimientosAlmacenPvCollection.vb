...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of MinvMovimientosAlmacenPvEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class MinvMovimientosAlmacenPvCollection 
#Else
	<Serializable()> _
	Public Class MinvMovimientosAlmacenPvCollection 
#End If
		Inherits EntityCollectionBase(Of MinvMovimientosAlmacenPvEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New MinvMovimientosAlmacenPvEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of MinvMovimientosAlmacenPvEntity))
		...
		''' <summary>Retrieves in this MinvMovimientosAlmacenPvCollection Object all MinvMovimientosAlmacenPvEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="catMovimientosAlmacenPvInstance">CatMovimientosAlmacenPvEntity instance to use as a filter for the MinvMovimientosAlmacenPvEntity objects to Return</param>
		''' <param name="almacenInstance">AlmacenEntity instance to use as a filter for the MinvMovimientosAlmacenPvEntity objects to Return</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(catMovimientosAlmacenPvInstance As IEntity, almacenInstance As IEntity) As Boolean
			Return GetMultiManyToOne(catMovimientosAlmacenPvInstance, almacenInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(catMovimientosAlmacenPvInstance As IEntity, almacenInstance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(catMovimientosAlmacenPvInstance, almacenInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(catMovimientosAlmacenPvInstance As IEntity, almacenInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(catMovimientosAlmacenPvInstance, almacenInstance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Overridable Function GetMultiManyToOne(catMovimientosAlmacenPvInstance As IEntity, almacenInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			Dim validParameters As Boolean = False
			validParameters = validParameters Or Not (catMovimientosAlmacenPvInstance Is Nothing)
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As MinvMovimientosAlmacenPvDAO = DAOFactory.CreateMinvMovimientosAlmacenPvDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, catMovimientosAlmacenPvInstance, almacenInstance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all MinvMovimientosAlmacenPv entities which have data in common
		''' with the specified related Entities.
		...
		Public Overloads Function DeleteMultiManyToOne(catMovimientosAlmacenPvInstance As IEntity, almacenInstance As IEntity) As Integer
			Dim dao As MinvMovimientosAlmacenPvDAO = DAOFactory.CreateMinvMovimientosAlmacenPvDAO()
			Return dao.DeleteMulti(MyBase.Transaction, catMovimientosAlmacenPvInstance, almacenInstance)
		End Function


		''' <summary>Updates in the persistent storage all MinvMovimientosAlmacenPv entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">MinvMovimientosAlmacenPvEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="catMovimientosAlmacenPvInstance">CatMovimientosAlmacenPvEntity instance to use as a filter for the MinvMovimientosAlmacenPvEntity objects to Return</param>
		''' <param name="almacenInstance">AlmacenEntity instance to use as a filter for the MinvMovimientosAlmacenPvEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As MinvMovimientosAlmacenPvEntity, catMovimientosAlmacenPvInstance As IEntity, almacenInstance As IEntity) As Integer
			Dim dao As MinvMovimientosAlmacenPvDAO = DAOFactory.CreateMinvMovimientosAlmacenPvDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, catMovimientosAlmacenPvInstance, almacenInstance)
		End Function
	
	
		''' <summary>Retrieves in this MinvMovimientosAlmacenPvCollection Object all MinvMovimientosAlmacenPvEntity objects which are related via a 
		...
		''' <summary>Retrieves MinvMovimientosAlmacenPvEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all MinvMovimientosAlmacenPv entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all MinvMovimientosAlmacenPv entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As MinvMovimientosAlmacenPvFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MinvMovimientosAlmacenPvFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MinvMovimientosAlmacenPvFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As MinvMovimientosAlmacenPvFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As MinvMovimientosAlmacenPvFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified MinvMovimientosAlmacenPvEntity. 
		...
		''' will result in an update action which will affect all MinvMovimientosAlmacenPv entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As MinvMovimientosAlmacenPvEntity, updateFilter As IPredicate) As Integer
			Dim dao As MinvMovimientosAlmacenPvDAO = DAOFactory.CreateMinvMovimientosAlmacenPvDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As MinvMovimientosAlmacenPvEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As MinvMovimientosAlmacenPvDAO = DAOFactory.CreateMinvMovimientosAlmacenPvDAO()
