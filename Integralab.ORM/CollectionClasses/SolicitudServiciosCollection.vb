...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of SolicitudServiciosEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class SolicitudServiciosCollection 
#Else
	<Serializable()> _
	Public Class SolicitudServiciosCollection 
#End If
		Inherits EntityCollectionBase(Of SolicitudServiciosEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New SolicitudServiciosEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of SolicitudServiciosEntity))
		...
		''' <summary>Retrieves in this SolicitudServiciosCollection Object all SolicitudServiciosEntity objects which have data in common
		''' with the specified related Entities.
		''' If one is omitted, that entity is not used as a filter. All current elements in the collection are removed from the collection.</summary>
		''' <param name="sucursalInstance">SucursalEntity instance to use as a filter for the SolicitudServiciosEntity objects to Return</param>
		...
		Public Overloads Overridable Function GetMultiManyToOne(sucursalInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As SolicitudServiciosDAO = DAOFactory.CreateSolicitudServiciosDAO()
		...
		''' <summary>Deletes from the persistent storage all SolicitudServicios entities which have data in common
		''' with the specified related Entities.
		...
		''' <summary>Updates in the persistent storage all SolicitudServicios entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">SolicitudServiciosEntity instance which holds the new values for the matching entities to update. Only
		''' changed fields are taken into account</param>
		''' <param name="sucursalInstance">SucursalEntity instance to use as a filter for the SolicitudServiciosEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As SolicitudServiciosEntity, sucursalInstance As IEntity) As Integer
			Dim dao As SolicitudServiciosDAO = DAOFactory.CreateSolicitudServiciosDAO()
		...
		''' <summary>Retrieves SolicitudServiciosEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all SolicitudServicios entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all SolicitudServicios entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As SolicitudServiciosFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As SolicitudServiciosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As SolicitudServiciosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As SolicitudServiciosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As SolicitudServiciosFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified SolicitudServiciosEntity. 
		...
		''' will result in an update action which will affect all SolicitudServicios entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As SolicitudServiciosEntity, updateFilter As IPredicate) As Integer
			Dim dao As SolicitudServiciosDAO = DAOFactory.CreateSolicitudServiciosDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As SolicitudServiciosEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As SolicitudServiciosDAO = DAOFactory.CreateSolicitudServiciosDAO()
