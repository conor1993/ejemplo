...
Namespace Integralab.ORM.CollectionClasses
	''' <summary>
	''' Collection class for storing and retrieving collections of AplicMediDetEntity objects. 
	''' </summary>
#If CF Then
	<SD.LLBLGen.Pro.ORMSupportClasses.Serializable()> _
	Public Class AplicMediDetCollection 
#Else
	<Serializable()> _
	Public Class AplicMediDetCollection 
#End If
		Inherits EntityCollectionBase(Of AplicMediDetEntity)
	
		''' <summary>CTor</summary>
		Public Sub New()
			MyBase.New(New AplicMediDetEntityFactory())
		End Sub

		''' <summary>CTor</summary>
		''' <param name="initialContents">The initial contents of this collection.</param>
		Public Sub New( initialContents As IList(Of AplicMediDetEntity))
		...
		''' <summary>Retrieves in this AplicMediDetCollection Object all AplicMediDetEntity objects which have data in common
		...
		Public Overloads Function GetMultiManyToOne(aplicMediInstance As IEntity, productoInstance As IEntity, mcecatCorralesCabInstance As IEntity, mcecatLotesCabInstance As IEntity) As Boolean
			Return GetMultiManyToOne(aplicMediInstance, productoInstance, mcecatCorralesCabInstance, mcecatLotesCabInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Nothing, 0, 0)
		End Function
		...
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(aplicMediInstance As IEntity, productoInstance As IEntity, mcecatCorralesCabInstance As IEntity, mcecatLotesCabInstance As IEntity, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(aplicMediInstance, productoInstance, mcecatCorralesCabInstance, mcecatLotesCabInstance, MyBase.MaxNumberOfItemsToReturn, MyBase.SortClauses, Filter, 0, 0)
		End Function
		...
		''' <param name="filter">Extra filter to limit the resultset. Predicate expression can be Nothing, in which case it will be ignored.</param>
		''' <returns>true if succeeded, false otherwise</returns>
		Public Overloads Function GetMultiManyToOne(aplicMediInstance As IEntity, productoInstance As IEntity, mcecatCorralesCabInstance As IEntity, mcecatLotesCabInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression) As Boolean
			Return GetMultiManyToOne(aplicMediInstance, productoInstance, mcecatCorralesCabInstance, mcecatLotesCabInstance, maxNumberOfItemsToReturn, sortClauses, Filter, 0, 0)
		End Function
		...
		Public Overloads Overridable Function GetMultiManyToOne(aplicMediInstance As IEntity, productoInstance As IEntity, mcecatCorralesCabInstance As IEntity, mcecatLotesCabInstance As IEntity, maxNumberOfItemsToReturn As Long, sortClauses As ISortExpression, Filter As IPredicateExpression, pageNumber As Integer, pageSize As Integer) As Boolean
			...
			If Not MyBase.SuppressClearInGetMulti Then
				Me.Clear()
			End If
			Dim dao As AplicMediDetDAO = DAOFactory.CreateAplicMediDetDAO()
			Return dao.GetMulti(MyBase.Transaction, Me, maxNumberOfItemsToReturn, sortClauses, MyBase.EntityFactoryToUse, Filter, aplicMediInstance, productoInstance, mcecatCorralesCabInstance, mcecatLotesCabInstance, pageNumber, pageSize)
		End Function

		''' <summary>Deletes from the persistent storage all AplicMediDet entities which have data in common
		''' with the specified related Entities.
		...
		Public Overloads Function DeleteMultiManyToOne(aplicMediInstance As IEntity, productoInstance As IEntity, mcecatCorralesCabInstance As IEntity, mcecatLotesCabInstance As IEntity) As Integer
			Dim dao As AplicMediDetDAO = DAOFactory.CreateAplicMediDetDAO()
			Return dao.DeleteMulti(MyBase.Transaction, aplicMediInstance, productoInstance, mcecatCorralesCabInstance, mcecatLotesCabInstance)
		End Function


		''' <summary>Updates in the persistent storage all AplicMediDet entities which have data in common with the specified related Entities.
		...
		''' <param name="entityWithNewValues">AplicMediDetEntity instance which holds the new values for the matching entities to update. Only
		...
		''' <param name="mcecatLotesCabInstance">McecatLotesCabEntity instance to use as a filter for the AplicMediDetEntity objects to Return</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMultiManyToOne(entityWithNewValues As AplicMediDetEntity, aplicMediInstance As IEntity, productoInstance As IEntity, mcecatCorralesCabInstance As IEntity, mcecatLotesCabInstance As IEntity) As Integer
			Dim dao As AplicMediDetDAO = DAOFactory.CreateAplicMediDetDAO()
			Return dao.UpdateMulti(entityWithNewValues, MyBase.Transaction, aplicMediInstance, productoInstance, mcecatCorralesCabInstance, mcecatLotesCabInstance)
		End Function
	
	
		''' <summary>Retrieves in this AplicMediDetCollection Object all AplicMediDetEntity objects which are related via a 
		...
		''' <summary>Retrieves AplicMediDetEntity rows in a datatable which match the specified filter. It will always create a new connection to the database.</summary>
		...
		''' <summary>Deletes from the persistent storage all AplicMediDet entities which match with the specified filter, formulated in
		...
		''' will result in a query removing all AplicMediDet entities from the persistent storage</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		...
		Public Overloads Function GetScalar(fieldIndex As AplicMediDetFieldIndex, aggregateToApply As AggregateFunction) As Object
		...
		''' <param name="aggregateToApply">Aggregate function to apply. </param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As AplicMediDetFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As AplicMediDetFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate) As Object
		...
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Function GetScalar(fieldIndex As AplicMediDetFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, groupByClause As IGroupByCollection) As Object
		...
		''' <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		''' <Returns>the scalar value requested</Returns>
		Public Overloads Overridable Function GetScalar(fieldIndex As AplicMediDetFieldIndex, expressionToExecute As IExpression, aggregateToApply As AggregateFunction, Filter As IPredicate, relations As IRelationCollection, groupByClause As IGroupByCollection) As Object
		...
		''' <summary>Updates in the persistent storage all entities which have data in common with the specified AplicMediDetEntity. 
		...
		''' will result in an update action which will affect all AplicMediDet entities.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As AplicMediDetEntity, updateFilter As IPredicate) As Integer
			Dim dao As AplicMediDetDAO = DAOFactory.CreateAplicMediDetDAO()
		...
		''' <param name="relations">The set of relations to walk to construct the total query.</param>
		''' <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		Public Overloads Function UpdateMulti(entityWithNewValues As AplicMediDetEntity, updateFilter As IPredicate, relations As IRelationCollection) As Integer
			Dim dao As AplicMediDetDAO = DAOFactory.CreateAplicMediDetDAO()
