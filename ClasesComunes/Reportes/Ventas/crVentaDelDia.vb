...
Public Class crVentaDelDia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesComunes.crVentaDelDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrVentaDelDia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crVentaDelDia = New crVentaDelDia()
        rpt.Site = Me.Site
        Return rpt
    End Function
