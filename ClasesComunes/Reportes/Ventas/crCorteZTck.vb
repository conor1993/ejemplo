...
Public Class crCorteZTck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesComunes.crCorteZTck.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TipoCorte() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrCorteZTck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCorteZTck = New crCorteZTck()
        rpt.Site = Me.Site
        Return rpt
    End Function
