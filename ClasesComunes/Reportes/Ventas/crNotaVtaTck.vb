...
Public Class crNotaVtaTck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesComunes.crNotaVtaTck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrNotaVtaTck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crNotaVtaTck = New crNotaVtaTck()
        rpt.Site = Me.Site
        Return rpt
    End Function
