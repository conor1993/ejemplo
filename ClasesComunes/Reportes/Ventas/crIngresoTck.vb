...
Public Class crIngresoTck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesComunes.crIngresoTck.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdIngreso() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrIngresoTck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crIngresoTck = New crIngresoTck()
        rpt.Site = Me.Site
        Return rpt
    End Function
