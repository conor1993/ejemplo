...
Public Class rptComprasProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesComunes.rptComprasProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComprasProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprasProducto = New rptComprasProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
