...
Public Class rptInvMensual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesComunes.rptInvMensual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdFamilia() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptInvMensual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvMensual = New rptInvMensual()
        rpt.Site = Me.Site
        Return rpt
    End Function
