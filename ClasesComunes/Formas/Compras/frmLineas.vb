Public Class frmLineas
    ...
    Private Sub guardar()
        ...
        If Application.ProductName.ToUpper() = "PUNTO DE VENTA" Or Application.ProductName.ToUpper() = "BACKEND" Then Linea.LinPuntoVenta = True
        If Application.ProductName.ToUpper() = "MEAT" Then Linea.LinMeat = True
    End Sub
