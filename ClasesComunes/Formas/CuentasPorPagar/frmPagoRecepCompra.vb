...
Public Class frmPagoRecepCompra
...
#End Region
    ...
    Private Sub frmPagoFacturas_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        MtbEstados.StateBuscar = "011011111"
        MtbEstados.StateLimpiar = ""
        MtbEstados.StateCancelar = "000100001"
    ...
    Public Sub llenarGridRecepOrdenes()
        ...
        If cmbProveedor.SelectedIndex <> -1 And bandera <> False Then
            ...
            If Not (chkFacturada.Checked And chkSinFacturar.Checked) Then
                If chkFacturada.Checked Then
                    filtro.Add(HC.RecepcionOrdenCompraFields.Facturada = True)
                    gbFacturar.Visible = False
                    txtFactura.Text = ""
                    MtxtUUID.Text = ""
                ...
                If chkSinFacturar.Checked Then
                    filtro.Add(HC.RecepcionOrdenCompraFields.Facturada = False)
                    gbFacturar.Visible = True
                    gbFacturar.Enabled = True
                Else
            ...
            If Not (chkPagada.Checked And chkSPagar.Checked) Then
                If chkSPagar.Checked Then
                    filtro.Add(HC.RecepcionOrdenCompraFields.Pagada = False)
            ...
            For Each row As EC.RecepcionOrdenCompraEntity In RecepcionesOrdenCompra
                ...
                Pago.Obtener(row.IdProveedor, row.FolioRecepcionOrdenCompra, Controlador.Empresa.CodEmpndx)

                If Pago.Count = 0 Then
                    Pago.Obtener(row.IdProveedor, row.NoFactura, Controlador.Empresa.CodEmpndx)
                    If Pago.Count = 0 Then
                        Pago.Obtener(row.IdProveedor, ("R" & CInt(row.FolioRecepcionOrdenCompra.Replace("R", "")).ToString()), Controlador.Empresa.CodEmpndx)
                    End If
    ...
    Public Sub limpiar()
        ...
        chkSinFacturar.Checked = False
        chkSPagar.Checked = False
...
#Region "Metodos Barra"
    ...
    Public Function ValidarBarra() As String Implements InterfaceForm.Validar
        ...
        Else
            If list.Count = 0 Then
                mensaje &= "    *Seleccione al menos una compra." & vbLf
            End If
        End If

        If chkFacturada.Checked = False And chkSinFacturar.Checked = False And chkPagada.Checked = False And chkSPagar.Checked = False Then
            mensaje &= "    *selección de solo lectura." & vbLf
        End If

        If chkFacturada.Checked Then
            ''AMBOS CHECK DE FACTURADOS Y POR FACTURAR ACTIVOS
            If chkFacturada.Checked And chkSinFacturar.Checked Then
                If chkSPagar.Checked And chkPagada.Checked Then
                    mensaje &= "    *selección de solo lectura." & vbLf
                ElseIf chkSPagar.Checked = False And chkPagada.Checked = False Then
                    mensaje &= "    *selección de solo lectura." & vbLf
                ElseIf chkPagada.Checked Then
                    mensaje &= "    *selección de solo lectura." & vbLf
                ElseIf chkSPagar.Checked Then
        ...
        Else
            If chkSinFacturar.Checked Then
                If chkPagada.Checked And chkSPagar.Checked Then
                    mensaje &= "    *selección de solo lectura." & vbLf
                ElseIf chkPagada.Checked = False And chkSPagar.Checked = False Then
                    ''FACTURAR
                    If txtFactura.Text.Trim() = "" Then
            ...
            Else
                If chkPagada.Checked And chkSinFacturar.Checked Then
                    mensaje &= "    *selección de solo lectura." & vbLf
                ElseIf chkPagada.Checked Then
                    mensaje &= "    *selección de solo lectura." & vbLf
                    'If chkFormaPago.Checked Then
    ...
    Private Sub mtb_ClickGuardar(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickGuardar
        ...
        If IsNothing(ValidarBarra()) Then
            ...
            Try
                ...
                Dim recepcionCompra As RecepcionOrdenCompraClass
                If chkSinFacturar.Checked And chkSPagar.Checked Then
                    ''SE HACE FACTURA
                    ...
                    'End If
                    Factura.Saldo = CDec(lblImporte.Text.Replace("$", ""))
                    ...
                    If Factura.Guardar(Tran) Then
                        For i As Integer = 0 To dgvRecepComp.Rows.Count - 1
                            If dgvRecepComp.Rows(i).Cells(0).Value = True And dgvRecepComp.Rows(i).Cells(0).Value <> Nothing Then
                                ...
                                folio = recepcionCompra.NumFactura
                        ...
                        Pago.NoFactura = txtFactura.Text.Trim()
                    ...
                    Else
                        ...
                        Return
                    End If
                ElseIf chkSinFacturar.Checked Then
                    ''SE HACE FACTURA
                    ...
                    For i As Integer = 0 To dgvRecepComp.Rows.Count - 1
                        If dgvRecepComp.Rows(i).Cells(0).Value = True And dgvRecepComp.Rows(i).Cells(0).Value <> Nothing Then
                            ...
                            If recepcionCompra.Guardar(Tran) Then
                                ...
                                Pago.Importe = Convert.ToDecimal(dgvRecepComp.Rows(i).Cells(clmTotal.Index).Value)
                                Pago.IdUsuarioAlta = Controlador.Sesion.Usrndx
                                Pago.IdConcepto = 0
                ...
                If chkFormaPago.Checked Then
                    ...
                    Else
                        ...
                        If rbFactura.Checked Then
                            ''Factura  CN.FacturasCabCXPClass
                            If chkFormaPago.Checked Then
                                If chkFacturada.Checked And rbSinPagar.Checked Then
                                    Dim totalPagadas = 0, TotalNopagadas = 0
                                    Facturas = ""
                ...
                If procesoCorrecto Then
                    ...
                    If chkSPagar.Checked Then
                        ...
                        If rbCheque.Checked Or rbTrans.Checked Then
                            ...
                            If chkSinFacturar.Checked Or chkFacturada.Checked Then
                                Dim temx As String = "PAGO A PROVEEDOR " & NombreProveedor & " la(s) Recepción(es) de Compra: " & Recepciones & ",\n con el folio de la factura " & txtFactura.Text.Trim() & "."
                                Dim conttext As Integer = temx.Length
                                If conttext > 99 Then
                                    conttext = 99
                                End If

                                temx = temx.Substring(0, conttext)
                                Cheque.Concepto = temx
                            Else
                                Dim temx As String = "PAGO A PROVEEDOR " & NombreProveedor & " la(s) Recepción(es) de Compra: " & Recepciones
                                Dim conttext As Integer = temx.Length
                                If conttext > 99 Then
                        ...
                        ElseIf rbEfect.Checked Then
                            ...
                            If RetiroCaja Then
                                ...
                                'Dim Folio As New FoliosClassPagoEfectivoRecepcionCompra
                                'Folio.Codigo = CodigodeFolios.
                                'Folio.Año = Now.Year
                                'Folio.Mes = Now.ToString("MM")
                                ...
                                '    Retiro.importe = TotalGlobal
                                'Else
                                Retiro.importe = CDec(lblImporte.Text.Replace("$", ""))
                                'End If
                                ...
                                If Retiro.Guardar() Then
                                    ...
                                    Finally
                                        ...
                                        ' Else
                                        If chkSinFacturar.Checked Or chkFacturada.Checked Then
                                            MsgBox("Pago se realizo correctamente de la(s) Recepción(es) de Compra: " & Recepciones & "\n, con el folio de la factura " & txtFactura.Text.Trim() & ".", MsgBoxStyle.Information, "AVISO")
                                        Else
                                            MsgBox("Pago se realizo correctamente de la(s) Recepción(es) de Compra: " & Recepciones & ".", MsgBoxStyle.Information, "AVISO")
                                        End If
...
#End Region
    ...
    Private Sub chkSinFacturar_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkSinFacturar.CheckedChanged
        llenarGridRecepOrdenes()
    End Sub
End Class