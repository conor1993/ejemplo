Public Class frmCatConceptos

    Dim WithEvents Ciudad As ClasesNegocio.CiudadClass
    Dim WithEvents Concepto As ClasesNegocio.ConceptoCajaClass
    Dim WithEvents Conceptos As New ClasesNegocio.ConceptoCajaCollectionClass
...
#End Region
    ...
    Private Sub TxtDescripción_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        'Para pasar al siguiente control
        'If e.KeyChar = Chr(13) Then
        '    Me.SelectNextControl(sender, True, True, False, True)
        '    TxtConcepto.Focus()
    ...
    Private Sub TxtDescCorta_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtConcepto.KeyPress
    ...
    Private Sub GralCatCiudades_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'MtbEstados.StateGuardar = "100110011"
        'MtbEstados.StateGuardar = "111011011"
        ...
        table.Rows.Add("E", "Retiro")
        table.Rows.Add("I", "Abono")
...
#Region "Metodos"
    ...
    Private Sub guardar()
        ...
        'Ciudad.DescripcionCorta = TxtConcepto.Text
        'Ciudad.Observaciones = TxtObservacion.Text

    End Sub

    Private Sub LlenarGrid()
        Conceptos = New ClasesNegocio.ConceptoCajaCollectionClass
        Try
...
#End Region
    ...
    Private Sub Ciudad_Modificado(ByVal sender As Object, ByVal e As System.EventArgs) Handles Ciudad.Modificado
        ...
        '    TxtConcepto.Text = Ciudad.DescripcionCorta
    ...
    Private Sub MEAToolBar_ClickGuardar(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As System.Boolean) Handles mtb.ClickGuardar
        ...
        Try
            ...
            If Me.cmbTipo.SelectedIndex = -1 Then
                MsgBox("Debe seleccionar un tipo", MsgBoxStyle.Exclamation, "Faltan Datos")
                Cancelar = False
                Exit Sub
            End If

            If Me.TxtConcepto.Text = "" Then
                MsgBox("Debe ingresar un concepto", MsgBoxStyle.Exclamation, "Faltan Datos")
                Cancelar = True
                Exit Sub
            End If

            If (Concepto.ObtenerEntidad.IsNew()) Then
                Concepto = New ClasesNegocio.ConceptoCajaClass
            End If

            Concepto.Tipo = Convert.ToString(cmbTipo.SelectedValue)
            ...
            If Concepto.Guardar Then
                If Editar Then
                    MsgBox("El concepto se ha modificado satisfactoriamente.", MsgBoxStyle.Information, "Aviso")
                Else
                    MsgBox("El concepto se ha guardado satisfactoriamente.", MsgBoxStyle.Information, "Aviso")
                End If
    ...
    Private Sub MEAToolBar_ClickBorrar(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As System.Boolean) Handles mtb.ClickBorrar
        ...
        Try
            If Concepto.Borrar Then
                MsgBox("El concepto ha sido borrado.", MsgBoxStyle.Information, "Aviso")
                deshabilitar()
                LlenarGrid()
                limpiar()
            Else
                Cancelar = True
                MsgBox("No se puede borrar registro, se encuetra relacionado.", MsgBoxStyle.Exclamation, "Error")
            End If
        Catch ex As Exception
    ...
    Private Sub DataGrid_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid.DoubleClick
        If DataGrid.SelectedRows.Count > 0 Then
            Concepto = New ClasesNegocio.ConceptoCajaClass
            Concepto.Obtener(DataGrid.SelectedRows(0).Cells(0).Value)
            cmbTipo.SelectedValue = Concepto.Tipo
            TxtConcepto.Text = Concepto.Concepto
            TxtCodigo.Text = DataGrid.SelectedRows(0).Cells(0).Value
            'mtb.sbCambiarEstadoBotones("Guardar")
    ...
    Private Sub mtb_ClickImprimir(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickImprimir
        ...
        '    Cursor = Cursors.WaitCursor
        '    Dim Previsualizar As New ClasesNegocio.PreVisualizarForm
        '    Dim Concepto As New ClasesNegocio.ConceptoCajaCollectionClass
        '    Concepto.Obtener()
        '    If Concepto.Count.ToString > 0 Then
        '        Previsualizar.Text = "Reporte de Conceptos"
        '        Previsualizar.Reporte = Ciudad.Reporte(Controlador.Sesion.MiEmpresa.Empnom, Controlador.Sesion.MiUsuario.Usrnomcom)
        '        Previsualizar.ShowDialog()
        '    Else
        '        MsgBox("No se enconto ninguna Ciudad", MsgBoxStyle.Information, "No hay Informacion")
