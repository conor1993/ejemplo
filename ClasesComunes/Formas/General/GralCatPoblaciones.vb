...
#End Region
    ...
    Private Sub CmbEstado_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmbEstado.SelectedIndexChanged
        If CmbEstado.SelectedIndex > -1 And Not Me.CmbEstado.ValueMember = "" Then
            CiudadC.Obtener(DirectCast(CmbEstado.SelectedItem, ClasesNegocio.EstadoClass), ClasesNegocio.CondicionEnum.ACTIVOS)
    ...
    Private Sub DataGrid_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGrid.DoubleClick
        ...
        If Me.DataGrid.SelectedRows.Count > 0 Then
            ...
            CmbEstado.SelectedValue = Poblacion.CodigoEstado.Codigo
            CmbCiudad.SelectedValue = Poblacion.CodigoCiudad.Codigo
