...
#Region "Metodos"
    ...
    Private Sub guardar()
        ...
        Sucursal.IdSerieFactura = CType(cmbSerieFactura.SelectedValue, Integer)
        Sucursal.Letra = txtLetras.Text
    End Sub
...
#End Region
    ...
    Private Sub Sucursal_Modificado(ByVal sender As Object, ByVal e As System.EventArgs)
        If puedorefrescar Then
            ...
            cmbSerieFactura.SelectedValue = Sucursal.IdSerieFactura
    ...
    Private Sub MEAToolBar1_ClickGuardar(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As System.Boolean) Handles MEAToolBar1.ClickGuardar
        Cursor = Cursors.WaitCursor
        Dim trans As New Transaction(IsolationLevel.ReadCommitted, "Menus")
        Try
            ...
            'If Me.cmbSerieFactura.SelectedIndex = -1 Then
            '    MsgBox("Debe seleccionar una serie de facturación.", MsgBoxStyle.Exclamation, "Faltan Datos")
            '    Cancelar = True
            '    Exit Sub
            'End If
            ...
            If Sucursal.Guardar(Application.ProductName) Then
                Dim a As Boolean = Application.AllowQuit
