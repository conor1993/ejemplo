...
Partial Class BusquedaCuentasContablesForm
    ...
    Public WithEvents txtCta As Integra.Controles.TextboxNumerico
    Public WithEvents txtSCta As Integra.Controles.TextboxNumerico
    Public WithEvents txtSSCta As Integra.Controles.TextboxNumerico
    Public WithEvents txtSSSCta As Integra.Controles.TextboxNumerico
    Friend WithEvents gpoCaracteristicas As System.Windows.Forms.GroupBox
    Public WithEvents chkBan As System.Windows.Forms.CheckBox
    Public WithEvents chkIna As System.Windows.Forms.CheckBox
    Public WithEvents chkDep As System.Windows.Forms.CheckBox
    Public WithEvents chkAfe As System.Windows.Forms.CheckBox
    Public WithEvents chkPre As System.Windows.Forms.CheckBox
    Public WithEvents chkRes As System.Windows.Forms.CheckBox
