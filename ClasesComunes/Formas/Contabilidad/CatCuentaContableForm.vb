...
#Region " Metodos "
    ...
    Private Sub BuscarSoloUnaCuentaContable()
        Try
            ...
            If Not (Me.txtCta.Text.PadLeft(4, "0").Equals("0000")) Then
                nivel = 1
            End If

            If Not (Me.txtCta.Text.PadLeft(4, "0").Equals("0000")) And Not (Me.txtSCta.Text.PadLeft(4, "0").Equals("0000")) Then
                nivel = 2
            End If
            If Not (Me.txtCta.Text.PadLeft(4, "0").Equals("0000")) And Not (Me.txtSCta.Text.PadLeft(4, "0").Equals("0000")) And Not (Me.txtSSCta.Text.PadLeft(4, "0").Equals("0000")) Then
                nivel = 3
            End If
            If Not (Me.txtCta.Text.PadLeft(4, "0").Equals("0000")) And Not (Me.txtSCta.Text.PadLeft(4, "0").Equals("0000")) And Not (Me.txtSSCta.Text.PadLeft(4, "0").Equals("0000")) And Not (Me.txtSSSCta.Text.PadLeft(4, "0").Equals("0000")) Then
                nivel = 4
            End If

            If Cuenta Is Nothing And nivel > 0 Then

                If nivel <> 1 Then
                    Dim ctaTemp As New CN.CuentaContableClass
                    If nivel = 2 Then
                        ctaTemp = CuentaCol.ObtenerCuentaContable(Me.txtCta.Text.PadLeft(4, "0"), Me.txtSCta.Text.PadLeft(4, "0"))
                    ElseIf nivel = 3 Then
                        ctaTemp = CuentaCol.ObtenerCuentaContable(Me.txtCta.Text.PadLeft(4, "0"), Me.txtSCta.Text.PadLeft(4, "0"), Me.txtSSCta.Text.PadLeft(4, "0"))
                    ElseIf nivel = 4 Then
                        ctaTemp = CuentaCol.ObtenerCuentaContable(Me.txtCta.Text.PadLeft(4, "0"), Me.txtSCta.Text.PadLeft(4, "0"), Me.txtSSCta.Text.PadLeft(4, "0"), Me.txtSSSCta.Text.PadLeft(4, "0"))
                    End If
                    gpoNaturaleza.Enabled = False
                    If ctaTemp IsNot Nothing Then
                        If ctaTemp.Naturaleza = ClasesNegocio.CuentaContableNaturalezaEnum.ACREEDORA Then
                            rdbAcredora.Checked = True
                        Else
                            rdbDeudora.Checked = True
                        End If
...
#End Region
    ...
    Private Sub MostrarCuentas()
        Try
            ...
            Lista.Fill(0, New OC.SortExpression(New SortClause(HC.VwContCuentasFields.CuentaContable, SortOperator.Ascending)), True, Filtro)
