...
Public Class Utilerias
    ...
    Public Shared Function ValidarCierreDiario() As Boolean
        Dim sqlAdapter As New SqlClient.SqlDataAdapter("Select CortePorDia From dbo.ConfigPuntoVta", IntegraLab.ORM.HelperClasses.DbUtils.ActualConnectionString)
        Dim dsDatos As New DataSet

        Try
            sqlAdapter.Fill(dsDatos)
            Return Convert.ToBoolean(dsDatos.Tables(0).Rows(0)(0))
