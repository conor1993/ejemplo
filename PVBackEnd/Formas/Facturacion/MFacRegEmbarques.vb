...
#Region "Metodos"
    ...
    Private Function Guardar(ByVal trans As HC.Transaction) As Boolean
        Try
            ...
            Embarque.TotalKilos = Integer.Parse(Me.txtKgrs.Text)
            ...
            For Each Fila As DataGridViewRow In dgvRelaciondeCortes.Rows
                If Not Fila.IsNewRow Then
                    ...
                    If dgvRelaciondeCortes.Item(Etiqueta.Index, Fila.Index).Value.ToString.Trim <> "" Then
                        caja.FetchUsingPK(dgvRelaciondeCortes.Item(LoteCorte.Index, Fila.Index).Value.ToString.Trim, dgvRelaciondeCortes.Item(Etiqueta.Index, Fila.Index).Value.ToString.Trim)
                    End If
    ...
    Private Function Imprimir() As Boolean
        Try
            ...
            Else
                ...
                Dim Poblacion As New EC.PoblacionEntity(Domicilio.IdPoblacion)
                ...
                Reporte.SetParameterValue(7, Poblacion.Ciudad.Descripcion)
                Reporte.SetParameterValue(8, Poblacion.Ciudad.Estado.Descripcion)
