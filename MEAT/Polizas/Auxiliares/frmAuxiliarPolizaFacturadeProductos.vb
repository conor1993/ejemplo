...
Public Class frmAuxiliarPolizaFacturadeProductos

    Private Sub frmAuxiliarPolizaFacturadeProductos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Public Sub Imprimir()
        Try
            ...
            ReporteAuxiliarPolizasFacturasReciba(ClasesNegocio.TipoFacturaEnum.VENTA_DE_PRODUCTO, Me.dtbFechaContable.Value, ClasesNegocio.EstatusChar.VIGENTE)
        Catch ex As Exception
    ...
    Public Sub ReporteAuxiliarPolizasFacturasReciba(Optional ByVal Tipo As TipoFacturaEnum = TipoFacturaEnum.FACTURACION_DE_VENTA_DE_RECIBA, Optional ByVal FechaContable As DateTime = Nothing, Optional ByVal Estatus As EstatusChar = EstatusChar.TODOS)
        ...
        Select Case Tipo
            Case TipoFacturaEnum.VENTA_DE_PRODUCTO
                Modulo = "Auxiliar de Póliza de Facturación de Venta en Reciba"
                Reporte = New rptAuxiliarPolizaFacturaVentaReciba
        End Select


        For Each FacturasdeVentaCabecero As FacturasClass In Controlador.ObtenerFacturasdeVentasParaAuxiliarContable(Me.dtbFechaContable.Value.AddDays(1), TipoFacturaEnum.VENTA_DE_PRODUCTO)
            With FacturasdeVentaCabecero
                For Each detalle As FacturasDetalleClass In .Detalles
                    ...
                    End If
                    dt.AddAuxiliarFacturasRecibaVentaRow(.NoFactura, .Cliente, Clientes.Nombre, .FechaFactura, .FechaVencimiento, .ImporteSubTotal, .ImporteDescuento, detalle.PorcentajeIVA, detalle.TipoGanado.ToString, GanadoDescripcion, detalle.IdProducto, _
    ...
    Public Sub Guardar()
        ...
        Try
            ...
            Total = 0
            For Each FacturasdeVentaCabecero As FacturasClass In Controlador.ObtenerFacturasdeVentasParaAuxiliarContable(Me.dtbFechaContable.Value.AddDays(1), TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_CORRAL)
