...
Public Class FrmAuxiliarPolizaFacturaCorralaMuerte

    Private Sub FrmAuxiliarPolizaFacturaCorralaMuerte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Public Sub Imprimir()
        Try
            ...
            ReporteAuxiliarPolizasFacturasReciba(ClasesNegocio.TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_CORRAL, Me.dtbFechaContable.Value, ClasesNegocio.EstatusChar.VIGENTE)
        Catch ex As Exception
