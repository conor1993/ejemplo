...
Public Class frmAuxiliarPolizaFacturaRecibaaVenta

    Private Sub frmAuxiliarPolizaFacturaRecibaaVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
