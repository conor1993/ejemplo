...
Public Class frmAuxiliarPolizaFacturaRecibaaMuerte

    Private Sub frmAuxiliarPolizaFacturaRecibaaMuerte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Public Sub Imprimir()
        Try
            ...
            ReporteAuxiliarPolizasFacturasReciba(ClasesNegocio.TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_RECIBA, Me.dtbFechaContable.Value, ClasesNegocio.EstatusChar.VIGENTE)
        Catch ex As Exception
    ...
    Public Sub ReporteAuxiliarPolizasFacturasReciba(Optional ByVal Tipo As TipoFacturaEnum = TipoFacturaEnum.FACTURACION_DE_VENTA_DE_RECIBA, Optional ByVal FechaContable As DateTime = Nothing, Optional ByVal Estatus As EstatusChar = EstatusChar.TODOS)
        ...
        For Each FacturasdeVentaCabecero As FacturasClass In Controlador.ObtenerFacturasdeVentasParaAuxiliarContable(Me.dtbFechaContable.Value.AddDays(1), TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_RECIBA)
