...
Public Class frmPolizaFacturaCorralaMuerte
    Dim CodigoPoliza As Long
    Private Sub frmPolizaFactturaCorralaMuerte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
