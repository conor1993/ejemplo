...
Public Class frmPolizadeAplicaciónyProrrateodeMedicamentos
    Dim CodigoPoliza As Long
    Private Sub frmPolizadeAplicaciónyProrrateodeMedicamentos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Function ImportesPolizas() As Boolean
        Try
            ...
            Filtro.Add(HC.CabFacturasFields.TipoFactu = TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_CORRAL)
