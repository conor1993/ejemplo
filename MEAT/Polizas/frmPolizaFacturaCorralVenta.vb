...
Public Class frmPolizaFacturaCorralVenta
    Dim CodigoPoliza As Long
    Private Sub frmPolizaFacturaCorralVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Function ImportesPolizas() As Boolean
        Try
            ...
            Filtro.Add(HC.CabFacturasFields.TipoFactu = TipoFacturaEnum.FACTURACION_DE_VENTA_DE_CORRAL)
