...
Public Class frmPolizadeAplicaciondeFormulas
    Dim CodigoPoliza As Long
    Private Sub frmPolizadeAplicaciondeFormulas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
