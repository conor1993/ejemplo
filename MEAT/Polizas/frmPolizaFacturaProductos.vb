...
Public Class frmPolizaFacturaProductos
    Dim CodigoPoliza As Long
    Private Sub frmPolizaFacturaProductos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Function GenerarPoliza(ByVal Trans As Integralab.ORM.HelperClasses.Transaction) As Boolean
        Try
            ...
            Poliza.Concepto = "Facturación de Productos"
    ...
    Function ImportesPolizas() As Boolean
        Try
            ...
            Filtro.Add(HC.CabFacturasFields.TipoFactu = TipoFacturaEnum.VENTA_DE_PRODUCTO)
