...
Public Class frmPolizaFacturaRecibaVenta
    Dim CodigoPoliza As Long

    Private Sub frmPolizaFacturaRecibaVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Function GenerarPoliza(ByVal Trans As Integralab.ORM.HelperClasses.Transaction) As Boolean
        ...
        Try
            ...
            Poliza.Concepto = "Facturación de Venta en Reciba"
    ...
    Function ImportesPolizas() As Boolean
        Try
            ...
            Filtro.Add(New OC.FieldBetweenPredicate(HC.CabFacturasFields.FecConta, dtbFechaContable.Value.ToShortDateString, dtbFechaContable.Value.AddDays(1).ToShortDateString))
            Filtro.Add(HC.CabFacturasFields.TipoFactu = TipoFacturaEnum.FACTURACION_DE_VENTA_DE_RECIBA)
