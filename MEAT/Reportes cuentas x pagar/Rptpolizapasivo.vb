...
Public Class Rptpolizapasivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEAT.Rptpolizapasivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NoFactura() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptpolizapasivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rptpolizapasivo = New Rptpolizapasivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
