...
Public Class FrmConFacturas
        ...
        Try
            ...
            If Not Me.RbtnTodas.Checked Then
                ...
                If Me.RbtnCanceladas.Checked Then
                    Filtro.Add(HC.VwConsultaFacturasSinFiltradoFields.Estatus = "X")
                End If
    ...
    Private Sub txtNoFactura_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNoFactura.KeyPress, RbtVigentes.KeyPress, RbtnTodas.KeyPress, RbtnPagadas.KeyPress, RbtnCanceladas.KeyPress, RbtnAbonadas.KeyPress, DtpFechaIni.KeyPress, DtpFechaFin.KeyPress, DgvFacturas.KeyPress, CmbCliente.KeyPress, ChkFechas.KeyPress
