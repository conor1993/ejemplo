...
Public Class rptCXCFacturasGenerales
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCXCFacturasGenerales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEAT.rptCXCFacturasGenerales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotalReal() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCXCFacturasGenerales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCXCFacturasGenerales = New rptCXCFacturasGenerales()
        rpt.Site = Me.Site
        Return rpt
    End Function
