...
Public Class RptVentasPorProducto
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptVentasPorProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEAT.RptVentasPorProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentasPorProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentasPorProducto = New RptVentasPorProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
