...
Public Class Utilerias
    ...
    Friend Shared Sub Forma_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim Forma As Form = CType(sender, Form)
        Forma.AutoValidate = Windows.Forms.AutoValidate.Inherit
    End Sub

    Friend Shared Sub Forma_Deactivate(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim Forma As Form = CType(sender, Form)
