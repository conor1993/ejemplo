...
Public Class frmBusquedaCorralesRecibaCorral
...
#Region "Acciones del Menu"
    Public Sub Buscar()
        ...
        dgvCorralesRecibaCab.DataSource = Controlador.ObtenerSalidasDeRecibaACorral(txtFolio.Text, RangodeFechas, Estatus, New CorralClass(CType(cmbCorral.SelectedItem, EC.McecatCorralesCabEntity)), CType(cmbLoteDestino.SelectedItem, LoteClass))
    End Sub
    ...
    Public Sub Limpiar()
        ...
        cmbCorral.Text = "Seleccione el Corral"
        cmbLoteDestino.SelectedIndex = -1
        cmbLoteDestino.Text = "Seleccione el Lote Destino"
