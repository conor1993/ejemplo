...
Public Class frmBusquedaCorralesRecibaRastro
...
#Region "Acciones del Menu"
    Public Sub Buscar()
        ...
        dgvCorralesRecibaCab.DataSource = Controlador.ObtenerSalidasDeRecibaARastro(txtFolio.Text, RangodeFechas, Estatus, New CorralClass(CType(cmbCorral.SelectedItem, EC.McecatCorralesCabEntity)), New RastroClass(CType(cmbRastro.SelectedItem, EC.CatRastrosEntity)))
    End Sub
