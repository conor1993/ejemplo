...
Public Class frmSalidasRecibaVenta
...
#Region "Acciones_Menu"
    ...
    Public Function Buscar() As Boolean
        Dim Cabezas As Integer = 0, Kilos As Decimal = 0D, Importe As Decimal = 0D, ImporteVenta As Decimal = 0D
        Dim frmCorralesReciba As New frmBusquedaCorralesRecibaVenta
    ...
    Public Function Guardar(ByVal Trans As HC.Transaction) As Boolean
        ...
        If Me.Validate() Then
            If Controlador.Configuracion.Engorda.RequerirArete Then
                ...
                CorralRecibaAretes.IdTipoReciba = SalidaGanadoCabeceroClass.TipoSalida.Corral_de_Reciba_a_Venta
                ...
                Next
                Controlador.RealizarSalidadeRecibaaVenta(CorralRecibaAretes, Me.dtpFecha.Value, Trans)
            Else
                Controlador.RealizarSalidadeRecibaaVenta(CorralReciba, Me.dtpFecha.Value, Trans)
            End If
            Trans.Commit()
            If Controlador.Configuracion.Engorda.RequerirArete Then
                MessageBox.Show("La Salida de Reciba a Venta se ha realizado satisfactoriamente con el folio: " & CorralRecibaAretes.Folio)
                Controlador.ImpresionSalidaDeGanado(CorralRecibaAretes)
            Else
                MessageBox.Show("La Salida de Reciba a Venta se ha realizado satisfactoriamente con el folio: " & CorralReciba.Folio)
    ...
    Public Function Borrar(ByVal Trans As HC.Transaction) As Boolean
        ...
        Trans.Commit()
        Cancelar()
        MessageBox.Show("La Salida de Reciba a Venta se ha cancelado satisfactoriamente")
        Return True
    End Function
...
#Region "Eventos"
    ...
    Private Sub dgvDetalle_CellEndEdit(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvDetalle.CellEndEdit
        If e.ColumnIndex = clmIdTipoGanado.Index Then
            ...
            Me.dgvDetalleLote.Rows.Clear()
            dgvDetalle.Refresh()
        ElseIf e.ColumnIndex = clmCabezas.Index Or e.ColumnIndex = clmKilos.Index Or e.ColumnIndex = clmPrecioxKilo.Index Then
            ...
            For Each detalle As SalidaGanadoDetalleClass In CorralReciba.Detalles
                ...
                If detalle.IsDirty OrElse Not detalle.IsNew Then
                    ...
                    TotalImporteVenta += detalle.ImporteVenta
                End If
            Next
