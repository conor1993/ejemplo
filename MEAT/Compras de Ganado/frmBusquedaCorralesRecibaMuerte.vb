...
Public Class frmBusquedaCorralesRecibaMuerte
...
#Region "Acciones del Menu"
    Public Sub Buscar()
        ...
        dgvCorralesRecibaCab.DataSource = Controlador.ObtenerSalidasDeRecibaAMuerte(txtFolio.Text, RangodeFechas, Estatus, New CorralClass(CType(cmbCorral.SelectedItem, EC.McecatCorralesCabEntity)), New CausaMuertesClass(CType(cmbCausaMuerte.SelectedItem, EC.McgcatCausasMuerteEntity)), chkRecuperacion.Checked)
    End Sub
