...
#Region "Metodos"
    ...
    Private Sub Habilitar()
        ...
        Me.txtDomicilioFisc.Enabled = True
    ...
    Private Sub DesHabilitar()
        ...
        Me.txtDomicilioFisc.Enabled = False
    ...
    Private Sub PonerDatos()
        Try
            Me.txtCodigo.Text = Me.Cliente.Codigo
    ...
    Private Function Validar() As Boolean
        Try
            ...
            ElseIf Me.txtDomicilio.Text.Trim = "" Then
                Mensaje.AppendLine("Domicilio")
            ElseIf Me.txtColonia.Text.Trim = "" Then
                Mensaje.AppendLine("Colonia")
            ElseIf Me.CmbEstado.SelectedValue Is Nothing Then
                Mensaje.AppendLine("Estado")
            ElseIf Me.CmbCiudades.SelectedValue Is Nothing Then
                Mensaje.AppendLine("Ciudad")
            ElseIf Me.CmbPoblaciones.SelectedValue Is Nothing Then
                Mensaje.AppendLine("Poblacion")
            ElseIf Me.txtRfc.Text.Trim = String.Empty OrElse Not ValidateRFC(txtRfc.Text.Trim) Then
                Mensaje.AppendLine("RFC")
            End If
    ...
    Private Function ValidarFiscales() As Boolean
        Try
            If Not Me.txtRazonSocial.Text = "" Then
                Return True
            End If
            If Not Me.txtDomicilioFisc.Text = "" Then
                Return True
            End If
...
#Region "Combos"
    ...
    Private Sub CmbEstado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbEstado.SelectedIndexChanged
        Try
            If Me.CmbEstado.SelectedIndex > -1 And Me.CmbEstado.SelectedItem IsNot Nothing Then
    ...
    Private Sub cmbEstadoFisc_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbEstadoFisc.SelectedIndexChanged
        Try
            If Me.cmbCiudadFisc.SelectedIndex >= -1 And Me.cmbEstadoFisc.SelectedItem IsNot Nothing Then
...
#Region "Botones Toolbar"
    ...
    Private Sub mtb_ClickGuardar(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickGuardar
        ...
        Try
            ...
            If Resultado Is Nothing OrElse Not Boolean.Parse(Resultado) Then
                Trans.Rollback()
                Cancelar = True
...
#Region "Botones"
    Private Sub btnCtaContable_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCtaContable.Click
        Try
            ...
            CuentaConfiguracion.GetMulti(HC.ConCfgCtasFields.Concepto Mod String.Format("%{0}%", "CLIENTES GANADERA TASA 0"), 0, Nothing, Relacion)
...
#Region "Key Press"
    ...
    Private Sub txtRazonSocial_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            Me.txtDomicilioFisc.Focus()
        End If
    End Sub

    Private Sub txtDomicilioFisc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtDomicilioFisc.KeyDown
        If e.KeyCode = Keys.Enter Then
...
#End Region
    ...
    Private Sub btnCrearDomicilio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCrearDomicilio.Click
        Try
            dgvDomicilios.DataSource = Nothing
            Dim Domicilio As New CN.DomicilioClienteClass(Me.cmbPoblacionFisc.SelectedValue, Me.txtColoniaFisc.Text.Trim, Me.txtDomicilioFisc.Text.Trim, Me.txtCPfiscal.Text.Trim, Me.txtTelefonoFisc.Text.Trim, txtTelCel.Text.Trim, txtFax.Text.Trim, txtEmail.Text.Trim)
            Cliente.ValidarDomicliosDiferentes(Domicilio)
            Cliente.DomiciliosFiscales.Add(Domicilio)
    ...
    Private Sub btnModificarDomicilio_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEditarDomicilio.Click
        Try
            Dim Domicilio As New CN.DomicilioClienteClass(cmbPoblacionFisc.SelectedValue, txtColoniaFisc.Text.Trim, txtDomicilioFisc.Text.Trim, txtCPfiscal.Text.Trim, txtTelefonoFisc.Text.Trim, txtTelCel.Text.Trim, txtFax.Text.Trim, txtEmail.Text.Trim)

            Domicilio.validarDomicilio(Val(cmbPoblacionFisc.SelectedValue), txtColoniaFisc.Text.Trim, txtDomicilioFisc.Text.Trim, txtEmail.Text.Trim)
