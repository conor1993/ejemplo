...
Public Class frmFacturaciondeMuerteEnReciba
...
#Region "Metodos"
    ...
    Public Function Guardar(ByVal Trans As HC.Transaction, ByVal Estatus As String) As Boolean
        Try
            If Estatus = "V" Then
                ...
                'guardar cabecero
                Controlador.RealizarFacturasdeVenta(FacturaCabecero, Now, ClasesNegocio.TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_RECIBA, Trans)
                ...
                For i As Integer = 0 To Me.dgvDetalle.RowCount - 1
                    ...
                    FacturasDetalle.TipoFactura = CN.TipoFacturaEnum.FACTURACION_DE_VENTA_DE_RECIBA
    ...
    Private Function Imprimir(ByVal DomicilioCliente As CN.DomicilioClienteClass, Optional ByVal conRFC As Boolean = True) As Boolean
        Try
            ...
            Fact = Controlador.ObtenerFacturasDeVenta(Me.txtFolioFactura.Text, Nothing, 0, ClasesNegocio.EstatusChar.TODOS, ClasesNegocio.TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_RECIBA)
    ...
    Private Function CargarSalidasdeGanadoaMuerte() As Boolean
        Try
            Dim Cabezas As Integer = 0, Kilos As Decimal = 0D, Importe As Decimal = 0D, ImporteVenta As Decimal = 0D
            Dim Consultas As New frmBusquedaCorralesRecibaMuerte
            ...
            If Consultas.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                SalidadeRecibaAVenta = CType(Consultas.dgvCorralesRecibaCab.SelectedRows(0).DataBoundItem, CN.SalidaGanadoCabeceroClass)
                ...
                For Each Detalle As CN.SalidaGanadoDetalleClass In SalidadeRecibaAVenta.Detalles
...
#Region "Eventos"
    Private Sub frmfacturaciondemuerteenreciba_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub MEAToolBar1_ClickBuscar(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles MEAToolBar1.ClickBuscar
        Try
            ...
            Dim ListaSalidas As New List(Of String)
            Consultas.TipoFactura = ClasesNegocio.TipoFacturaEnum.FACTURACION_DE_MUERTE_EN_RECIBA
            If Consultas.ShowDialog = Windows.Forms.DialogResult.OK Then
    ...
    Private Sub MEAToolBar1_ClickNuevo(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles MEAToolBar1.ClickNuevo
        ...
        If Me.CargarSalidasdeGanadoaMuerte() Then
            Habilitar()
