...
Public Class _692ReportedeCarteraPorvendedor
    Private Sub Limpiar()
    ...
    Private Sub Imprimir()
        ...
        Try
            ...
            Dim reporte As New rptCarteraporVendedor
            ...
            reporte.SetParameterValue(1, "Cuentas por Cobrar/Reportes/Cartera por Tipo de Vendedor")
...
#End If
    ...
    Private Sub _692ReportedeCarteraPorvendedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Limpiar()
        Catch ex As Exception
