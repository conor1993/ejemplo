...
Public Class crRecepcionGanado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEAT.crRecepcionGanado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRecepcionGanado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRecepcionGanado = New crRecepcionGanado()
        rpt.Site = Me.Site
        Return rpt
    End Function
