...
Public Class rptCierreContable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEAT.rptCierreContable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCierreContable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCierreContable = New rptCierreContable()
        rpt.Site = Me.Site
        Return rpt
    End Function
