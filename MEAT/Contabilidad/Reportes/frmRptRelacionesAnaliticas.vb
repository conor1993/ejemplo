...
Public Class frmRptRelacionesAnaliticas
...
#Region "Acciones"
    ...
    Public Sub Imprimir()
        ...
        ValidarFechas()
        Controlador.ReporteRelacionesAnaliticas(ultdtpInicial.Value, ultdtpFinal.Value, txtIniCuentaP1.Text & txtIniCuentaP2.Text & txtIniCuentaP3.Text & txtIniCuentaP4.Text, txtFinCuentaP1.Text & txtFinCuentaP2.Text & txtFinCuentaP3.Text & txtFinCuentaP4.Text)
    End Sub
