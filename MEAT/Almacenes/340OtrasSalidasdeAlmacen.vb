    ...
    Private Function GuardarCab() As Boolean
        Try
            ...
            If ConfigAlm.Count < 1 Then
                MessageBox.Show("Configure los movimientos de almacén para poder guardar", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                Return False
            End If
                    ...
                    If Me.DgvProductos.CurrentRow.Cells(Me.clmCantidad.Index).Value > 0 Then
                        ...
                        If InvCol.Count > 0 Then
                            ...
                            If Me.DgvProductos.CurrentRow.Cells(Me.clmCantidad.Index).Value > Exist Then
                                MessageBox.Show("Esta sacando mas mercancia de la que hay en el almacén", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            End If
                        Else
    ...
    Private Sub mtb_ClickBorrar(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickBorrar
        ...
        Try
            ...
            If Not GuardarCab() Then
                Trans.Rollback()
                Cancelar = True
                MessageBox.Show("No se pudo cancelar la salida del Almacén, intente de nuevo", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            ...
            Next
            Trans.Commit()
            MessageBox.Show("Se ha registrado la cancelación de salida de Almacén con el folio: " & _FolioAlmacen, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
            DesHabilitar()
            Limpiar()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub mtb_ClickGuardar(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickGuardar
        ...
        Try
            ...
            If Not GuardarCab() Then
                Trans.Rollback()
                Cancelar = True
                MessageBox.Show("No se pudo registrar la Salida en el Almacén, intente de nuevo", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            End If
            ...
            For i = 0 To Me.DgvProductos.Rows.Count - 2
                ...
                If Not MovAlmacenDet.Guardar(Trans) Then
                    Trans.Rollback()
                    Cancelar = True
                    MessageBox.Show("No se pudo registrar Salida en el Almacén, intente de nuevo", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            Next
            Trans.Commit()
            MessageBox.Show("Se ha registrado Salida en el Almacén con el folio: " & _FolioAlmacen, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information)
            DesHabilitar()
            Limpiar()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
