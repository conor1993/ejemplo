...
Public Class frmBusquedaCorralesAVenta
...
#Region "Acciones del Menu"
    Public Sub Buscar()
        ...
        dgvCorralesRecibaCab.DataSource = Controlador.ObtenerSalidasDeCorralAVenta(txtFolio.Text, RangodeFechas, Estatus, txtArete.Text.Trim)
    End Sub
