...
Public Class frmReporteMedicamentosReimplante
    ...
    Private Sub cmbMedicamento_ActualizarCombo(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbMedicamento.ActualizarCombo
        Try
            ...
            rel.Add(New OC.EntityRelation(HC.ProductoFields.Codigo, HC.CabMediReimFields.CveMedi, _
    ...
    Private Sub MEAToolBar1_ClickImprimir(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As System.Boolean) Handles MEAToolBar1.ClickImprimir
        ...
        Try
            Dim col As New ClasesNegocio.MedicamentoReimplanteCollectionClass
            Dim filtro As New OC.PredicateExpression

            If Me.cmbMedicamento.SelectedIndex > -1 Then filtro.Add(HC.CabMediReimFields.CveMedi = CInt(Me.cmbMedicamento.SelectedValue))
    ...
    Private Sub frmReporteMedicamentosReimplante_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
