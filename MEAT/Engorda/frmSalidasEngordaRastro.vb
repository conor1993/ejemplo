...
Public Class frmSalidasEngordaRastro
    Inherits MeatForm
...
#Region "Metodos"
    ...
    Public Overrides Sub InicializarForma()
        ...
        'Cargar Rastros
        Controlador.LlenarComboRastros(cmbRastro)
...
#Region "Acciones_Menu"
    ...
    Public Overrides Function Buscar() As Boolean
        Dim frmCorralesReciba As New frmBusquedaCorralesARastro
        ...
        If frmCorralesReciba.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            cmbRastro.SelectedValue = SalidaGanado.IdRastro
    ...
    Public Overrides Function Guardar(ByVal Trans As HC.Transaction) As Boolean
        ...
        If MessageBox.Show("La Salida a Rastro se efectuara, ¿Esta seguro?", Controlador.Sesion.MiEmpresa.Empnom, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Return False
        End If
        ...
        If Me.Validate() Then
            ...
            If FrmVistaDetalle.ShowDialog() = Windows.Forms.DialogResult.OK Then
                Controlador.RealizarSalidadeCorralaRastro(SalidaGanado, Me.dtpFecha.Value, Trans)
                Trans.Commit()
                MessageBox.Show("La Salida de Corral a Rastro se ha realizado satisfactoriamente con el folio: " & SalidaGanado.Folio)
    ...
    Public Overrides Function Borrar(ByVal Trans As HC.Transaction) As Boolean
        If MessageBox.Show("La Salida a Rastro (" & SalidaGanado.Folio & ") se cancelara, ¿Esta seguro?", Controlador.Sesion.MiEmpresa.Empnom, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
            Return False
        End If

        Controlador.CancelarSalidaDeCorralARastro(SalidaGanado, Trans)
        Trans.Commit()
        Cancelar()
        MessageBox.Show("La Salida de Corral a Rastro se ha cancelado satisfactoriamente")
        Return True
    End Function
...
#Region "Eventos"
    ...
    Private Sub cmbRastro_SelectedValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbRastro.SelectedValueChanged
        If cmbRastro.SelectedValue IsNot Nothing AndAlso Estado = FormState.Nuevo Then
            SalidaGanado.IdRastro = cmbRastro.SelectedValue
        End If
    End Sub
    ...
    Private Sub dgvLotes_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dgvLotes.KeyDown
