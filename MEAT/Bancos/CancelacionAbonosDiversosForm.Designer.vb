...
Partial Class CancelacionAbonosDiversosForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.AbonosDiversos.MaximoElementosSeleccionados = 1
        Me.AbonosDiversos.MensajeLimiteMaximo = "Ya se selecciono el maximo de elementos permitidos"
        Me.AbonosDiversos.MostrarAlertas = False
        Me.AbonosDiversos.Name = Nothing
        Me.AbonosDiversos.RaiseListChangedEvents = True
        Me.AbonosDiversos.Transaction = Nothing
        '
        'ImprimirCheque
        '
