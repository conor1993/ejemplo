...
Public Class FrmBanAnalisisDiarios

    Private Sub FrmBanAnalisisDiarios_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub mtb_ClickImprimir(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickImprimir
        ...
        Try
            ...
            Else
                ...
                Dim Reporte As New rptAnaisisDiariodeBancos
                ...
                Using ad As New SqlClient.SqlDataAdapter(New SqlClient.SqlCommand("dbo.BancosReportes", _
                    ...
                    With ad.SelectCommand.Parameters
                        .Add("@Opcion", SqlDbType.VarChar).Value = 3
                ...
                visualizar.Text = "Reporte de Analisis Diarios de Movimientos Bancarios"
