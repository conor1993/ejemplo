        ...
        Try
            ...
            Else
                If abonodiverso.Entregado = True Then
                    MsgBox("El Abono Diverso no puede ser borrado, ya fué Entregado...")
                Else
                    GenerarPoliza()
            ...
            If VerificarBalance() = 0 Then
                ...
                If bbl Then
                    ...
                    If abonodiverso.Guardar() Then
                        MessageBox.Show(String.Format("Número de Poliza Generado:{0}{1}", vbCrLf, abonodiverso.Poliza.NumeroPoliza), "Poliza Generada", MessageBoxButtons.OK, MessageBoxIcon.Information)
