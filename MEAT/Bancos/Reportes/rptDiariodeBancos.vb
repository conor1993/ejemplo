...
Public Class rptDiariodeBancos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEAT.rptDiariodeBancos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDiariodeBancos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDiariodeBancos = New rptDiariodeBancos()
        rpt.Site = Me.Site
        Return rpt
    End Function
