...
Public Class FrmBanAbonosDiversos
...
#End Region
    ...
    Private Sub FrmBanAbonosDiversos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.mtb.Buttons(6).ToolTipText = "Guarda el Registro de Dep�sitos o los cambios que se le hayan Realizado."
...
#Region " Metodos "
    ...
    Public Function Validar() As String Implements InterfaceForm.Validar
        ...
        If Not Bl Then
            ...
            Cargo.TipoMovimiento = ClasesNegocio.BancosMovimientosTipo.ABONO_DIVERSO
...
#Region " ToolBar "
    ...
    Private Sub mtb_ClickGuardar(ByVal sender As Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs, ByRef Cancelar As Boolean) Handles mtb.ClickGuardar
            ...
            If IsNothing(Validar()) Then
                If VerificarBalance() = 0 Then
                    ...
                    If Cargo.Guardar(Trans) Then
                        ...
                        Trans.Commit()
                        MessageBox.Show(String.Format("Numero de Poliza Generado:{0}{1}", vbCrLf, Cargo.Poliza.NumeroPoliza), "Poliza Generada", MessageBoxButtons.OK, MessageBoxIcon.Information)
        ...
        Try
            ...
            Poliza.FechaCaptura = dtp.Value.ToString("dd'/'MM'/'yyyy hh:mm:ss")
            Dim query As String
            ...
            Else
                ...
                TransDet.Commit()
                sqlCon.Close()
                'MessageBox.Show("La P?liza ha sido grabada con el folio " & Poliza.NumeroPoliza, "?Correcto!", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
                ...
                If Cargo.Medio = ClasesNegocio.BancosMovimientosMedio.ELECTRONICO Then
                    ...
                    If pDg.ShowDialog = Windows.Forms.DialogResult.OK Then
                        Try
                            ...
                            If MessageBox.Show("�Se imprimira el comprobante?", "Confirmaci�n de Impresi�n", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = Windows.Forms.DialogResult.Yes Then
                    ...
                    If MessageBox.Show("�Desea imprimir el cheque?", "Confirmaci�n de Impresi�n", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = Windows.Forms.DialogResult.Yes Then
                        ...
                        If pDg.ShowDialog = Windows.Forms.DialogResult.OK Then
                            Try
                                ...
                                If MessageBox.Show("�Se imprimira el cheque?", "Confirmaci�n de Impresi�n", MessageBoxButtons.YesNo, MessageBoxIcon.Information) = Windows.Forms.DialogResult.Yes Then
...
#Region " Grid "
    ...
    Private Sub DgvCuentas_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DgvCuentas.CellEndEdit
        ...
        'Pro-Rateo
        cuenta.Obtener(Me.DgvCuentas.CurrentRow.Cells(idCuentaContable.Index).Value)
        ...
        Try
            If Buscar Then
                ...
                If Cuenta.Departamentalizable = Integra.Clases.SiNoEnum.SI Then
                    ...
                    frmDistribuciondeGastosconsulta.idpoliza = Cargo.Poliza.Codigo
                    frmDistribuciondeGastosconsulta.idcuentacontable = Me.DgvCuentas.CurrentRow.Cells(Me.idCuentaContable.Index).Value
                    If Ventana.ShowDialog = Windows.Forms.DialogResult.OK Then
                    End If
                End If
            End If
