...
Public Class FrmBanMovimientosdeConciliacion
    ...
    Private Sub FrmBanMovimientosdeConciliacion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Sub Reporte(ByVal NumCuenta As String, ByVal FechaInicial As Date, ByVal FechaFinal As Date)
        Try
            ...
            Dim Where As String = ""
            Dim Orden As String = ""
            Where &= " where CuentasBancarias.cuenta = '" & NumCuenta & "' and MovimientosBancarios.Fec_Mov Between '" & FechaInicial.ToString("yyyyMMdd") & "' AND '" & FechaFinal.AddDays(1).Date.ToString("yyyyMMdd") & "'" & "and Cve_Concil = 'S'"
            Query &= Where
            ...
            Where2 &= " where CuentasBancarias.cuenta = '" & NumCuenta & "' and MovimientosEstadoCuenta.Fecha Between '" & FechaInicial.ToString("yyyyMMdd") & "' AND '" & FechaFinal.AddDays(1).Date.ToString("yyyyMMdd") & "'" & "and Conciliado = 1 "
            ...
            Reporte.SetParameterValue(2, "Bancos\Reportes\Movimientos de Conciliación")
            Reporte.SetParameterValue(3, Me.dtpFechaInicial.Value.Date)
            Reporte.SetParameterValue(4, Me.dtpFechaFinal.Value.Date)
            Reporte.SetParameterValue(5, "Reporte de Movimientos de Conciliación")
