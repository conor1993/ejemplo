...
Public Class crReporteNomina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.crReporteNomina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReporteNomina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReporteNomina = New crReporteNomina()
        rpt.Site = Me.Site
        Return rpt
    End Function
