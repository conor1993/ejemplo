...
Public Class rptABCSucursales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptABCSucursales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptABCSucursales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptABCSucursales = New rptABCSucursales()
        rpt.Site = Me.Site
        Return rpt
    End Function
