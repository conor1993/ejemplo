...
Public Class rptABCLineas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptABCLineas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptABCLineas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptABCLineas = New rptABCLineas()
        rpt.Site = Me.Site
        Return rpt
    End Function
