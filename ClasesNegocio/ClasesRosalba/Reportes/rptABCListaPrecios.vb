...
Public Class rptABCListaPrecios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptABCListaPrecios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptABCListaPrecios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptABCListaPrecios = New rptABCListaPrecios()
        rpt.Site = Me.Site
        Return rpt
    End Function
