...
Public Class rptABCSubLineas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptABCSubLineas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptABCSubLineas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptABCSubLineas = New rptABCSubLineas()
        rpt.Site = Me.Site
        Return rpt
    End Function
