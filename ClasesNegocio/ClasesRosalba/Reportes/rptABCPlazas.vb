...
Public Class rptABCPlazas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptABCPlazas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptABCPlazas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptABCPlazas = New rptABCPlazas()
        rpt.Site = Me.Site
        Return rpt
    End Function
