...
Public Class rptCatCausaMuertes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptCatCausaMuertes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatCausaMuertes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatCausaMuertes = New rptCatCausaMuertes()
        rpt.Site = Me.Site
        Return rpt
    End Function
