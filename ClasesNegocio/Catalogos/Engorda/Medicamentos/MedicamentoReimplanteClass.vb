...
Public Class MedicamentoReimplanteClass
    Inherits ClassBase(Of EC.CabMediReimEntity)
...
#Region "Constructores"
    Sub New()
        Entity = New EC.CabMediReimEntity
    End Sub

    Sub New(ByVal idMedicamento As Integer)
        MyBase.New(New EC.CabMediReimEntity(idMedicamento))
    End Sub

    Sub New(ByVal entidad As EC.CabMediReimEntity)
        MyBase.New(entidad)
    End Sub
#End Region
    ...
    Public Property IdMedicamento() As Integer
        ...
        Set(ByVal value As Integer)
            ...
            Nombre = prod.GetScalar(Integralab.ORM.ProductoFieldIndex.Descripcion, _
                                                ...
                                                HC.ProductoFields.Codigo = value).ToString()
            Me.UnidadMedida = unidad.GetScalar(Integralab.ORM.UnidadMedidaFieldIndex.DescripcionCorta, _
                            ...
                            SD.LLBLGen.Pro.ORMSupportClasses.AggregateFunction.None, _
                            HC.ProductoFields.Codigo = value, rel, Nothing).ToString()
        End Set
    End Property
