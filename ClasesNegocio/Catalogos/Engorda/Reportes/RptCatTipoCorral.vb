...
Public Class RptCatTipoCorral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptCatTipoCorral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCatTipoCorral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCatTipoCorral = New RptCatTipoCorral()
        rpt.Site = Me.Site
        Return rpt
    End Function
