...
Public Class RptCatCorrales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptCatCorrales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCatCorrales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCatCorrales = New RptCatCorrales()
        rpt.Site = Me.Site
        Return rpt
    End Function
