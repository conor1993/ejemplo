...
Public Class RptBeneficiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptBeneficiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptBeneficiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptBeneficiario = New RptBeneficiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
