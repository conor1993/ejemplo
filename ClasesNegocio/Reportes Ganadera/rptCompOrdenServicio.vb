...
Public Class rptCompOrdenServicio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCompOrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptCompOrdenServicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompOrdenServicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompOrdenServicio = New rptCompOrdenServicio()
        rpt.Site = Me.Site
        Return rpt
    End Function
