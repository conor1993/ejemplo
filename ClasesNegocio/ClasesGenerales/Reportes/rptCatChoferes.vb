...
Public Class rptCatChoferes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptCatChoferes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatChoferes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatChoferes = New rptCatChoferes()
        rpt.Site = Me.Site
        Return rpt
    End Function
