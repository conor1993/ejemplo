...
Public Class rptCatVehiculos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptCatVehiculos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCatVehiculos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCatVehiculos = New rptCatVehiculos()
        rpt.Site = Me.Site
        Return rpt
    End Function
