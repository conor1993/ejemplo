...
Public Class CRepTAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepTAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepTAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepTAlmacen = New CRepTAlmacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
