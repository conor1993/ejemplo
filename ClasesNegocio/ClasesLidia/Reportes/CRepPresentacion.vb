...
Public Class CRepPresentacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepPresentacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepPresentacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepPresentacion = New CRepPresentacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
