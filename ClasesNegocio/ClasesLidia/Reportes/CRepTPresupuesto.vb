...
Public Class CRepTPresupuesto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepTPresupuesto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepTPresupuesto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepTPresupuesto = New CRepTPresupuesto()
        rpt.Site = Me.Site
        Return rpt
    End Function
