...
Public Class CRepListaPrecio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepListaPrecio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepListaPrecio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepListaPrecio = New CRepListaPrecio()
        rpt.Site = Me.Site
        Return rpt
    End Function
