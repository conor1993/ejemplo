...
Public Class CRepLListPrec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepLListPrec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepLListPrec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepLListPrec = New CRepLListPrec()
        rpt.Site = Me.Site
        Return rpt
    End Function
