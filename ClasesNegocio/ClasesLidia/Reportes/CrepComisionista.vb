...
Public Class CrepComisionista
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CrepComisionista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrepComisionista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrepComisionista = New CrepComisionista()
        rpt.Site = Me.Site
        Return rpt
    End Function
