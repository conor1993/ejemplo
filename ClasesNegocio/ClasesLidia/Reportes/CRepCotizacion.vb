...
Public Class CRepCotizacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepCotizacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepCotizacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepCotizacion = New CRepCotizacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
