...
Public Class CRepPblacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepPblacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepPblacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepPblacion = New CRepPblacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
