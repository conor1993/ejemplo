...
Public Class CRepNotaDeVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepNotaDeVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepNotaDeVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepNotaDeVenta = New CRepNotaDeVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
