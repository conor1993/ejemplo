...
Public Class CRepTComisionista
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepTComisionista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepTComisionista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepTComisionista = New CRepTComisionista()
        rpt.Site = Me.Site
        Return rpt
    End Function
