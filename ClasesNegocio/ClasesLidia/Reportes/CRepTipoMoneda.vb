...
Public Class CRepTipoMoneda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.CRepTipoMoneda.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRepTipoMoneda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRepTipoMoneda = New CRepTipoMoneda()
        rpt.Site = Me.Site
        Return rpt
    End Function
