...
Public Class RptProductoComando
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptProductoComando.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptProductoComando
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptProductoComando = New RptProductoComando()
        rpt.Site = Me.Site
        Return rpt
    End Function
