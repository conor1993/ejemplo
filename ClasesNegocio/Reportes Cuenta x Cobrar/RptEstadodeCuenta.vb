...
Public Class RptEstadodeCuenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptEstadodeCuenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEstadodeCuenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEstadodeCuenta = New RptEstadodeCuenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
