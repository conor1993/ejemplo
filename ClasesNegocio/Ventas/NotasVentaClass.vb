...
Public Class NotaVentaClass
    Inherits ClassBase(Of EC.NotaVentaEntity)

#Region "Miembros"
    Dim _Func As String
    Dim _NumOpc As Integer
    Dim _Detalles As NotaVentaDetalleCollectionClass
...
#Region "Constructores"
    Sub New()
        Entity = New EC.NotaVentaEntity
        Entity.FechaCancelacion = "01/01/1900"
        'Entity.Cliente = 0
        'Entity.TipoVentaId = 0
    End Sub

    Sub New(ByVal ent As EC.NotaVentaEntity)
        Entity = ent
    End Sub
#End Region
...
#Region "Propiedades"
    ...
    Property Sucursal() As SucursalClass
        ...
        Set(ByVal value As SucursalClass)
            _Sucursal = value
            Entity.CodSucursal = value.Codigo
        End Set
    End Property
    ...
    Property ControlTurnoCanc() As ControlTurnoClass
        Get
            If _ControlTurnoCanc Is Nothing Then
                _ControlTurnoCanc = New ControlTurnoClass(Entity.ControlTurnoCanc)
            End If
    ...
    Public Property Detalles() As NotaVentaDetalleCollectionClass
        Get
            If _Detalles Is Nothing Then
                _Detalles = New NotaVentaDetalleCollectionClass()
                _Detalles.RellenarMe(Entity.Detalle)

            End If
            Return _Detalles
        End Get
        Set(ByVal value As NotaVentaDetalleCollectionClass)
            _Detalles = value
        End Set
    End Property
...
#Region "Metodos"
    ...
    Public Overloads Function Guardar(ByRef trans As Integralab.ORM.HelperClasses.Transaction, Optional ByVal Modif As Boolean = False) As Boolean
        Try
            trans.Add(Me.Entity)
            ...
            If Modif = False Then
                For Each det As NotaVentaDetalleClass In _Detalles
...
Public Class NotaVentaDetalleClass
    Inherits ClassBase(Of EC.NotaVentaDetalleEntity)
...
#Region "Constructores"
    Sub New()
        Entity = New EC.NotaVentaDetalleEntity
    End Sub

    Sub New(ByVal Entidad As EC.NotaVentaDetalleEntity)
        Entity = Entidad
    End Sub

    Sub New(ByVal Codigo As Integer)
        Entity = New EC.NotaVentaDetalleEntity(Codigo)
...
Public Class NotaVentaDetalleCollectionClass
    Inherits ColleccionBase(Of EC.NotaVentaDetalleEntity, CC.NotaVentaDetalleCollection, NotaVentaDetalleClass)
...
#Region "Metodos"
    Public Shadows Sub Add(ByVal item As NotaVentaDetalleClass)
        MyBase.Add(item)
    End Sub
    ...
    Public Overloads Function ObtenerTotal(ByVal CodProdComp As Integer) As Integer
        Try
            ...
            filtro.Add(HC.NotaVentaDetalleFields.IdProductoCompuesto = CodProdComp)
    ...
    Public Sub AgregarProducto(ByVal Detalle As NotaVentaDetalleClass)
        Me.Add(Detalle)
    End Sub
#End Region
...
Public Class NotaVentaCollectionClass
    Inherits ColleccionBase(Of EC.NotaVentaEntity, CC.NotaVentaCollection, NotaVentaClass)
...
#Region "Metodos"
    Public Shadows Sub Add(ByVal item As NotaVentaClass)
        MyBase.Add(item)
    End Sub
    ...
    Public Sub AgregarNota(ByVal Detalle As NotaVentaClass)
        Me.Add(Detalle)
    End Sub
#End Region
