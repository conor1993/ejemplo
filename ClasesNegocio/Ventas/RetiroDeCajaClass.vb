...
Public Class RetiroDeCajaClass
    Inherits ClassBase(Of EC.RetiroCajaEntity)
...
#Region "Constructores"
    ...
    Sub New(ByVal Ent As Integralab.ORM.EntityClasses.RetiroCajaEntity)
        Me.Entity = Ent
    End Sub
#End Region
...
#Region "Propiedades"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <System.ComponentModel.DisplayName("Código retiro")> _
...
#Region "Metodos"
    ...
    '                MsgBox("no se realizo retiro correctamante.", MsgBoxStyle.Exclamation, "")
    '                Return False
    '            End If
    '        Else
    ...
    Public Sub LeerEntidad(ByVal EntidadL As EC.RetiroCajaEntity)
        Me.Entity = EntidadL
    End Sub

    Public Function ObtenerEntidad() As EC.RetiroCajaEntity
        Return Me.Entity
    End Function
#End Region
...
Public Class RetiroCajaCollectionClass
    Inherits ColleccionBase(Of EC.RetiroCajaEntity, CC.RetiroCajaCollection, RetiroDeCajaClass)
...
#Region "Metodos"
    Public Shadows Sub Add(ByVal item As RetiroDeCajaClass)
        MyBase.Add(item)
    End Sub
    ...
    Public Sub AgregarControlTurno(ByVal ControlTurno As RetiroDeCajaClass)
        Me.Add(ControlTurno)
    End Sub
#End Region
