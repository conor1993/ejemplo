...
Public Class RptPagosCheDevueltos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptPagosCheDevueltos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptPagosCheDevueltos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RptDetallesCheDevueltos2rpt_Padre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptPagosCheDevueltos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPagosCheDevueltos = New RptPagosCheDevueltos()
        rpt.Site = Me.Site
        Return rpt
    End Function
