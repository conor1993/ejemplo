...
Public Class RptDetallesCheDevueltos2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptDetallesCheDevueltos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptDetallesCheDevueltos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Padre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptDetallesCheDevueltos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDetallesCheDevueltos2 = New RptDetallesCheDevueltos2()
        rpt.Site = Me.Site
        Return rpt
    End Function
