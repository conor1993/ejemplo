...
Public Class rptDepartamentos2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptDepartamentos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDepartamentos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDepartamentos2 = New rptDepartamentos2()
        rpt.Site = Me.Site
        Return rpt
    End Function
