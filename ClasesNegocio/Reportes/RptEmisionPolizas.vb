...
Public Class RptEmisionPolizas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptEmisionPolizas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEmisionPolizas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEmisionPolizas = New RptEmisionPolizas()
        rpt.Site = Me.Site
        Return rpt
    End Function
