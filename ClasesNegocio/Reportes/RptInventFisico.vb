...
Public Class RptInventFisico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptInventFisico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInventFisico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInventFisico = New RptInventFisico()
        rpt.Site = Me.Site
        Return rpt
    End Function
