...
Public Class RptDiariosPolizas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptDiariosPolizas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDiariosPolizas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDiariosPolizas = New RptDiariosPolizas()
        rpt.Site = Me.Site
        Return rpt
    End Function
