...
Public Class RptCuentaFiscal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptCuentaFiscal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCuentaFiscal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCuentaFiscal = New RptCuentaFiscal()
        rpt.Site = Me.Site
        Return rpt
    End Function
