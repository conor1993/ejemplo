...
Public Class RptCuentaBancaria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptCuentaBancaria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCuentaBancaria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCuentaBancaria = New RptCuentaBancaria()
        rpt.Site = Me.Site
        Return rpt
    End Function
