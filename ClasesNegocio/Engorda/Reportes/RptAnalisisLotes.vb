...
Public Class RptAnalisisLotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptAnalisisLotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptAnalisisLotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptAnalisisLotes = New RptAnalisisLotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
