...
Public Class RptReimplantes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptReimplantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptReimplantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptReimplantes = New RptReimplantes()
        rpt.Site = Me.Site
        Return rpt
    End Function
