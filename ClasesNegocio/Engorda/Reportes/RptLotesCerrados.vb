...
Public Class RptLotesCerrados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptLotesCerrados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLotesCerrados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLotesCerrados = New RptLotesCerrados()
        rpt.Site = Me.Site
        Return rpt
    End Function
