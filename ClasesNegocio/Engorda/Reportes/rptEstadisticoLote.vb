...
Public Class rptEstadisticoLote
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptEstadisticoLote.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstadisticoLote
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstadisticoLote = New rptEstadisticoLote()
        rpt.Site = Me.Site
        Return rpt
    End Function
