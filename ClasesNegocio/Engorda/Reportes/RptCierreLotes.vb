...
Public Class RptCierreLotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptCierreLotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptCierreLotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCierreLotes = New RptCierreLotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
