...
Public Class RptDecomisos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptDecomisos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDecomisos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDecomisos = New RptDecomisos()
        rpt.Site = Me.Site
        Return rpt
    End Function
