...
Public Class RptConcetradodeCortes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptConcetradodeCortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptConcetradodeCortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Imprimir() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptConcetradodeCortes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptConcetradodeCortes = New RptConcetradodeCortes()
        rpt.Site = Me.Site
        Return rpt
    End Function
