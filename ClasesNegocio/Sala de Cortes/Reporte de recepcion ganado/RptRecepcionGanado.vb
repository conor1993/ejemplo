...
Public Class RptRecepcionGanado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptRecepcionGanado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRecepcionGanado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRecepcionGanado = New RptRecepcionGanado()
        rpt.Site = Me.Site
        Return rpt
    End Function
