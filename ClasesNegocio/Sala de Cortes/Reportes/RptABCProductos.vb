...
Public Class RptABCProductos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptABCProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptABCProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptABCProductos = New RptABCProductos()
        rpt.Site = Me.Site
        Return rpt
    End Function
