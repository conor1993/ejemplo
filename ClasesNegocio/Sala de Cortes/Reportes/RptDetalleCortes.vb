...
Public Class RptDetalleCortes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptDetalleCortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Concentrado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptDetalleCortes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDetalleCortes = New RptDetalleCortes()
        rpt.Site = Me.Site
        Return rpt
    End Function
