...
Public Class rptReporteCanales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptReporteCanales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteCanales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteCanales = New rptReporteCanales()
        rpt.Site = Me.Site
        Return rpt
    End Function
