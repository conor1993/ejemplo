...
Public Class RptPrecortes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptPrecortes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPrecortes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPrecortes = New RptPrecortes()
        rpt.Site = Me.Site
        Return rpt
    End Function
