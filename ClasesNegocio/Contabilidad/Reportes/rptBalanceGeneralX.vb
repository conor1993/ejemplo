...
Public Class rptBalanceGeneralX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptBalanceGeneralX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBalanceGeneralX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBalanceGeneralX = New rptBalanceGeneralX()
        rpt.Site = Me.Site
        Return rpt
    End Function
