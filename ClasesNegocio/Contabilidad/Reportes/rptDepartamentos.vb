...
Public Class rptDepartamentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptDepartamentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDepartamentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDepartamentos = New rptDepartamentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
