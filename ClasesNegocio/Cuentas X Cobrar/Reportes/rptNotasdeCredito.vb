...
Public Class rptNotasdeCredito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptNotasdeCredito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotasdeCredito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotasdeCredito = New rptNotasdeCredito()
        rpt.Site = Me.Site
        Return rpt
    End Function
