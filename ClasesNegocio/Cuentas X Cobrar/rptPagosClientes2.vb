...
Public Class rptPagosClientes2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptPagosClientes2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosClientes2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosClientes2 = New rptPagosClientes2()
        rpt.Site = Me.Site
        Return rpt
    End Function
