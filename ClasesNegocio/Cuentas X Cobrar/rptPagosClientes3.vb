...
Public Class rptPagosClientes3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptPagosClientes3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosClientes3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosClientes3 = New rptPagosClientes3()
        rpt.Site = Me.Site
        Return rpt
    End Function
