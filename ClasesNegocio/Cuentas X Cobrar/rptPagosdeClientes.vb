...
Public Class rptPagosdeClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptPagosdeClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosdeClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosdeClientes = New rptPagosdeClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
