...
Public Class RptFacturasCXP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptFacturasCXP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturasCXP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturasCXP = New RptFacturasCXP()
        rpt.Site = Me.Site
        Return rpt
    End Function
