...
Public Class RptFacturasGastos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptFacturasGastos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFacturasGastos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFacturasGastos = New RptFacturasGastos()
        rpt.Site = Me.Site
        Return rpt
    End Function
