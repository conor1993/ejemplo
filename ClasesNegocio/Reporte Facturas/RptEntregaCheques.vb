...
Public Class RptEntregaCheques
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptEntregaCheques.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptEntregaCheques
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEntregaCheques = New RptEntregaCheques()
        rpt.Site = Me.Site
        Return rpt
    End Function
