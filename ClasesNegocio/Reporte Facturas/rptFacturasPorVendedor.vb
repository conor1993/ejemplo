...
Public Class rptFacturasPorVendedor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFacturasPorVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptFacturasPorVendedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFacturasPorVendedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFacturasPorVendedor = New rptFacturasPorVendedor()
        rpt.Site = Me.Site
        Return rpt
    End Function
