...
Public Class RptSalidasDeReciba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.RptSalidasDeReciba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSalidasDeReciba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSalidasDeReciba = New RptSalidasDeReciba()
        rpt.Site = Me.Site
        Return rpt
    End Function
