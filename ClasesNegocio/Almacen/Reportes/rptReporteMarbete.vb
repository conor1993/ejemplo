...
Public Class rptReporteMarbete
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptReporteMarbete.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReporteMarbete
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReporteMarbete = New rptReporteMarbete()
        rpt.Site = Me.Site
        Return rpt
    End Function
