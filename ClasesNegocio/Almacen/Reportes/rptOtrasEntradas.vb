...
Public Class rptOtrasEntradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptOtrasEntradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOtrasEntradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOtrasEntradas = New rptOtrasEntradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
