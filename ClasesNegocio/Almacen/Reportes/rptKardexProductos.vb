...
Public Class rptKardexProductos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptKardexProductos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKardexProductos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKardexProductos = New rptKardexProductos()
        rpt.Site = Me.Site
        Return rpt
    End Function
