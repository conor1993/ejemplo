...
Public Class rptCompRecepciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptCompRecepciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompRecepciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompRecepciones = New rptCompRecepciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
