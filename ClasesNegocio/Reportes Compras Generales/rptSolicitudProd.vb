...
Public Class rptSolicitudProd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptSolicitudProd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSolicitudProd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSolicitudProd = New rptSolicitudProd()
        rpt.Site = Me.Site
        Return rpt
    End Function
