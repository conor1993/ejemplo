...
Public Class rptCompCotizacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptCompCotizacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCompCotizacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCompCotizacion = New rptCompCotizacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
