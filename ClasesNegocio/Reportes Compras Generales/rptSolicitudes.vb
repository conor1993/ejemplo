...
Public Class rptSolicitudes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.rptSolicitudes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSolicitudes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSolicitudes = New rptSolicitudes()
        rpt.Site = Me.Site
        Return rpt
    End Function
