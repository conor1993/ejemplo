...
Public Class crRecepCompraTck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ClasesNegocio.crRecepCompraTck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrRecepCompraTck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crRecepCompraTck = New crRecepCompraTck()
        rpt.Site = Me.Site
        Return rpt
    End Function
